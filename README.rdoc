...
{<img src="http://img.shields.io/scrutinizer/g/stripe/stripe-php.svg" alt="Scrutinizer Code Quality" />}[https://scrutinizer-ci.com/g/stripe/stripe-php]
...
In order to run tests you have to install PHPUnit[http://packagist.org/packages/phpunit/phpunit] via Composer[http://getcomposer.org/] (recommended way):

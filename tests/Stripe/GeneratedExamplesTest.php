...
final class GeneratedExamplesTest extends TestCase
{
    ...
    public function testV2BillingContractGet()
    {
        $this->stubRequest(
            'get',
        ...
        $result = $this->v2Client->v2->billing->contracts->all([]);
        self::assertInstanceOf(V2\Collection::class, $result);
        self::assertInstanceOf(V2\Billing\Contract::class, $result->data[0]);
    }

    public function testV2BillingContractPost()
    {
        $this->stubRequest(
            'post',
            '/v2/billing/contracts',
    ...
    public function testV2BillingContractGet2()
    {
        ...
        $result = $this->v2Client->v2->billing->contracts->retrieve(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Billing\Contract::class, $result);
    ...
    public function testV2BillingContractPost2()
    {
        $this->stubRequest(
            'post',
            '/v2/billing/contracts/id_123',
        ...
        $result = $this->v2Client->v2->billing->contracts->update('id_123', []);
        self::assertInstanceOf(V2\Billing\Contract::class, $result);
    }

    public function testV2BillingContractPost3()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->billing->contracts->activate(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Billing\Contract::class, $result);
    ...
    public function testV2BillingContractPost4()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->billing->contracts->cancel('id_123', []);
        self::assertInstanceOf(V2\Billing\Contract::class, $result);
    }
    ...
    public function testV2IamApiKeyGet()
    {
        ...
        $result = $this->v2Client->v2->iam->apiKeys->all([]);
        self::assertInstanceOf(V2\Collection::class, $result);
        self::assertInstanceOf(V2\Iam\ApiKey::class, $result->data[0]);
    }

    public function testV2IamApiKeyPost()
    {
        $this->stubRequest(
            'post',
            '/v2/iam/api_keys',
        ...
        $result = $this->v2Client->v2->iam->apiKeys->create([
            'type' => 'publishable_key',
        ]);
        self::assertInstanceOf(V2\Iam\ApiKey::class, $result);
    }

    public function testV2IamApiKeyGet2()
    {
        $this->stubRequest(
            'get',
        ...
        $result = $this->v2Client->v2->iam->apiKeys->retrieve('id_123', []);
        self::assertInstanceOf(V2\Iam\ApiKey::class, $result);
    }

    public function testV2IamApiKeyPost2()
    {
        $this->stubRequest(
            'post',
            '/v2/iam/api_keys/id_123',
        ...
        $result = $this->v2Client->v2->iam->apiKeys->update('id_123', []);
        self::assertInstanceOf(V2\Iam\ApiKey::class, $result);
    }

    public function testV2IamApiKeyPost3()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->iam->apiKeys->expire('id_123', []);
        self::assertInstanceOf(V2\Iam\ApiKey::class, $result);
    }

    public function testV2IamApiKeyPost4()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->iam->apiKeys->rotate('id_123', []);
        self::assertInstanceOf(V2\Iam\ApiKey::class, $result);
    }
    ...
    public function testV2MoneyManagementAdjustmentGet2()
    {
        ...
        $result = $this->v2Client->v2->moneyManagement->adjustments->retrieve(
            'id_123',
            []
        );
    ...
    public function testV2MoneyManagementCurrencyConversionGet()
    {
        $this->stubRequest(
            'get',
        ...
        $result = $this->v2Client->v2->moneyManagement->currencyConversions->all([]);
        self::assertInstanceOf(V2\Collection::class, $result);
        self::assertInstanceOf(V2\MoneyManagement\CurrencyConversion::class, $result->data[0]);
    }

    public function testV2MoneyManagementCurrencyConversionPost()
    {
        $this->stubRequest(
            'post',
            '/v2/money_management/currency_conversions',
    ...
    public function testV2MoneyManagementCurrencyConversionGet2()
    {
        $this->stubRequest(
            'get',
        ...
        $result = $this->v2Client->v2->moneyManagement->currencyConversions->retrieve(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\MoneyManagement\CurrencyConversion::class, $result);
    ...
    public function testV2MoneyManagementFinancialAddressGet2()
    {
        ...
        $result = $this->v2Client->v2->moneyManagement->financialAddresses->retrieve(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\MoneyManagement\FinancialAddress::class, $result);
    ...
    public function testV2MoneyManagementInboundTransferGet2()
    {
        ...
        $result = $this->v2Client->v2->moneyManagement->inboundTransfers->retrieve(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\MoneyManagement\InboundTransfer::class, $result);
    ...
    public function testV2MoneyManagementOutboundTransferGet2()
    {
        ...
        $result = $this->v2Client->v2->moneyManagement->outboundTransfers->retrieve(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\MoneyManagement\OutboundTransfer::class, $result);
    ...
    public function testV2MoneyManagementReceivedCreditGet()
    {
        $this->stubRequest(
            'get',
    ...
    public function testV2MoneyManagementReceivedCreditGet2()
    {
        ...
        $result = $this->v2Client->v2->moneyManagement->receivedCredits->retrieve(
            'id_123',
            []
        );
    ...
    public function testV2MoneyManagementReceivedDebitGet2()
    {
        ...
        $result = $this->v2Client->v2->moneyManagement->receivedDebits->retrieve(
            'id_123',
            []
        );
    ...
    public function testV2PaymentsSettlementAllocationIntentPost()
    {
        ...
        $result = $this->v2Client->v2->payments->settlementAllocationIntents->create([
            'amount' => [
                'currency' => 'USD',
                'value' => 96,
            ],
    ...
    public function testV2PaymentsSettlementAllocationIntentGet2()
    {
        ...
        $result = $this->v2Client->v2->payments->settlementAllocationIntents->retrieve(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Payments\SettlementAllocationIntent::class, $result);
    ...
    public function testV2PaymentsSettlementAllocationIntentPost2()
    {
        $this->stubRequest(
            'post',
            '/v2/payments/settlement_allocation_intents/id_123',
        ...
        $result = $this->v2Client->v2->payments->settlementAllocationIntents->update(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Payments\SettlementAllocationIntent::class, $result);
    ...
    public function testV2PaymentsSettlementAllocationIntentPost3()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->payments->settlementAllocationIntents->cancel(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Payments\SettlementAllocationIntent::class, $result);
    ...
    public function testV2PaymentsSettlementAllocationIntentPost4()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->payments->settlementAllocationIntents->submit(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Payments\SettlementAllocationIntent::class, $result);
    ...
    public function testV2PaymentsSettlementAllocationIntentsSplitPost()
    {
        ...
        $result = $this->v2Client->v2->payments->settlementAllocationIntents->splits->create(
            'settlement_allocation_intent_id_123',
            [
                'account' => 'account',
                'amount' => [
    ...
    public function testV2PaymentsSettlementAllocationIntentsSplitGet2()
    {
        ...
        $result = $this->v2Client->v2->payments->settlementAllocationIntents->splits->retrieve(
            'settlement_allocation_intent_id_123',
            'id_123',
            []
        );
    ...
    public function testV2PaymentsSettlementAllocationIntentsSplitPost2()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->payments->settlementAllocationIntents->splits->cancel(
            'settlement_allocation_intent_id_123',
            'id_123',
            []
        );
    ...
    public function testV2ProvisioningPaymentProfilePost()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->provisioning->paymentProfile->updateLimit([
            'usage_limits' => [
                'currency' => 'usd',
                'max_amount' => 803901331,
                'recurring_interval' => 'year',
    ...
    public function testV2SignalsPaymentRetryEvaluationPost()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->signals->paymentRetryEvaluations->create([]);
        self::assertInstanceOf(V2\Signals\PaymentRetryEvaluation::class, $result);
    }

    public function testV2SignalsPaymentRetryEvaluationGet()
    {
        $this->stubRequest(
            'get',
            '/v2/signals/payment_retry_evaluations/id_123',
            [],
            [],
            false,
            [
        ...
        $result = $this->v2Client->v2->signals->paymentRetryEvaluations->retrieve(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Signals\PaymentRetryEvaluation::class, $result);
    ...
    public function testV2SignalsPaymentRetryEvaluationPost2()
    {
        $this->stubRequest(
            'post',
            '/v2/signals/payment_retry_evaluations/id_123',
        ...
        $result = $this->v2Client->v2->signals->paymentRetryEvaluations->update(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Signals\PaymentRetryEvaluation::class, $result);
    ...
    public function testV2SignalsPaymentRetryEvaluationPost3()
    {
        $this->stubRequest(
            'post',
            '/v2/signals/payment_retry_evaluations/id_123/cancel',
            [],
            [],
            false,
            [
        ...
        $result = $this->v2Client->v2->signals->paymentRetryEvaluations->cancel(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Signals\PaymentRetryEvaluation::class, $result);
    ...
    public function testV2SignalsPaymentRetrySignalGet()
    {
        $this->stubRequest(
            'get',
            '/v2/signals/payment_retry_signals/id_123',
            [],
            [],
            false,
            [
        ...
        $result = $this->v2Client->v2->signals->paymentRetrySignals->retrieve(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Signals\PaymentRetrySignal::class, $result);
    }

    public function testV2TaxIntegrationConfigurationGet()
    {
        $this->stubRequest(
            'get',
        ...
        $result = $this->v2Client->v2->tax->integrationConfigurations->retrieve([]);
        self::assertInstanceOf(V2\Tax\IntegrationConfiguration::class, $result);
    }

    public function testV2TaxIntegrationConfigurationPost()
    {
        $this->stubRequest(
            'post',
            '/v2/tax/integration_configurations',
        ...
        $result = $this->v2Client->v2->tax->integrationConfigurations->update([]);
        self::assertInstanceOf(V2\Tax\IntegrationConfiguration::class, $result);
    }
    ...
    public function testV2TaxManualRuleGet()
    {
        ...
        $result = $this->v2Client->v2->tax->manualRules->all([]);
        self::assertInstanceOf(V2\Collection::class, $result);
        self::assertInstanceOf(V2\Tax\ManualRule::class, $result->data[0]);
    }

    public function testV2TaxManualRulePost()
    {
        $this->stubRequest(
            'post',
            '/v2/tax/manual_rules',
        ...
        $result = $this->v2Client->v2->tax->manualRules->create([
            'scheduled_tax_rates' => [
                [
                    'rates' => [
                        [
    ...
    public function testV2TaxManualRuleGet2()
    {
        $this->stubRequest(
            'get',
        ...
        $result = $this->v2Client->v2->tax->manualRules->retrieve('id_123', []);
        self::assertInstanceOf(V2\Tax\ManualRule::class, $result);
    }

    public function testV2TaxManualRulePost2()
    {
        $this->stubRequest(
            'post',
            '/v2/tax/manual_rules/id_123',
        ...
        $result = $this->v2Client->v2->tax->manualRules->update(
            'id_123',
            [
                'scheduled_tax_rates' => [
                    [
    ...
    public function testV2TaxManualRulePost3()
    {
        $this->stubRequest(
            'post',
        ...
        $result = $this->v2Client->v2->tax->manualRules->deactivate(
            'id_123',
            []
        );
        self::assertInstanceOf(V2\Tax\ManualRule::class, $result);
    ...
    public function testAlreadyExistsError()
    {
        ...
        try {
            $this->v2Client->v2->billing->contracts->create([
                'contract_number' => 'contract_number',
                'currency' => 'usd',
            ]);
    ...
    public function testCannotProceedError()
    {
        ...
        try {
            $this->v2Client->v2->billing->contracts->update('id_123', []);
    ...
    public function testRecipientNotNotifiableError()
    {
        $this->stubRequest(
            'post',
            '/v2/money_management/outbound_payments',

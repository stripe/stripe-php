...
class Price extends ApiResource
{
     ...
     * @param null|array{active?: bool, currency_options?: null|StripeObject, expand?: string[], lookup_key?: string, metadata?: array<string, string>, nickname?: string, tax_behavior?: string, transfer_lookup_key?: bool} $params
     * @param null|array|string $opts
     *

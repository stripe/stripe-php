 ...
 * @property null|(object{maximum: null|int, minimum: null|int, preset: null|int}&\stdClass&StripeObject) $custom_unit_amount When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
 ...
 * @property null|(object{behavior: string, effective_after: int, price: string}&\stdClass&StripeObject) $migrate_to Subscriptions using this price will be migrated to use the new referenced price.
 ...
 * @property null|(object{aggregate_usage: null|string, interval: string, interval_count: int, meter: null|string, trial_period_days: null|int, usage_type: string}&\stdClass&StripeObject) $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 ...
 * @property null|(object{divide_by: int, round: string}&\stdClass&StripeObject) $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.

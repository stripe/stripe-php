 ...
 * @property null|(object{aggregate_usage: null|string, interval: string, interval_count: int, meter: null|string, trial_period_days: null|int, usage_type: string}&\Stripe\StripeObject&\stdClass) $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 ...
 * @property ((object{flat_amount: null|int, flat_amount_decimal: null|string, unit_amount: null|int, unit_amount_decimal: null|string, up_to: null|int}&\Stripe\StripeObject&\stdClass))[] $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property null|(object{divide_by: int, round: string}&\Stripe\StripeObject&\stdClass) $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.

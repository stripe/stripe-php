...
class EventNotificationTypes
{
    const v2EventMapping = [
        ...
        \Stripe\Events\V1BalanceSettingsUpdatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1BalanceSettingsUpdatedEventNotification::class,
        ...
        \Stripe\Events\V1BillingCreditBalanceTransactionCreatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1BillingCreditBalanceTransactionCreatedEventNotification::class,
        \Stripe\Events\V1BillingCreditGrantCreatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1BillingCreditGrantCreatedEventNotification::class,
        \Stripe\Events\V1BillingCreditGrantUpdatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1BillingCreditGrantUpdatedEventNotification::class,
        \Stripe\Events\V1BillingMeterCreatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1BillingMeterCreatedEventNotification::class,
        \Stripe\Events\V1BillingMeterDeactivatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1BillingMeterDeactivatedEventNotification::class,
        ...
        \Stripe\Events\V1BillingMeterReactivatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1BillingMeterReactivatedEventNotification::class,
        \Stripe\Events\V1BillingMeterUpdatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1BillingMeterUpdatedEventNotification::class,
        ...
        \Stripe\Events\V1FinancialConnectionsAccountAccountNumbersUpdatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1FinancialConnectionsAccountAccountNumbersUpdatedEventNotification::class,
        ...
        \Stripe\Events\V1FinancialConnectionsAccountExpectedDeactivationDateUpdatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1FinancialConnectionsAccountExpectedDeactivationDateUpdatedEventNotification::class,
        ...
        \Stripe\Events\V1FinancialConnectionsAccountSupportedPaymentMethodTypesUpdatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1FinancialConnectionsAccountSupportedPaymentMethodTypesUpdatedEventNotification::class,
        \Stripe\Events\V1FinancialConnectionsAccountUpcomingAccountNumberExpiryEventNotification::LOOKUP_TYPE => \Stripe\Events\V1FinancialConnectionsAccountUpcomingAccountNumberExpiryEventNotification::class,
        \Stripe\Events\V1FinancialConnectionsAccountUpcomingDeactivationEventNotification::LOOKUP_TYPE => \Stripe\Events\V1FinancialConnectionsAccountUpcomingDeactivationEventNotification::class,
        ...
        \Stripe\Events\V1InvoicePaymentAttemptRequiredEventNotification::LOOKUP_TYPE => \Stripe\Events\V1InvoicePaymentAttemptRequiredEventNotification::class,
        ...
        \Stripe\Events\V2BillingContractCollectionBlockedEventNotification::LOOKUP_TYPE => \Stripe\Events\V2BillingContractCollectionBlockedEventNotification::class,
        \Stripe\Events\V2BillingContractCollectionCurrentEventNotification::LOOKUP_TYPE => \Stripe\Events\V2BillingContractCollectionCurrentEventNotification::class,
        \Stripe\Events\V2BillingContractCollectionPastDueEventNotification::LOOKUP_TYPE => \Stripe\Events\V2BillingContractCollectionPastDueEventNotification::class,
        \Stripe\Events\V2BillingContractCollectionUnpaidEventNotification::LOOKUP_TYPE => \Stripe\Events\V2BillingContractCollectionUnpaidEventNotification::class,
        ...
        \Stripe\Events\V2CoreVaultNetworkTokenActivatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V2CoreVaultNetworkTokenActivatedEventNotification::class,
        \Stripe\Events\V2CoreVaultNetworkTokenAuthorizationRequirementsChangedEventNotification::LOOKUP_TYPE => \Stripe\Events\V2CoreVaultNetworkTokenAuthorizationRequirementsChangedEventNotification::class,
        \Stripe\Events\V2CoreVaultNetworkTokenDeactivatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V2CoreVaultNetworkTokenDeactivatedEventNotification::class,
        \Stripe\Events\V2CoreVaultNetworkTokenDetailsUpdatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V2CoreVaultNetworkTokenDetailsUpdatedEventNotification::class,
        \Stripe\Events\V2CoreVaultNetworkTokenSuspendedEventNotification::LOOKUP_TYPE => \Stripe\Events\V2CoreVaultNetworkTokenSuspendedEventNotification::class,
        ...
        \Stripe\Events\V2MoneyManagementEarnedCreditSucceededEventNotification::LOOKUP_TYPE => \Stripe\Events\V2MoneyManagementEarnedCreditSucceededEventNotification::class,
        ...
        \Stripe\Events\V2MoneyManagementFinancialAccountWalletExportCompletedEventNotification::LOOKUP_TYPE => \Stripe\Events\V2MoneyManagementFinancialAccountWalletExportCompletedEventNotification::class,
        \Stripe\Events\V2MoneyManagementFinancialAccountWalletExportPendingEventNotification::LOOKUP_TYPE => \Stripe\Events\V2MoneyManagementFinancialAccountWalletExportPendingEventNotification::class,
        \Stripe\Events\V2MoneyManagementFinancialAccountWalletExportReadyEventNotification::LOOKUP_TYPE => \Stripe\Events\V2MoneyManagementFinancialAccountWalletExportReadyEventNotification::class,

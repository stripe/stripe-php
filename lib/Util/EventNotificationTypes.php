...
class EventNotificationTypes
{
    const v2EventMapping = [
        ...
        \Stripe\Events\V1CustomerDiscountCreatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1CustomerDiscountCreatedEventNotification::class,
        \Stripe\Events\V1CustomerDiscountDeletedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1CustomerDiscountDeletedEventNotification::class,
        \Stripe\Events\V1CustomerDiscountUpdatedEventNotification::LOOKUP_TYPE => \Stripe\Events\V1CustomerDiscountUpdatedEventNotification::class,

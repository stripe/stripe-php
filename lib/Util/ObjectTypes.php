...
class ObjectTypes
{
    ...
    const mapping
        = [
            ...
            \Stripe\Apps\Install::OBJECT_NAME => \Stripe\Apps\Install::class,
            ...
            \Stripe\Billing\AlertNotification::OBJECT_NAME => \Stripe\Billing\AlertNotification::class,
            ...
            \Stripe\Crypto\Customer::OBJECT_NAME => \Stripe\Crypto\Customer::class,
            \Stripe\Crypto\CustomerConsumerWallet::OBJECT_NAME => \Stripe\Crypto\CustomerConsumerWallet::class,
            \Stripe\Crypto\CustomerPaymentToken::OBJECT_NAME => \Stripe\Crypto\CustomerPaymentToken::class,
            \Stripe\Crypto\DepositAddress::OBJECT_NAME => \Stripe\Crypto\DepositAddress::class,
            \Stripe\Crypto\OnrampSession::OBJECT_NAME => \Stripe\Crypto\OnrampSession::class,
            \Stripe\Crypto\OnrampTransactionLimits::OBJECT_NAME => \Stripe\Crypto\OnrampTransactionLimits::class,
            ...
            \Stripe\FinancialConnections\Consent::OBJECT_NAME => \Stripe\FinancialConnections\Consent::class,
            \Stripe\FinancialConnections\Institution::OBJECT_NAME => \Stripe\FinancialConnections\Institution::class,
            ...
            \Stripe\GiftCard::OBJECT_NAME => \Stripe\GiftCard::class,
            \Stripe\GiftCardOperation::OBJECT_NAME => \Stripe\GiftCardOperation::class,
            ...
            \Stripe\Orchestration\PaymentAttempt::OBJECT_NAME => \Stripe\Orchestration\PaymentAttempt::class,
            ...
            \Stripe\PaymentPlan::OBJECT_NAME => \Stripe\PaymentPlan::class,
            ...
            \Stripe\SharedPayment\IssuedToken::OBJECT_NAME => \Stripe\SharedPayment\IssuedToken::class,
            ...
            \Stripe\Tax\Location::OBJECT_NAME => \Stripe\Tax\Location::class,
            ...
            \Stripe\TaxFund::OBJECT_NAME => \Stripe\TaxFund::class,
            ...
            \Stripe\ThreeDSecure\Authentication::OBJECT_NAME => \Stripe\ThreeDSecure\Authentication::class,
    ...
    const v2Mapping = [
        ...
        \Stripe\V2\Core\AccountEvaluation::OBJECT_NAME => \Stripe\V2\Core\AccountEvaluation::class,
        ...
        \Stripe\V2\Core\FeeBatch::OBJECT_NAME => \Stripe\V2\Core\FeeBatch::class,
        \Stripe\V2\Core\FeeEntry::OBJECT_NAME => \Stripe\V2\Core\FeeEntry::class,
        \Stripe\V2\Core\Health\Alert::OBJECT_NAME => \Stripe\V2\Core\Health\Alert::class,
        \Stripe\V2\Core\Health\AlertHistoryEntry::OBJECT_NAME => \Stripe\V2\Core\Health\AlertHistoryEntry::class,
        \Stripe\V2\Core\Vault\GbBankAccount::OBJECT_NAME => \Stripe\V2\Core\Vault\GbBankAccount::class,
        \Stripe\V2\Core\Vault\NetworkToken::OBJECT_NAME => \Stripe\V2\Core\Vault\NetworkToken::class,
        ...
        \Stripe\V2\MoneyManagement\DebitDispute::OBJECT_NAME => \Stripe\V2\MoneyManagement\DebitDispute::class,
        \Stripe\V2\MoneyManagement\EarnedCredit::OBJECT_NAME => \Stripe\V2\MoneyManagement\EarnedCredit::class,
        \Stripe\V2\MoneyManagement\EarnedCreditSimulation::OBJECT_NAME => \Stripe\V2\MoneyManagement\EarnedCreditSimulation::class,
        \Stripe\V2\MoneyManagement\FinancialAccount::OBJECT_NAME => \Stripe\V2\MoneyManagement\FinancialAccount::class,
        \Stripe\V2\MoneyManagement\FinancialAccountStatement::OBJECT_NAME => \Stripe\V2\MoneyManagement\FinancialAccountStatement::class,
        \Stripe\V2\MoneyManagement\FinancialAccountWalletExport::OBJECT_NAME => \Stripe\V2\MoneyManagement\FinancialAccountWalletExport::class,
        \Stripe\V2\MoneyManagement\FinancialAccountWalletExportCredentials::OBJECT_NAME => \Stripe\V2\MoneyManagement\FinancialAccountWalletExportCredentials::class,
        \Stripe\V2\MoneyManagement\FinancialAddress::OBJECT_NAME => \Stripe\V2\MoneyManagement\FinancialAddress::class,
        \Stripe\V2\MoneyManagement\FinancialAddressCreditSimulation::OBJECT_NAME => \Stripe\V2\MoneyManagement\FinancialAddressCreditSimulation::class,
        \Stripe\V2\MoneyManagement\FinancialAddressDebitSimulation::OBJECT_NAME => \Stripe\V2\MoneyManagement\FinancialAddressDebitSimulation::class,
        \Stripe\V2\MoneyManagement\FinancialAddressGeneratedMicrodeposits::OBJECT_NAME => \Stripe\V2\MoneyManagement\FinancialAddressGeneratedMicrodeposits::class,
        \Stripe\V2\MoneyManagement\InboundTransfer::OBJECT_NAME => \Stripe\V2\MoneyManagement\InboundTransfer::class,
        \Stripe\V2\MoneyManagement\OutboundPayment::OBJECT_NAME => \Stripe\V2\MoneyManagement\OutboundPayment::class,
        \Stripe\V2\MoneyManagement\OutboundPaymentQuote::OBJECT_NAME => \Stripe\V2\MoneyManagement\OutboundPaymentQuote::class,
        \Stripe\V2\MoneyManagement\OutboundSetupIntent::OBJECT_NAME => \Stripe\V2\MoneyManagement\OutboundSetupIntent::class,
        \Stripe\V2\MoneyManagement\OutboundTransfer::OBJECT_NAME => \Stripe\V2\MoneyManagement\OutboundTransfer::class,
        \Stripe\V2\MoneyManagement\PayoutIntent::OBJECT_NAME => \Stripe\V2\MoneyManagement\PayoutIntent::class,
        ...
        \Stripe\V2\Provisioning\Eligibility::OBJECT_NAME => \Stripe\V2\Provisioning\Eligibility::class,
        \Stripe\V2\Provisioning\PaymentMethodRequest::OBJECT_NAME => \Stripe\V2\Provisioning\PaymentMethodRequest::class,
        \Stripe\V2\Provisioning\PaymentProfile::OBJECT_NAME => \Stripe\V2\Provisioning\PaymentProfile::class,
        \Stripe\V2\Provisioning\Project::OBJECT_NAME => \Stripe\V2\Provisioning\Project::class,
        \Stripe\V2\Provisioning\Provider::OBJECT_NAME => \Stripe\V2\Provisioning\Provider::class,
        \Stripe\V2\Provisioning\ProviderConnection::OBJECT_NAME => \Stripe\V2\Provisioning\ProviderConnection::class,
        \Stripe\V2\Provisioning\ProviderConnectionRequest::OBJECT_NAME => \Stripe\V2\Provisioning\ProviderConnectionRequest::class,
        \Stripe\V2\Provisioning\ProviderServiceDetail::OBJECT_NAME => \Stripe\V2\Provisioning\ProviderServiceDetail::class,
        \Stripe\V2\Provisioning\Resource::OBJECT_NAME => \Stripe\V2\Provisioning\Resource::class,

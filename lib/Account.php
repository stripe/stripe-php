 ...
 * @property null|(object{annual_revenue?: null|(object{amount: null|int, currency: null|string, fiscal_year_end: null|string}&\stdClass&StripeObject), estimated_worker_count?: null|int, mcc: null|string, monthly_estimated_revenue?: (object{amount: int, currency: string}&\stdClass&StripeObject), name: null|string, product_description?: null|string, support_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), support_email: null|string, support_phone: null|string, support_url: null|string, url: null|string}&\stdClass&StripeObject) $business_profile Business information about the account.
 ...
 * @property null|(object{acss_debit_payments?: string, affirm_payments?: string, afterpay_clearpay_payments?: string, alma_payments?: string, amazon_pay_payments?: string, au_becs_debit_payments?: string, automatic_indirect_tax?: string, bacs_debit_payments?: string, bancontact_payments?: string, bank_transfer_payments?: string, blik_payments?: string, boleto_payments?: string, card_issuing?: string, card_payments?: string, cartes_bancaires_payments?: string, cashapp_payments?: string, eps_payments?: string, fpx_payments?: string, gb_bank_transfer_payments?: string, giropay_payments?: string, gopay_payments?: string, grabpay_payments?: string, id_bank_transfer_payments?: string, id_bank_transfer_payments_bca?: string, ideal_payments?: string, india_international_payments?: string, jcb_payments?: string, jp_bank_transfer_payments?: string, kakao_pay_payments?: string, klarna_payments?: string, konbini_payments?: string, kr_card_payments?: string, legacy_payments?: string, link_payments?: string, mb_way_payments?: string, mobilepay_payments?: string, multibanco_payments?: string, mx_bank_transfer_payments?: string, naver_pay_payments?: string, oxxo_payments?: string, p24_payments?: string, pay_by_bank_payments?: string, payco_payments?: string, paynow_payments?: string, paypal_payments?: string, payto_payments?: string, promptpay_payments?: string, qris_payments?: string, rechnung_payments?: string, revolut_pay_payments?: string, samsung_pay_payments?: string, sepa_bank_transfer_payments?: string, sepa_debit_payments?: string, shopeepay_payments?: string, sofort_payments?: string, swish_payments?: string, tax_reporting_us_1099_k?: string, tax_reporting_us_1099_misc?: string, transfers?: string, treasury?: string, treasury_evolve?: string, treasury_fifth_third?: string, treasury_goldman_sachs?: string, twint_payments?: string, us_bank_account_ach_payments?: string, us_bank_transfer_payments?: string, zip_payments?: string}&\stdClass&StripeObject) $capabilities
 * @property null|bool $charges_enabled Whether the account can process charges.
 * @property (object{address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), address_kana?: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string, town: null|string}&\stdClass&StripeObject), address_kanji?: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string, town: null|string}&\stdClass&StripeObject), directors_provided?: bool, directorship_declaration?: null|(object{date: null|int, ip: null|string, user_agent: null|string}&\stdClass&StripeObject), executives_provided?: bool, export_license_id?: string, export_purpose_code?: string, name?: null|string, name_kana?: null|string, name_kanji?: null|string, owners_provided?: bool, ownership_declaration?: null|(object{date: null|int, ip: null|string, user_agent: null|string}&\stdClass&StripeObject), ownership_exemption_reason?: string, phone?: null|string, structure?: string, tax_id_provided?: bool, tax_id_registrar?: string, vat_id_provided?: bool, verification?: null|(object{document: (object{back: null|File|string, details: null|string, details_code: null|string, front: null|File|string}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject) $company
 * @property null|(object{application?: (object{loss_liable: bool, onboarding_owner: bool, pricing_controls: bool}&\stdClass&StripeObject), dashboard?: (object{type: string}&\stdClass&StripeObject), fees?: (object{payer: string}&\stdClass&StripeObject), is_controller?: bool, losses?: (object{payments: string}&\stdClass&StripeObject), requirement_collection?: string, stripe_dashboard?: (object{type: string}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject) $controller
 ...
 * @property (object{alternatives: null|(object{alternative_fields_due: string[], original_fields_due: string[]}&\stdClass&StripeObject)[], current_deadline: null|int, currently_due: null|string[], disabled_reason: null|string, errors: null|(object{code: string, reason: string, requirement: string}&\stdClass&StripeObject)[], eventually_due: null|string[], past_due: null|string[], pending_verification: null|string[]}&\stdClass&StripeObject) $future_requirements
 * @property null|(object{payments_pricing: null|string}&\stdClass&StripeObject) $groups The groups associated with the account.
 ...
 * @property (object{alternatives: null|(object{alternative_fields_due: string[], original_fields_due: string[]}&\stdClass&StripeObject)[], current_deadline: null|int, currently_due: null|string[], disabled_reason: null|string, errors: null|(object{code: string, reason: string, requirement: string}&\stdClass&StripeObject)[], eventually_due: null|string[], past_due: null|string[], pending_verification: null|string[]}&\stdClass&StripeObject) $requirements
 * @property null|(object{charges: (object{pause_requested: bool}&\stdClass&StripeObject), payouts: (object{pause_requested: bool}&\stdClass&StripeObject), rejected_reason?: string}&\stdClass&StripeObject) $risk_controls
 * @property null|(object{bacs_debit_payments?: (object{display_name: null|string, service_user_number: null|string}&\stdClass&StripeObject), bank_bca_onboarding?: (object{account_holder_name?: string, business_account_number?: string}&\stdClass&StripeObject), branding: (object{icon: null|File|string, logo: null|File|string, primary_color: null|string, secondary_color: null|string}&\stdClass&StripeObject), capital?: (object{payout_destination?: StripeObject, payout_destination_selector?: StripeObject}&\stdClass&StripeObject), card_issuing?: (object{tos_acceptance?: (object{date: null|int, ip: null|string, user_agent?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), card_payments: (object{decline_on?: (object{avs_failure: bool, cvc_failure: bool}&\stdClass&StripeObject), statement_descriptor_prefix: null|string, statement_descriptor_prefix_kana: null|string, statement_descriptor_prefix_kanji: null|string}&\stdClass&StripeObject), dashboard: (object{display_name: null|string, timezone: null|string}&\stdClass&StripeObject), invoices?: (object{default_account_tax_ids: null|(string|TaxId)[]}&\stdClass&StripeObject), payments: (object{statement_descriptor: null|string, statement_descriptor_kana: null|string, statement_descriptor_kanji: null|string, statement_descriptor_prefix_kana: null|string, statement_descriptor_prefix_kanji: null|string}&\stdClass&StripeObject), payouts?: (object{debit_negative_balances: bool, schedule: (object{delay_days: int, interval: string, monthly_anchor?: int, weekly_anchor?: string}&\stdClass&StripeObject), statement_descriptor: null|string}&\stdClass&StripeObject), sepa_debit_payments?: (object{creditor_id?: string}&\stdClass&StripeObject), tax_forms?: (object{consented_to_paperless_delivery: bool}&\stdClass&StripeObject), treasury?: (object{tos_acceptance?: (object{date: null|int, ip: null|string, user_agent?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject) $settings Options for customizing how the account functions within Stripe.
 * @property (object{date?: null|int, ip?: null|string, service_agreement?: string, user_agent?: null|string}&\stdClass&StripeObject) $tos_acceptance

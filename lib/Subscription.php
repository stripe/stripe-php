 ...
 * @property (object{disabled_reason: null|string, enabled: bool, liability: null|(object{account?: Account|string, type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $automatic_tax
 ...
 * @property null|(object{day_of_month: int, hour: null|int, minute: null|int, month: null|int, second: null|int}&\stdClass&StripeObject) $billing_cycle_anchor_config The fixed values used to calculate the <code>billing_cycle_anchor</code>.
 * @property null|(object{amount_gte: null|int, reset_billing_cycle_anchor: null|bool}&\stdClass&StripeObject) $billing_thresholds Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period
 ...
 * @property null|(object{comment: null|string, feedback: null|string, reason: null|string}&\stdClass&StripeObject) $cancellation_details Details about why this subscription was cancelled
 ...
 * @property int $current_period_end End of the current period that the subscription has been invoiced for. At the end of this period, a new invoice will be created. This field is deprecated starting on the <code>2025-03-31.basil</code> version, please use <code>current_period_end</code> on the items[] field instead
 * @property int $current_period_start Start of the current period that the subscription has been invoiced for. This field is deprecated starting on the <code>2025-03-31.basil</code> version, please use <code>current_period_start</code> on the items[] field instead
 ...
 * @property (object{account_tax_ids: null|(string|TaxId)[], issuer: (object{account?: Account|string, type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $invoice_settings
 * @property Collection<SubscriptionItem> $items List of subscription items, each with an attached price.
 * @property null|(object{errored_at: int, failed_transitions: (object{source_price: string, target_price: string}&\stdClass&StripeObject)[], type: string}&\stdClass&StripeObject) $last_price_migration_error Details of the most recent price migration that failed for the subscription.
 ...
 * @property null|(object{behavior: string, resumes_at: null|int}&\stdClass&StripeObject) $pause_collection If specified, payment collection for this subscription will be paused. Note that the subscription status will be unchanged and will not be updated to <code>paused</code>. Learn more about <a href="https://stripe.com/docs/billing/subscriptions/pause-payment">pausing collection</a>.
 * @property null|(object{payment_method_options: null|(object{acss_debit: null|(object{mandate_options?: (object{transaction_type: null|string}&\stdClass&StripeObject), verification_method?: string}&\stdClass&StripeObject), bancontact: null|(object{preferred_language: string}&\stdClass&StripeObject), card: null|(object{mandate_options?: (object{amount: null|int, amount_type: null|string, description: null|string}&\stdClass&StripeObject), network: null|string, request_three_d_secure: null|string}&\stdClass&StripeObject), customer_balance: null|(object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&\stdClass&StripeObject), type: null|string}&\stdClass&StripeObject), funding_type: null|string}&\stdClass&StripeObject), id_bank_transfer?: null|(object{}&\stdClass&StripeObject), konbini: null|(object{}&\stdClass&StripeObject), sepa_debit: null|(object{}&\stdClass&StripeObject), us_bank_account: null|(object{financial_connections?: (object{filters?: (object{account_subcategories?: string[], institution?: string}&\stdClass&StripeObject), permissions?: string[], prefetch: null|string[]}&\stdClass&StripeObject), verification_method?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), payment_method_types: null|string[], save_default_payment_method: null|string}&\stdClass&StripeObject) $payment_settings Payment settings passed on to invoices created by the subscription.
 * @property null|(object{interval: string, interval_count: int}&\stdClass&StripeObject) $pending_invoice_item_interval Specifies an interval for how often to bill for any pending invoice items. It is analogous to calling <a href="https://stripe.com/docs/api#create_invoice">Create an invoice</a> for the given subscription at the specified interval.
 ...
 * @property null|(object{amount_percent: null|float, destination: Account|string}&\stdClass&StripeObject) $transfer_data The account (if any) the subscription's payments will be attributed to for tax reporting, and where funds from each payment will be transferred to for each of the subscription's invoices.
 * @property null|int $trial_end If the subscription has a trial, the end of that trial.
 * @property null|(object{end_behavior: (object{missing_payment_method: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $trial_settings Settings related to subscription trials.

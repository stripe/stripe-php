 ...
 * @property null|string $billing_cadence The Billing Cadence which controls the timing of recurring invoice generation for this subscription.If unset, the subscription will bill according to its own configured schedule and create its own invoices.If set, this subscription will be billed by the cadence instead, potentially sharing invoices with the other subscriptions linked to that Cadence.
 ...
 * @property null|string $customer_account ID of the account who owns the subscription.
 ...
 * @property null|(object{errored_at: int, failed_transitions: (object{source_price: string, target_price: string}&StripeObject)[], type: string}&StripeObject) $last_price_migration_error Details of the most recent price migration that failed for the subscription.
...
class Subscription extends ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return Subscription the attached subscription
     *
     * @throws Exception\ApiErrorException if the request fails
     */
    public function attachCadence($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/attach_cadence';

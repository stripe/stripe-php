 ...
 * @property null|string $billing_mode Controls how prorations and invoices for subscriptions are calculated and orchestrated.
 * @property null|(object{updated_at?: int}&StripeObject) $billing_mode_details Details about when the current billing_mode was updated.
 * @property null|int $cancel_at A date in the future at which the subscription will automatically get canceled
 * @property bool $cancel_at_period_end Whether this subscription will (if <code>status=active</code>) or did (if <code>status=canceled</code>) cancel at the end of the current billing period. This field will be removed in a future API version. Please use <code>cancel_at</code> instead.

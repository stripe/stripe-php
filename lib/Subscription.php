 ...
 * @property null|(object{comment: null|string, feedback: null|string, feedback_option: null|Billing\FeedbackOption|string, reason: null|string}&StripeObject) $cancellation_details Details about why this subscription was cancelled
 ...
 * @property null|(object{payment_method_options: null|(object{acss_debit: null|(object{mandate_options?: (object{transaction_type: null|string}&StripeObject), verification_method?: string}&StripeObject), bacs_debit?: null|(object{debit_behavior: string, verification_method?: string}&StripeObject), bancontact: null|(object{preferred_language: string}&StripeObject), billie?: null|(object{company_details?: (object{registered_address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&StripeObject), registered_name: null|string, registration_number: null|string, registration_type?: string, vat: null|string}&StripeObject)}&StripeObject), bizum?: null|(object{mandate_options?: (object{amount?: int, amount_type?: string}&StripeObject)}&StripeObject), blik?: null|(object{mandate_options?: (object{expires_at: null|int}&StripeObject)}&StripeObject), card: null|(object{mandate_options?: (object{amount: null|int, amount_type: null|string, description: null|string}&StripeObject), network: null|string, request_three_d_secure: null|string}&StripeObject), check_scan?: null|(object{}&StripeObject), customer_balance: null|(object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&StripeObject), type: null|string}&StripeObject), funding_type: null|string}&StripeObject), id_bank_transfer?: null|(object{}&StripeObject), konbini: null|(object{}&StripeObject), payto: null|(object{mandate_options?: (object{amount: null|int, amount_type: null|string, purpose: null|string}&StripeObject)}&StripeObject), pix: null|(object{expires_after_seconds?: int, mandate_options?: (object{amount: null|int, amount_includes_iof: null|string, end_date: null|string, payment_schedule: null|string}&StripeObject)}&StripeObject), sepa_debit: null|(object{}&StripeObject), upi: null|(object{mandate_options?: (object{amount: null|int, amount_type: null|string, description: null|string, end_date: null|int}&StripeObject)}&StripeObject), us_bank_account: null|(object{financial_connections?: (object{filters?: (object{account_subcategories?: string[], institution?: string}&StripeObject), permissions?: string[], prefetch: null|string[]}&StripeObject), verification_method?: string}&StripeObject), wechat_pay?: null|(object{app_id?: string, client?: string}&StripeObject)}&StripeObject), payment_method_types: null|string[], save_default_payment_method: null|string}&StripeObject) $payment_settings Payment settings passed on to invoices created by the subscription.
 ...
 * @property null|(object{end_behavior: (object{billing_cycle_anchor: null|string, missing_payment_method: string}&StripeObject)}&StripeObject) $trial_settings Settings related to subscription trials.

...
class WebhookEndpoint extends ApiResource
{
     ...
     *
     * @param null|array{api_version?: string, connect?: bool, description?: null|string, enabled_events: string[], expand?: string[], metadata?: array<string, string>, url: string} $params
     ...
     * @param null|array{description?: null|string, disabled?: bool, enabled_events?: string[], expand?: string[], metadata?: array<string, string>, url?: string} $params
     * @param null|array|string $opts
     *

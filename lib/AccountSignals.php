 ...
 * @property null|(object{evaluated_at: null|int, indicators: null|(object{description: string, impact: string, indicator: string}&StripeObject)[], probability: null|float, risk_level: string, signal_id: null|string}&StripeObject) $fraud_intent The fraud intent signal of the account.

...
class AccountService extends AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{expand?: string[], payouts_action?: string, reason: string} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\Account
     *
     ...
     *
     * Only accounts that were rejected by your platform can be unrejected. This API
     * cannot be used to unreject accounts that were rejected by Stripe.
     *
     * Unreject will only enable charges and/or payouts if there are no other
     * restrictions other than those placed by a previous rejection. If you have
     * separately paused charges and/or payouts outside of rejection, those pauses will
     ...
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     */
    public function unreject($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/v1/accounts/%s/unreject', $id), $params, $opts);
    }
     ...
     * @return string
     */
    public function serializeBatchDelete($account, $params = null, $opts = null)
    {
        $itemId = (new \Stripe\Util\RandomGenerator())->uuid();
        $opts = \Stripe\Util\RequestOptions::parse($opts);
        $stripeVersion = isset($opts->headers['Stripe-Version']) ? $opts->headers['Stripe-Version'] : \Stripe\Stripe::getApiVersion();
     ...
     * @return string
     */
    public function serializeBatchUpdate($account, $params = null, $opts = null)
    {
        $itemId = (new \Stripe\Util\RandomGenerator())->uuid();
        $opts = \Stripe\Util\RequestOptions::parse($opts);
        $stripeVersion = isset($opts->headers['Stripe-Version']) ? $opts->headers['Stripe-Version'] : \Stripe\Stripe::getApiVersion();

...
class TopupService extends AbstractService
{
     ...
     *
     * @param null|array{amount: int, currency: string, description?: string, expand?: string[], metadata?: array<string, string>, source?: string, statement_descriptor?: string, transfer_group?: string} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\Topup
     *

 ...
 */
class BillingEvaluationService extends \Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \Stripe\Radar\BillingEvaluation
     *
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     */
    public function create($params = null, $opts = null)
    {
        return $this->request('post', '/v1/radar/billing_evaluations', $params, $opts);
    }
}

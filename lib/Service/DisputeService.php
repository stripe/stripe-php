...
class DisputeService extends AbstractService
{
     ...
     * submit and are essentially dismissing the dispute (accepting it), acknowledging
     * it as lost.
     *
     ...
     * @return string
     */
    public function serializeBatchClose($dispute, $params = null, $opts = null)
    {
        ...
        $item['path_params'] = ['dispute' => $dispute];

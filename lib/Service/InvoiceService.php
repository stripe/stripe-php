...
class InvoiceService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{amount_requested?: int, expand?: string[], payment_intent?: string, payment_record?: string, payment_record_data?: array{amount: int, currency: string, metadata?: null|StripeObject, money_movement_type: string, paid_at?: int, payment_reference?: string}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     *
     ...
     *
     * @param string $id
     * @param null|array{expand?: string[], invoice_metadata?: null|StripeObject, lines: array{behavior: string, id: string}[]} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     *

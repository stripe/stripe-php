...
class InvoiceService extends AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{amount_requested?: int, expand?: string[], payment_intent?: string, payment_record?: string, payment_record_data?: array{amount: int, currency: string, metadata?: null|array<string, string>, money_movement_type: string, paid_at?: int, payment_reference?: string}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\Invoice
     *
    ...
    /**
     * Detaches a payment from the invoice, removing it from the list of
     * <code>payments</code>.
     *
     * @param string $id
     ...
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     */
    public function detachPayment($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/v1/invoices/%s/detach_payment', $id), $params, $opts);
    }
     ...
     * @return string
     */
    public function serializeBatchCreatePreview($params = null, $opts = null)
    {
        $itemId = (new \Stripe\Util\RandomGenerator())->uuid();
        $opts = \Stripe\Util\RequestOptions::parse($opts);
        $stripeVersion = isset($opts->headers['Stripe-Version']) ? $opts->headers['Stripe-Version'] : \Stripe\Stripe::getApiVersion();

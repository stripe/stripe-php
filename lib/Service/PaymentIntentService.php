...
class PaymentIntentService extends AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{amount: int, application_fee_amount?: int, description?: string, expand?: string[], hooks?: array{inputs?: array{tax?: array{calculation: null|string}}}, metadata?: array<string, string>, payment_method_options?: array{card?: array{request_partial_authorization?: string}}, statement_descriptor?: string, transfer_data?: array{amount?: int}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\PaymentIntent
     *

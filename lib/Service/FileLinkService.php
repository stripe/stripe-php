...
class FileLinkService extends AbstractService
{
     ...
     *
     * @param null|array{expand?: string[], expires_at?: int, file: string, metadata?: array<string, string>} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     ...
     *
     * @param string $id
     * @param null|array{expand?: string[], expires_at?: null|array|int|string, metadata?: array<string, string>} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\FileLink
     *

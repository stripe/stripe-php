...
class ReaderService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{amount_tip?: int, card?: array{cvc?: string, exp_month: int, exp_year: int, number: string}, card_present?: array{number?: string}, expand?: string[], gift_card?: array{brand: string, track_2: string}, interac_present?: array{number?: string}, type?: string} $params

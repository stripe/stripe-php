...
class PaymentLocationService extends AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{address?: array{city?: null|string, country?: string, line1?: null|string, line2?: null|string, postal_code?: null|string, state?: null|string}, business_registration?: array{siret?: null|string}, display_name?: string, expand?: string[], onboarding_data_update_acknowledged?: bool} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\PaymentLocation
     *

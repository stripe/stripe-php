...
class AccountActivityService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{account_details?: array{account?: string, customer?: string, data?: array{defaults?: array{profile: array{business_url: string, doing_business_as?: string, product_description?: string}}, identity?: array{business_details: array{registered_name?: string}}}}, account_evaluation?: string, account_restricted?: array{reason: string}, account_reviewed?: array{outcome: string}, account_suspended?: array{reason: string}, login_attempt?: array{client_details: array{data?: array{ip: string, referrer?: string, user_agent?: string}, radar_session?: string}}, login_decision?: array{status: string}, metadata?: array<string, string>, occurred_at?: string, registration_attempt?: array{client_details: array{data?: array{ip: string, referrer?: string, user_agent?: string}, radar_session?: string}}, registration_decision?: array{status: string}, type: string} $params

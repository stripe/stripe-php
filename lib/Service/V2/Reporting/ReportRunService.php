...
class ReportRunService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{report: string, report_parameters: array<string, array{array_value?: array{items: string[]}, string_value?: string, timestamp_value?: string}>, result_options?: array{compress_file?: bool}} $params

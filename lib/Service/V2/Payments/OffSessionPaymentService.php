...
class OffSessionPaymentService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{amount: \Stripe\StripeObject, amount_details?: array{discount_amount?: int, enforce_arithmetic_validation?: bool, line_items?: array{discount_amount?: int, product_code?: string, product_name: string, quantity: int, tax?: array{total_tax_amount: int}, unit_cost: int, unit_of_measure?: string}[], shipping?: array{amount?: int, from_postal_code?: string, to_postal_code?: string}, tax?: array{total_tax_amount: int}}, application_fee_amount?: \Stripe\StripeObject, cadence: string, capture?: array{capture_method: string}, customer: string, description?: string, include?: string[], metadata?: array<string, string>, on_behalf_of?: string, payment_details?: array{customer_reference?: string, order_reference?: string}, payment_method?: string, payment_method_data?: array{billing_details?: array{address?: array{city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, state?: string}, email?: string, name?: string, phone?: string}, card?: array{exp_month: string, exp_year: string, number?: string}, type: string}, payment_method_options?: array{card?: array{mcc?: string, network_transaction_id?: string}}, payments_orchestration?: array{enabled: bool}, retry_details?: array{retry_policy?: string, retry_strategy?: string}, statement_descriptor?: string, statement_descriptor_suffix?: string, target_date?: string, test_clock?: string, transfer_data?: array{amount?: int, destination: string}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\V2\Payments\OffSessionPayment
     *

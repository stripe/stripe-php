...
class SettlementAllocationIntentService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{amount: \Stripe\StripeObject, expected_settlement_date: string, financial_account: string, metadata?: array<string, string>, reference: string} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\V2\Payments\SettlementAllocationIntent
     *
     ...
     *
     * @param string $id
     * @param null|array{amount?: \Stripe\StripeObject, reference?: string} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\V2\Payments\SettlementAllocationIntent
     *

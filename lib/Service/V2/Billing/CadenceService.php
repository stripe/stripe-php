...
class CadenceService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{lookup_key?: string, metadata?: array<string, null|string>, payer?: array{billing_profile?: string}, settings?: array{bill?: array{id: string, version?: string}, collection?: array{id: string, version?: string}}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\V2\Billing\Cadence
     *

...
class IntentService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{actions: array{type: string, apply?: array{effective_at?: array{timestamp?: string, type: string}, type: string, discount?: array{coupon?: string, promotion_code?: string, type: string}, invoice_discount_rule?: array{applies_to: string, type: string, percent_off?: array{maximum_applications: array{type: string}, percent_off: string}}, spend_modifier_rule?: array{applies_to: string, type: string, max_billing_period_spend?: array{amount: array{type: string, custom_pricing_unit?: array{id?: string, value: string}}, custom_pricing_unit_overage_rate: array{id: string}}}}, deactivate?: array{cancellation_details?: array{comment?: string, feedback?: string}, collect_at?: string, effective_at?: array{timestamp?: string, type: string}, pricing_plan_subscription_details: array{overrides?: array{partial_period_behaviors: array{type: string, license_fee?: array{credit_proration_behavior: string}}[]}, pricing_plan_subscription: string}, type: string}, modify?: array{collect_at?: string, effective_at?: array{timestamp?: string, type: string}, pricing_plan_subscription_details: array{component_configurations?: array{quantity?: int, lookup_key?: string, pricing_plan_component?: string}[], new_pricing_plan?: string, new_pricing_plan_version?: string, overrides?: array{partial_period_behaviors: array{type: string, license_fee?: array{credit_proration_behavior: string, debit_proration_behavior: string}, recurring_credit_grant?: array{create_behavior: string}}[]}, pricing_plan_subscription: string}, type: string}, remove?: array{effective_at?: array{type: string}, type: string, invoice_discount_rule?: string, spend_modifier_rule?: string}, subscribe?: array{collect_at?: string, effective_at?: array{timestamp?: string, type: string}, type: string, pricing_plan_subscription_details?: array{component_configurations?: array{quantity?: int, lookup_key?: string, pricing_plan_component?: string}[], metadata?: array<string, string>, overrides?: array{partial_period_behaviors: array{type: string, license_fee?: array{debit_proration_behavior: string}, recurring_credit_grant?: array{create_behavior: string}}[]}, pricing_plan: string, pricing_plan_version: string}, v1_subscription_details?: array{description?: string, items: array{metadata?: array<string, string>, price: string, quantity?: int}[], metadata?: array<string, string>}}}[], currency: string, cadence?: string, cadence_data?: array{billing_cycle: array{interval_count?: int, type: string, day?: array{time?: array{hour: int, minute: int, second: int}}, month?: array{day_of_month: int, month_of_year?: int, time?: array{hour: int, minute: int, second: int}}, week?: array{day_of_week: int, time?: array{hour: int, minute: int, second: int}}, year?: array{day_of_month?: int, month_of_year?: int, time?: array{hour: int, minute: int, second: int}}}, payer: array{billing_profile?: string, billing_profile_data?: array{customer: string, default_payment_method?: string}}, settings?: array{bill?: array{id: string, version?: string}, collection?: array{id: string, version?: string}}}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\V2\Billing\Intent
     *

...
class ServiceActionService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{lookup_key?: string, service_interval: string, service_interval_count: int, type: string, credit_grant?: array{amount: array{type: string, custom_pricing_unit?: array{id: string, value: string}, monetary?: \Stripe\StripeObject}, applicability_config: array{scope: array{billable_items?: string[], price_type?: string}}, category?: string, expiry_config: array{type: string}, name: string, priority?: int}, credit_grant_per_tenant?: array{amount: array{type: string, custom_pricing_unit?: array{id: string, value: string}, monetary?: \Stripe\StripeObject}, applicability_config: array{scope: array{billable_items?: string[], price_type?: string}}, category?: string, expiry_config: array{type: string}, grant_condition: array{type: string, meter_event_first_per_period?: array{meter_segment_conditions: array{type: string, dimension?: array{payload_key: string, value: string}}[]}}, name: string, priority?: int}} $params

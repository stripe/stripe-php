...
class EventDestinationService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{description?: string, enabled_events: string[], event_payload: string, events_from?: string[], include?: string[], metadata?: array<string, string>, name: string, snapshot_api_version?: string, type: string, amazon_eventbridge?: array{aws_account_id: string, aws_region: string}, azure_event_grid?: array{azure_region: string, azure_resource_group_name: string, azure_subscription_id: string}, webhook_endpoint?: array{url: string}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *

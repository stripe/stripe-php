...
class WorkflowRunService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @return \Stripe\V2\Collection<\Stripe\V2\Core\WorkflowRun>
     *
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     */
    public function all($params = null, $opts = null)
    {
        return $this->requestCollection('get', '/v2/core/workflow_runs', $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/v2/core/workflow_runs/%s', $id), $params, $opts);
    }
}

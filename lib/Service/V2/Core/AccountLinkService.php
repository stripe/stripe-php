...
class AccountLinkService extends \Stripe\Service\AbstractService
{
     ...
     * information.
     *
     * @param null|array{account: string, use_case: array{account_onboarding?: array{collection_options?: array{fields?: string, future_requirements?: string}, refresh_url: string, return_url?: string}, account_update?: array{collection_options?: array{fields?: string, future_requirements?: string}, refresh_url: string, return_url?: string}, recipient_onboarding?: array{collection_options?: array{fields?: string, future_requirements?: string}, refresh_url: string, return_url?: string}, recipient_update?: array{collection_options?: array{fields?: string, future_requirements?: string}, refresh_url: string, return_url?: string}, type: string}} $params

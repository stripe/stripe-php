...
class ReceivedDebitService extends \Stripe\Service\AbstractService
{
    ...
    {
        return $this->requestCollection('get', '/v2/money_management/received_debits', $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/v2/money_management/received_debits/%s', $id), $params, $opts);
    }
}

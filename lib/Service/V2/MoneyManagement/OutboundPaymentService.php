...
class OutboundPaymentService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{amount: \Stripe\StripeObject, delivery_options?: array{bank_account?: string, paper_check?: array{attachment?: string, memo?: string, shipping_speed?: string, signature: string}, speed?: string}, description?: string, from: array{currency: string, financial_account: string}, metadata?: array<string, string>, outbound_payment_quote?: string, purpose?: string, recipient_notification?: array{setting: string}, recipient_verification?: string, statement_descriptor?: string, to: array{currency?: string, payout_method?: string, payout_method_options?: array{bank_account?: array{preferred_network_options?: array{ach?: array{addenda?: string, submission?: string, transaction_purpose?: string}}, preferred_networks: string[]}}, recipient: string}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\V2\MoneyManagement\OutboundPayment
     *

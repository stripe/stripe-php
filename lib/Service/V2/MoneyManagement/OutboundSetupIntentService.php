...
class OutboundSetupIntentService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param null|array{payout_method?: string, payout_method_data?: array{bank_account?: array{account_number: string, bank_account_type?: string, branch_number?: string, country: string, currency: string, routing_number?: string, swift_code?: string}, card?: array{currency: string, exp_month: string, exp_year: string, number: string}, type: string}, usage_intent?: string} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\V2\MoneyManagement\OutboundSetupIntent
     *

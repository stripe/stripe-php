...
class PlanService extends AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{active?: bool, expand?: string[], metadata?: array<string, string>, nickname?: string, product?: string, trial_period_days?: int} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\Plan
     *

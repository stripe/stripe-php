...
class ShippingRateService extends AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{active?: bool, expand?: string[], fixed_amount?: array{currency_options?: \Stripe\StripeObject}, metadata?: array<string, string>, tax_behavior?: string} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\ShippingRate
     *

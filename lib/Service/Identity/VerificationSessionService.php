...
class VerificationSessionService extends \Stripe\Service\AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{confirm?: bool, expand?: string[], metadata?: array<string, string>, options?: array{document?: null|array{allowed_types?: string[], require_id_number?: bool, require_live_capture?: bool, require_matching_selfie?: bool}}, provided_details?: array{email?: string, phone?: string}, type?: string, user_consent?: array{date: int, ip: string, user_agent?: string}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\Identity\VerificationSession
     *

...
class CouponService extends AbstractService
{
     ...
     * it.
     *
     * @param null|array{amount_off?: int, applies_to?: array{products?: string[]}, currency?: string, currency_options?: \Stripe\StripeObject, duration?: string, duration_in_months?: int, expand?: string[], id?: string, max_redemptions?: int, metadata?: array<string, string>, name?: string, percent_off?: float, redeem_by?: int} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     ...
     *
     * @param string $id
     * @param null|array{currency_options?: \Stripe\StripeObject, expand?: string[], metadata?: array<string, string>, name?: string} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\Coupon
     *

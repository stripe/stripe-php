...
class PaymentMethodService extends \Stripe\Service\AbstractService
{
     ...
     * PaymentMethods attached to a Customer for payments, you should use the [List a Customer’s PaymentMethods](/docs/api/payment_methods/customer_list) API instead.
     *
     ...
     * with [setup_future_usage](/docs/api/payment_intents/create#create_payment_intent-setup_future_usage).
     ...
     * use, which makes later declines and payment friction more likely. See [Optimizing cards for future payments](/docs/payments/payment-intents#future-usage) for more information about setting up future payments.
     *
     ...
     *
     * Instead of creating a PaymentMethod directly, we recommend using the [PaymentIntents](/docs/payments/accept-a-payment) API to accept a
     * payment immediately or the [SetupIntent](/docs/payments/save-and-reuse) API to collect payment
     ...
     * payment method attached to a Customer, you should use [Retrieve a Customer’s PaymentMethods](/docs/api/payment_methods/customer).
     *
     * @param string $id
     * @param null|array $params
     * @param null|array|\Stripe\Util\RequestOptions $opts

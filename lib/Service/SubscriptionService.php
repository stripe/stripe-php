...
class SubscriptionService extends AbstractService
{
    ...
    /**
     * Attach a Cadence to an existing subscription. Once attached, the subscription
     * will be billed by the cadence, potentially sharing invoices with the other
     * subscriptions linked to the Cadence.
     *
     * @param string $id

...
class SubscriptionService extends AbstractService
{
    ...
    /**
     * Attach a Billing Cadence to an existing subscription. When attached, the
     * subscription is billed by the Billing Cadence, potentially sharing invoices with
     * the other subscriptions linked to the Billing Cadence.
     *
     * @param string $id
     * @param null|array{billing_cadence: string, expand?: string[]} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     ...
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     */
    public function attachCadence($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/v1/subscriptions/%s/attach_cadence', $id), $params, $opts);
    }
     ...
     *
     * @param string $id
     * @param null|array{billing_cycle_anchor?: array{timestamp?: int, type: string}, expand?: string[], payment_behavior?: string, proration_behavior?: string, proration_date?: int} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\Subscription
     *
     ...
     * @return string
     */
    public function serializeBatchCancel($subscription_exposed_id, $params = null, $opts = null)
    {
     ...
     * @return string
     */
    public function serializeBatchPause($subscription, $params = null, $opts = null)
    {
        $itemId = (new \Stripe\Util\RandomGenerator())->uuid();
        $opts = \Stripe\Util\RequestOptions::parse($opts);
        $stripeVersion = isset($opts->headers['Stripe-Version']) ? $opts->headers['Stripe-Version'] : \Stripe\Stripe::getApiVersion();
     ...
     * @return string
     */
    public function serializeBatchResume($subscription, $params = null, $opts = null)
    {
        $itemId = (new \Stripe\Util\RandomGenerator())->uuid();
        $opts = \Stripe\Util\RequestOptions::parse($opts);
        $stripeVersion = isset($opts->headers['Stripe-Version']) ? $opts->headers['Stripe-Version'] : \Stripe\Stripe::getApiVersion();

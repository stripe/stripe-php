...
class SubscriptionService extends AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{billing_mode: string, expand?: string[]} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\Subscription
     *

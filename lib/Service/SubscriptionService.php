...
class SubscriptionService extends AbstractService
{
     ...
     *
     * @param null|array{automatic_tax?: array{enabled: bool}, collection_method?: string, created?: array{gt?: int, gte?: int, lt?: int, lte?: int}|int, current_period_end?: array{gt?: int, gte?: int, lt?: int, lte?: int}|int, current_period_start?: array{gt?: int, gte?: int, lt?: int, lte?: int}|int, customer?: string, customer_account?: string, ending_before?: string, expand?: string[], limit?: int, plan?: string, price?: string, starting_after?: string, status?: string, test_clock?: string} $params

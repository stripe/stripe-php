...
class PaymentRecordService extends AbstractService
{
     ...
     *
     * @param null|array{amount_requested: array{currency: string, value: int}, canceled?: array{canceled_at: int, payment_evaluations?: string[], reason?: string}, customer_details?: array{customer?: string, email?: string, name?: string, phone?: string}, customer_presence?: string, description?: string, expand?: string[], failed?: array{failed_at: int, failure_code?: string, payment_evaluations?: string[], processor_details?: array{custom?: array{payment_reference: string}, type: string}}, guaranteed?: array{guaranteed_at: int, payment_evaluations?: string[], processor_details?: array{custom?: array{payment_reference: string}, type: string}}, initiated_at: int, metadata?: null|array<string, string>, outcome?: string, payment_method_details: array{billing_details?: array{address?: array{city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, state?: string}, email?: string, name?: string, phone?: string}, card?: array{checks?: array{address_line1_check?: string, address_postal_code_check?: string, cvc_check?: string}}, custom?: array{display_name?: string, type?: string}, payment_method?: string, type?: string}, processor_details?: array{custom?: array{payment_reference: string}, type: string}, shipping_details?: array{address?: array{city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, state?: string}, name?: string, phone?: string}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\PaymentRecord
     *
     ...
     *
     * @param string $id
     * @param null|array{canceled?: array{canceled_at: int, payment_evaluations?: string[], reason?: string}, description?: string, expand?: string[], failed?: array{failed_at: int, failure_code?: string, payment_evaluations?: string[], processor_details?: array{custom?: array{payment_reference: string}, type: string}}, guaranteed?: array{guaranteed_at: int, payment_evaluations?: string[], processor_details?: array{custom?: array{payment_reference: string}, type: string}}, initiated_at: int, metadata?: null|array<string, string>, outcome?: string, payment_method_details?: array{billing_details?: array{address?: array{city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, state?: string}, email?: string, name?: string, phone?: string}, card?: array{checks?: array{address_line1_check?: string, address_postal_code_check?: string, cvc_check?: string}}, custom?: array{display_name?: string, type?: string}, payment_method?: string, type?: string}, shipping_details?: array{address?: array{city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, state?: string}, name?: string, phone?: string}} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\PaymentRecord
     *

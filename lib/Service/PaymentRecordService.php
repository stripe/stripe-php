...
class PaymentRecordService extends AbstractService
{
     ...
     *
     * @param string $id
     * @param null|array{canceled_at: int, expand?: string[], metadata?: null|\Stripe\StripeObject} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\PaymentRecord
     *
     ...
     *
     * @param string $id
     * @param null|array{expand?: string[], failed_at: int, metadata?: null|\Stripe\StripeObject} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\PaymentRecord
     *
     ...
     *
     * @param string $id
     * @param null|array{expand?: string[], guaranteed_at: int, metadata?: null|\Stripe\StripeObject} $params
     * @param null|RequestOptionsArray|\Stripe\Util\RequestOptions $opts
     *
     * @return \Stripe\PaymentRecord
     *

 ...
 * @property null|string $performance_location Indicates the line item represents a performance where the venue location might determine the tax, not the customer address. Leave empty if the tax code doesn't require a tax location. If you provide this value for tax codes with an <code>optional</code> location requirement, it overrides the customer address.

 ...
 * @property ((object{dropdown?: (object{options: (object{label: string, value: string}&\stdClass&StripeObject)[]}&\stdClass&StripeObject), key: string, label: (object{custom: null|string, type: string}&\stdClass&StripeObject), numeric?: (object{maximum_length: null|int, minimum_length: null|int}&\stdClass&StripeObject), optional: bool, text?: (object{maximum_length: null|int, minimum_length: null|int}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject))[] $custom_fields Collect additional information from your customer using custom fields. Up to 3 fields are supported.

 ...
 * @property null|((object{adjustable_quantity: null|(object{enabled: bool, maximum: null|int, minimum: null|int}&\stdClass&StripeObject), price: string, quantity: int}&\stdClass&StripeObject))[] $optional_items The optional items presented to the customer at checkout.

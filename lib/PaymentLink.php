 ...
 * @property (object{hosted_confirmation?: (object{custom_message: null|string}&\stdClass&StripeObject), redirect?: (object{url: string}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject) $after_completion
 ...
 * @property (object{enabled: bool, liability: null|(object{account?: Account|string, type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $automatic_tax
 ...
 * @property null|(object{payment_method_reuse_agreement: null|(object{position: string}&\stdClass&StripeObject), promotions: null|string, terms_of_service: null|string}&\stdClass&StripeObject) $consent_collection When set, provides configuration to gather active consent from customers.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property ((object{dropdown?: (object{default_value: null|string, options: (object{label: string, value: string}&\stdClass&StripeObject)[]}&\stdClass&StripeObject), key: string, label: (object{custom: null|string, type: string}&\stdClass&StripeObject), numeric?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int}&\stdClass&StripeObject), optional: bool, text?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject))[] $custom_fields Collect additional information from your customer using custom fields. Up to 3 fields are supported.
 * @property (object{after_submit: null|(object{message: string}&\stdClass&StripeObject), shipping_address: null|(object{message: string}&\stdClass&StripeObject), submit: null|(object{message: string}&\stdClass&StripeObject), terms_of_service_acceptance: null|(object{message: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $custom_text
 ...
 * @property null|(object{enabled: bool, invoice_data: null|(object{account_tax_ids: null|(string|TaxId)[], custom_fields: null|(object{name: string, value: string}&\stdClass&StripeObject)[], description: null|string, footer: null|string, issuer: null|(object{account?: Account|string, type: string}&\stdClass&StripeObject), metadata: null|StripeObject, rendering_options: null|(object{amount_tax_display: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject) $invoice_creation Configuration for creating invoice for payment mode payment links.
 ...
 * @property (object{enabled: bool}&\stdClass&StripeObject) $phone_number_collection
 * @property null|(object{completed_sessions: (object{count: int, limit: int}&\stdClass&StripeObject)}&\stdClass&StripeObject) $restrictions Settings that restrict the usage of a payment link.
 * @property null|(object{allowed_countries: string[]}&\stdClass&StripeObject) $shipping_address_collection Configuration for collecting the customer's shipping address.
 * @property ((object{shipping_amount: int, shipping_rate: ShippingRate|string}&\stdClass&StripeObject))[] $shipping_options The shipping rate options applied to the session.
 ...
 * @property null|(object{description: null|string, invoice_settings: (object{issuer: (object{account?: Account|string, type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), metadata: StripeObject, trial_period_days: null|int, trial_settings: null|(object{end_behavior: (object{missing_payment_method: string}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject) $subscription_data When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use <code>subscription_data</code>.
 * @property (object{enabled: bool, required: string}&\stdClass&StripeObject) $tax_id_collection
 * @property null|(object{amount: null|int, destination: Account|string}&\stdClass&StripeObject) $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to.

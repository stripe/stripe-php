 ...
 * @property null|(object{requested: bool, status: string, status_details: ((object{code: string, resolution: null|string, restriction?: string}&\stdClass&\Stripe\StripeObject))[]}&\stdClass&\Stripe\StripeObject) $card_issuing Toggle settings for enabling/disabling a feature
 * @property null|(object{requested: bool, status: string, status_details: ((object{code: string, resolution: null|string, restriction?: string}&\stdClass&\Stripe\StripeObject))[]}&\stdClass&\Stripe\StripeObject) $deposit_insurance Toggle settings for enabling/disabling a feature
 * @property null|(object{aba?: (object{bank?: string, requested: bool, status: string, status_details: ((object{code: string, resolution: null|string, restriction?: string}&\stdClass&\Stripe\StripeObject))[]}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $financial_addresses Settings related to Financial Addresses features on a Financial Account
 ...
 * @property null|(object{requested: bool, status: string, status_details: ((object{code: string, resolution: null|string, restriction?: string}&\stdClass&\Stripe\StripeObject))[]}&\stdClass&\Stripe\StripeObject) $intra_stripe_flows Toggle settings for enabling/disabling a feature

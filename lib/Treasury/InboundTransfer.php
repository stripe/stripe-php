 ...
 * @property null|(object{code: string}&\Stripe\StripeObject&\stdClass) $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.

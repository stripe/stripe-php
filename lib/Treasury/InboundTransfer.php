 ...
 * @property null|(object{code: string}&\stdClass&\Stripe\StripeObject) $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property (object{received_debit: null|string}&\stdClass&\Stripe\StripeObject) $linked_flows
 ...
 * @property null|(object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&\Stripe\StripeObject), email: null|string, name: null|string}&\stdClass&\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\Stripe\Mandate, network: string, routing_number: null|string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property (object{canceled_at?: null|int, failed_at: null|int, succeeded_at: null|int}&\stdClass&\Stripe\StripeObject) $status_transitions

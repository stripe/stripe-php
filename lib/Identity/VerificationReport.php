 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Stripe\StripeObject), blocked_by_entry?: null|BlocklistEntry|string, dob?: null|(object{day: null|int, month: null|int, year: null|int}&\Stripe\StripeObject), error: null|(object{code: null|string, reason: null|string}&\Stripe\StripeObject), expiration_date?: null|(object{day: null|int, month: null|int, year: null|int}&\Stripe\StripeObject), files: null|string[], first_name: null|string, issued_date: null|(object{day: null|int, month: null|int, year: null|int}&\Stripe\StripeObject), issuing_country: null|string, last_name: null|string, number?: null|string, sex?: null|string, status: string, type: null|string, unparsed_place_of_birth?: null|string, unparsed_sex?: null|string}&\Stripe\StripeObject) $document Result from a document check
 * @property null|(object{address_match_confidence?: string, details?: (object{days_since_domain_creation?: float, days_since_ownership_started?: float, domain_country?: string}&\Stripe\StripeObject), domain_country?: string, email: null|string, email_exists_confidence?: string, error: null|(object{code: null|string, reason: null|string}&\Stripe\StripeObject), name_match_confidence?: string, observed_domain_tenure_days?: float, observed_email_tenure_days?: float, phone_match_confidence?: string, status: string}&\Stripe\StripeObject) $email Result from a email check
 ...
 * @property null|(object{address_match_confidence?: string, carrier?: string, error: null|(object{code: null|string, reason: null|string}&\Stripe\StripeObject), line_type?: string, name_match_confidence?: string, observed_phone_tenure_days?: float, phone: null|string, status: string}&\Stripe\StripeObject) $phone Result from a phone check
 * @property null|(object{blocked_by_entry?: null|BlocklistEntry|string, document: null|string, error: null|(object{code: null|string, reason: null|string}&\Stripe\StripeObject), selfie: null|string, status: string}&\Stripe\StripeObject) $selfie Result from a selfie check
 * @property null|(object{fraudulent_email?: (object{indicators: (object{explanation: string, impact: string, indicator: string}&\Stripe\StripeObject)[], risk_level: string}&\Stripe\StripeObject), fraudulent_person?: (object{indicators: (object{explanation: string, impact: string, indicator: string}&\Stripe\StripeObject)[], risk_level: string}&\Stripe\StripeObject), fraudulent_phone?: (object{indicators: (object{explanation: string, impact: string, indicator: string}&\Stripe\StripeObject)[], risk_level: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $signals
...
class VerificationReport extends \Stripe\ApiResource
{
     ...
     *
     * @param null|array{blocked_by_entry?: string, client_reference_id?: string, created?: array|int, ending_before?: string, expand?: string[], limit?: int, starting_after?: string, type?: string, verification_session?: string} $params

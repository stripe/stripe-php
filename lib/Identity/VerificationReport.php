 ...
 * @property null|(object{document: null|string, error: null|(object{code: null|string, reason: null|string}&\Stripe\StripeObject), selfie: null|string, status: string, blocked_by_entry?: null|BlocklistEntry|string}&\Stripe\StripeObject) $selfie Result from a selfie check

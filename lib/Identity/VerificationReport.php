 ...
 * @property null|(object{details?: (object{days_since_domain_creation?: float, days_since_ownership_started?: float, domain_country?: string}&\Stripe\StripeObject), email: null|string, error: null|(object{code: null|string, reason: null|string}&\Stripe\StripeObject), status: string}&\Stripe\StripeObject) $email Result from a email check

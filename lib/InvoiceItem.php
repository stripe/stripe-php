 ...
 * @property null|(object{type: string}&StripeObject)[] $invoicing_rules The rules that control when this invoice item is eligible for invoicing. All rules must be satisfied for the item to be invoiced.
 ...
 * @property null|(object{pricing_plan_subscription_details?: null|(object{pricing_plan_subscription: string, pricing_plan_version: string}&StripeObject), rate_card_subscription_details?: null|(object{rate_card_subscription: string, rate_card_version: string}&StripeObject), schedule_details?: null|(object{schedule: string, subscription: null|string}&StripeObject), subscription_details: null|(object{subscription: string, subscription_item?: string}&StripeObject), type: string}&StripeObject) $parent The parent that generated this invoice item.

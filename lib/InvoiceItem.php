 ...
 * @property null|(object{credited_items?: (object{invoice_item?: string, invoice_line_items?: (object{invoice: string, invoice_line_items: string[]}&StripeObject), type: string}&StripeObject), discount_amounts: ((object{amount: int, discount: Discount|string}&StripeObject))[]}&StripeObject) $proration_details

 ...
 * @property null|(object{rate_card_subscription_details?: null|(object{rate_card_subscription: string, rate_card_version: string}&StripeObject), schedule_details?: null|(object{schedule: string}&StripeObject), subscription_details: null|(object{subscription: string, subscription_item?: string}&StripeObject), type: string, pricing_plan_subscription_details?: null|(object{pricing_plan_subscription: string, pricing_plan_version: string}&StripeObject)}&StripeObject) $parent The parent that generated this invoice item.

 ...
 * The create and capture methods are deprecated and will be deleted soon. If your integration uses either of them, you need to update it to use a different payment flow, such as <a href="https://docs.stripe.com/payments/payment-intents">the Payment Intents API</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|TransitBalance $allocated_funds Funds that are in transit and destined for another balance or another connected account.

 ...
 * @property null|(object{stripe_report?: string, user_report?: string}&\stdClass&StripeObject) $fraud_details Information on fraud assessments for the charge.
 * @property null|(object{customer_reference?: string, line_items: ((object{discount_amount: null|int, product_code: string, product_description: string, quantity: null|int, tax_amount: null|int, unit_cost: null|int}&\stdClass&StripeObject))[], merchant_reference: string, shipping_address_zip?: string, shipping_amount?: int, shipping_from_zip?: string}&\stdClass&StripeObject) $level3
 ...
 * @property null|(object{ach_credit_transfer?: (object{account_number: null|string, bank_name: null|string, routing_number: null|string, swift_code: null|string}&\stdClass&StripeObject), ach_debit?: (object{account_holder_type: null|string, bank_name: null|string, country: null|string, fingerprint: null|string, last4: null|string, routing_number: null|string}&\stdClass&StripeObject), acss_debit?: (object{bank_name: null|string, fingerprint: null|string, institution_number: null|string, last4: null|string, mandate?: string, transit_number: null|string}&\stdClass&StripeObject), affirm?: (object{transaction_id: null|string}&\stdClass&StripeObject), afterpay_clearpay?: (object{order_id: null|string, reference: null|string}&\stdClass&StripeObject), alipay?: (object{buyer_id?: string, fingerprint: null|string, transaction_id: null|string}&\stdClass&StripeObject), alma?: (object{}&\stdClass&StripeObject), amazon_pay?: (object{funding?: (object{card?: (object{brand: null|string, country: null|string, exp_month: null|int, exp_year: null|int, funding: null|string, last4: null|string}&\stdClass&StripeObject), type: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), au_becs_debit?: (object{bsb_number: null|string, fingerprint: null|string, last4: null|string, mandate?: string}&\stdClass&StripeObject), bacs_debit?: (object{fingerprint: null|string, last4: null|string, mandate: null|string, sort_code: null|string}&\stdClass&StripeObject), bancontact?: (object{bank_code: null|string, bank_name: null|string, bic: null|string, generated_sepa_debit: null|PaymentMethod|string, generated_sepa_debit_mandate: null|Mandate|string, iban_last4: null|string, preferred_language: null|string, verified_name: null|string}&\stdClass&StripeObject), billie?: (object{}&\stdClass&StripeObject), blik?: (object{buyer_id: null|string}&\stdClass&StripeObject), boleto?: (object{tax_id: string}&\stdClass&StripeObject), card?: (object{amount_authorized: null|int, authorization_code: null|string, brand: null|string, capture_before?: int, checks: null|(object{address_line1_check: null|string, address_postal_code_check: null|string, cvc_check: null|string}&\stdClass&StripeObject), country: null|string, description?: null|string, exp_month: int, exp_year: int, extended_authorization?: (object{status: string}&\stdClass&StripeObject), fingerprint?: null|string, funding: null|string, iin?: null|string, incremental_authorization?: (object{status: string}&\stdClass&StripeObject), installments: null|(object{plan: null|(object{count: null|int, interval: null|string, type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), issuer?: null|string, last4: null|string, mandate: null|string, moto?: null|bool, multicapture?: (object{status: string}&\stdClass&StripeObject), network: null|string, network_token?: null|(object{used: bool}&\stdClass&StripeObject), network_transaction_id: null|string, overcapture?: (object{maximum_amount_capturable: int, status: string}&\stdClass&StripeObject), regulated_status: null|string, three_d_secure: null|(object{authentication_flow: null|string, electronic_commerce_indicator: null|string, exemption_indicator: null|string, exemption_indicator_applied?: bool, result: null|string, result_reason: null|string, transaction_id: null|string, version: null|string}&\stdClass&StripeObject), wallet: null|(object{amex_express_checkout?: (object{}&\stdClass&StripeObject), apple_pay?: (object{}&\stdClass&StripeObject), dynamic_last4: null|string, google_pay?: (object{}&\stdClass&StripeObject), link?: (object{}&\stdClass&StripeObject), masterpass?: (object{billing_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), email: null|string, name: null|string, shipping_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), samsung_pay?: (object{}&\stdClass&StripeObject), type: string, visa_checkout?: (object{billing_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), email: null|string, name: null|string, shipping_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject), card_present?: (object{amount_authorized: null|int, brand: null|string, brand_product: null|string, capture_before?: int, cardholder_name: null|string, country: null|string, description?: null|string, emv_auth_data: null|string, exp_month: int, exp_year: int, fingerprint: null|string, funding: null|string, generated_card: null|string, iin?: null|string, incremental_authorization_supported: bool, issuer?: null|string, last4: null|string, network: null|string, network_transaction_id: null|string, offline: null|(object{stored_at: null|int, type: null|string}&\stdClass&StripeObject), overcapture_supported: bool, preferred_locales: null|string[], read_method: null|string, receipt: null|(object{account_type?: string, application_cryptogram: null|string, application_preferred_name: null|string, authorization_code: null|string, authorization_response_code: null|string, cardholder_verification_method: null|string, dedicated_file_name: null|string, terminal_verification_results: null|string, transaction_status_information: null|string}&\stdClass&StripeObject), wallet?: (object{type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), cashapp?: (object{buyer_id: null|string, cashtag: null|string}&\stdClass&StripeObject), customer_balance?: (object{}&\stdClass&StripeObject), eps?: (object{bank: null|string, verified_name: null|string}&\stdClass&StripeObject), fpx?: (object{account_holder_type: null|string, bank: string, transaction_id: null|string}&\stdClass&StripeObject), giropay?: (object{bank_code: null|string, bank_name: null|string, bic: null|string, verified_name: null|string}&\stdClass&StripeObject), grabpay?: (object{transaction_id: null|string}&\stdClass&StripeObject), ideal?: (object{bank: null|string, bic: null|string, generated_sepa_debit: null|PaymentMethod|string, generated_sepa_debit_mandate: null|Mandate|string, iban_last4: null|string, verified_name: null|string}&\stdClass&StripeObject), interac_present?: (object{brand: null|string, cardholder_name: null|string, country: null|string, description?: null|string, emv_auth_data: null|string, exp_month: int, exp_year: int, fingerprint: null|string, funding: null|string, generated_card: null|string, iin?: null|string, issuer?: null|string, last4: null|string, network: null|string, network_transaction_id: null|string, preferred_locales: null|string[], read_method: null|string, receipt: null|(object{account_type?: string, application_cryptogram: null|string, application_preferred_name: null|string, authorization_code: null|string, authorization_response_code: null|string, cardholder_verification_method: null|string, dedicated_file_name: null|string, terminal_verification_results: null|string, transaction_status_information: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), kakao_pay?: (object{buyer_id: null|string}&\stdClass&StripeObject), klarna?: (object{payer_details: null|(object{address: null|(object{country: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), payment_method_category: null|string, preferred_locale: null|string}&\stdClass&StripeObject), konbini?: (object{store: null|(object{chain: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), kr_card?: (object{brand: null|string, buyer_id: null|string, last4: null|string}&\stdClass&StripeObject), link?: (object{country: null|string}&\stdClass&StripeObject), mobilepay?: (object{card: null|(object{brand: null|string, country: null|string, exp_month: null|int, exp_year: null|int, last4: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), multibanco?: (object{entity: null|string, reference: null|string}&\stdClass&StripeObject), naver_pay?: (object{buyer_id: null|string}&\stdClass&StripeObject), nz_bank_account?: (object{account_holder_name: null|string, bank_code: string, bank_name: string, branch_code: string, last4: string, suffix: null|string}&\stdClass&StripeObject), oxxo?: (object{number: null|string}&\stdClass&StripeObject), p24?: (object{bank: null|string, reference: null|string, verified_name: null|string}&\stdClass&StripeObject), pay_by_bank?: (object{}&\stdClass&StripeObject), payco?: (object{buyer_id: null|string}&\stdClass&StripeObject), paynow?: (object{reference: null|string}&\stdClass&StripeObject), paypal?: (object{country: null|string, payer_email: null|string, payer_id: null|string, payer_name: null|string, seller_protection: null|(object{dispute_categories: null|string[], status: string}&\stdClass&StripeObject), transaction_id: null|string}&\stdClass&StripeObject), pix?: (object{bank_transaction_id?: null|string}&\stdClass&StripeObject), promptpay?: (object{reference: null|string}&\stdClass&StripeObject), revolut_pay?: (object{funding?: (object{card?: (object{brand: null|string, country: null|string, exp_month: null|int, exp_year: null|int, funding: null|string, last4: null|string}&\stdClass&StripeObject), type: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), samsung_pay?: (object{buyer_id: null|string}&\stdClass&StripeObject), satispay?: (object{}&\stdClass&StripeObject), sepa_credit_transfer?: (object{bank_name: null|string, bic: null|string, iban: null|string}&\stdClass&StripeObject), sepa_debit?: (object{bank_code: null|string, branch_code: null|string, country: null|string, fingerprint: null|string, last4: null|string, mandate: null|string}&\stdClass&StripeObject), sofort?: (object{bank_code: null|string, bank_name: null|string, bic: null|string, country: null|string, generated_sepa_debit: null|PaymentMethod|string, generated_sepa_debit_mandate: null|Mandate|string, iban_last4: null|string, preferred_language: null|string, verified_name: null|string}&\stdClass&StripeObject), stripe_account?: (object{}&\stdClass&StripeObject), swish?: (object{fingerprint: null|string, payment_reference: null|string, verified_phone_last4: null|string}&\stdClass&StripeObject), twint?: (object{}&\stdClass&StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: Mandate|string, payment_reference: null|string, routing_number: null|string}&\stdClass&StripeObject), wechat?: (object{}&\stdClass&StripeObject), wechat_pay?: (object{fingerprint: null|string, transaction_id: null|string}&\stdClass&StripeObject), zip?: (object{}&\stdClass&StripeObject)}&\stdClass&StripeObject) $payment_method_details Details about the payment method at the time of the transaction.
 ...
 * @property null|(object{address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), carrier?: null|string, name?: string, phone?: null|string, tracking_number?: null|string}&\stdClass&StripeObject) $shipping Shipping information for the charge.
 ...
 * @property null|(object{amount: null|int, destination: Account|string}&\stdClass&StripeObject) $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.

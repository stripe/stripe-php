 ...
 * @property (object{amazon_pay?: (object{dispute_type: null|string}&\stdClass&StripeObject), card?: (object{brand: string, case_type: string, network_reason_code: null|string}&\stdClass&StripeObject), klarna?: (object{reason_code: null|string}&\stdClass&StripeObject), paypal?: (object{case_id: null|string, reason_code: null|string}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject) $payment_method_details

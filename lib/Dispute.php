 ...
 * @property (object{access_activity_log: null|string, billing_address: null|string, cancellation_policy: null|File|string, cancellation_policy_disclosure: null|string, cancellation_rebuttal: null|string, customer_communication: null|File|string, customer_email_address: null|string, customer_name: null|string, customer_purchase_ip: null|string, customer_signature: null|File|string, duplicate_charge_documentation: null|File|string, duplicate_charge_explanation: null|string, duplicate_charge_id: null|string, enhanced_evidence: (object{visa_compelling_evidence_3?: (object{disputed_transaction: null|(object{customer_account_id: null|string, customer_device_fingerprint: null|string, customer_device_id: null|string, customer_email_address: null|string, customer_purchase_ip: null|string, merchandise_or_services: null|string, product_description: null|string, shipping_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), prior_undisputed_transactions: ((object{charge: string, customer_account_id: null|string, customer_device_fingerprint: null|string, customer_device_id: null|string, customer_email_address: null|string, customer_purchase_ip: null|string, product_description: null|string, shipping_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject))[]}&\stdClass&StripeObject), visa_compliance?: (object{fee_acknowledged: bool}&\stdClass&StripeObject)}&\stdClass&StripeObject), product_description: null|string, receipt: null|File|string, refund_policy: null|File|string, refund_policy_disclosure: null|string, refund_refusal_explanation: null|string, service_date: null|string, service_documentation: null|File|string, shipping_address: null|string, shipping_carrier: null|string, shipping_date: null|string, shipping_documentation: null|File|string, shipping_tracking_number: null|string, uncategorized_file: null|File|string, uncategorized_text: null|string}&\stdClass&StripeObject) $evidence
 * @property (object{due_by: null|int, enhanced_eligibility: (object{visa_compelling_evidence_3?: (object{required_actions: string[], status: string}&\stdClass&StripeObject), visa_compliance?: (object{status: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), has_evidence: bool, past_due: bool, submission_count: int}&\stdClass&StripeObject) $evidence_details
 ...
 * @property null|(object{amazon_pay?: (object{dispute_type: null|string}&\stdClass&StripeObject), card?: (object{brand: string, case_type: string, network_reason_code: null|string}&\stdClass&StripeObject), klarna?: (object{reason_code: null|string}&\stdClass&StripeObject), paypal?: (object{case_id: null|string, reason_code: null|string}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject) $payment_method_details

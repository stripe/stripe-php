 ...
 * @property null|(object{category_code: string, country: null|string, name: string, network_id: string, terminal_id: null|string}&\Stripe\StripeObject) $merchant_details Details about the merchant where the authorization occurred.
 * @property null|\Stripe\StripeObject $metadata Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 * @property null|(object{acquiring_institution_id: null|string, routed_network: null|string}&\Stripe\StripeObject) $network_details Details about the card network processing.
 ...
 * @property null|(object{created_at: null|int, reference: null|string, wallet: null|string}&\Stripe\StripeObject) $token_details Details about the token, if a tokenized payment method was used.
 * @property null|(object{three_d_secure_result: null|string}&\Stripe\StripeObject) $verification_details Details about verification checks performed.
 */

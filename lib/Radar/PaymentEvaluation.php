 ...
 * @property (object{early_fraud_warning: null|(object{evaluated_at: int, risk_level: string, score: float}&\Stripe\StripeObject), fraudulent_dispute: null|(object{evaluated_at: int, risk_level: string, score: float}&\Stripe\StripeObject), fraudulent_payment: (object{evaluated_at: int, risk_level: string, score: float}&\Stripe\StripeObject)}&\Stripe\StripeObject) $signals Collection of signals for this payment evaluation.
 */

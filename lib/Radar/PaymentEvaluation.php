 ...
 * @property null|(object{radar_session: string, data?: null|(object{ip: string, pasted_fields: null|string[], referrer: null|string, time_on_page_ms: null|int, user_agent: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $client_device_metadata_details Client device metadata attached to this payment evaluation.

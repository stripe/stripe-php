 ...
 * @property null|(object{data?: null|(object{ip: string, pasted_fields: null|string[], referrer: null|string, time_on_page_ms: null|int, user_agent: string}&\Stripe\StripeObject), radar_session: null|string}&\Stripe\StripeObject) $client_device_metadata_details Client device metadata attached to this payment evaluation.
 ...
 * @property null|(object{amount: int, currency: string, description: null|string, money_movement_details: null|(object{card: null|(object{customer_presence: null|string, payment_type: null|string}&\Stripe\StripeObject), money_movement_type: string}&\Stripe\StripeObject), payment_method_details: null|(object{billing_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Stripe\StripeObject), email: null|string, name: null|string, phone: null|string}&\Stripe\StripeObject), card?: null|(object{exp_month: int, exp_year: int, first6: string, last4: string}&\Stripe\StripeObject), payment_method: string|\Stripe\PaymentMethod}&\Stripe\StripeObject), shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Stripe\StripeObject), name: null|string, phone: null|string}&\Stripe\StripeObject), statement_descriptor: null|string}&\Stripe\StripeObject) $payment_details Payment details attached to this payment evaluation.
 ...
 * @property (object{early_fraud_warning: null|(object{evaluated_at: int, risk_level: string, score: null|float}&\Stripe\StripeObject), fraudulent_dispute: null|(object{evaluated_at: int, risk_level: string, score: null|float}&\Stripe\StripeObject), fraudulent_payment: (object{evaluated_at: int, risk_level: string, score: null|float}&\Stripe\StripeObject)}&\Stripe\StripeObject) $signals Collection of signals for this payment evaluation.
 */
class PaymentEvaluation extends \Stripe\ApiResource
{
     ...
     *
     * @param null|array{client_device_metadata_details?: array{data?: array{ip: string, pasted_fields?: string[], referrer?: string, time_on_page_ms?: int, user_agent: string}, radar_session: string}, customer_details: array{customer?: string, customer_account?: string, email?: string, name?: string, phone?: string}, expand?: string[], metadata?: array<string, string>, payment_details: array{amount: int, currency: string, description?: string, money_movement_details?: array{card?: array{customer_presence?: string, payment_type?: string}, money_movement_type: string}, payment_method_details: array{billing_details?: array{address?: array{city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, state?: string}, email?: string, name?: string, phone?: string}, card?: array{cvc?: string, exp_month: int, exp_year: int, first6?: string, last4?: string, number?: string}, payment_method: string}, shipping_details?: array{address?: array{city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, state?: string}, name?: string, phone?: string}, statement_descriptor?: string}} $params

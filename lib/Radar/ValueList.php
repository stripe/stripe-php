...
class ValueList extends \Stripe\ApiResource
{
     ...
     * appearing first.
     *
     * @param null|array{alias?: string, contains?: string, created?: array{gt?: int, gte?: int, lt?: int, lte?: int}|int, ending_before?: string, expand?: string[], limit?: int, starting_after?: string} $params
     * @param null|array|string $opts
     *

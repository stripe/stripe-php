 ...
 * @property null|((object{login_failed?: (object{reason: string}&\Stripe\StripeObject), login_succeeded?: (object{qualification: null|string}&\Stripe\StripeObject), occurred_at: int, registration_failed?: (object{reason: string}&\Stripe\StripeObject), registration_succeeded?: (object{qualification: null|string}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject))[] $events The list of events that were reported for this Account Evaluation object via the report API.
...
class AccountEvaluation extends \Stripe\ApiResource
{
     ...
     * @param null|array{expand?: string[], login_failed?: array{reason: string}, login_succeeded?: array{qualification?: string}, registration_failed?: array{reason: string}, registration_succeeded?: array{qualification?: string}, type: string} $params
     * @param null|array|string $opts
     *

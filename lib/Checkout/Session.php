 ...
 * @property null|(object{business_name: null|string, email?: null|string, individual_name: null|string, phone?: null|string, shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Stripe\StripeObject), name: string}&\Stripe\StripeObject), tax_ids?: null|((object{type: string, value: null|string}&\Stripe\StripeObject))[]}&\Stripe\StripeObject) $collected_information Information about the customer collected within the Checkout Session.

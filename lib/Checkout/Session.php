 ...
 * @property null|(object{billing_details?: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Stripe\StripeObject), name: null|string}&\Stripe\StripeObject), email?: null|string, id: string, payment_method_details?: null|(object{allow_redisplay: string, card?: (object{brand: string, country: null|string, exp_month: int, exp_year: int, fingerprint: null|string, funding: string, iin?: null|string, last4: string, wallet: null|(object{type: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject), phone?: null|string, shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Stripe\StripeObject), name: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $current_attempt The customer's pending attempt to pay that requires your approval. Contains information about the customer and their payment details.

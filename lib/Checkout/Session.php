 ...
 * @property null|(object{update?: null|(object{line_items?: null|string, shipping_details: null|string}&\stdClass&\Stripe\StripeObject), update_shipping_details: null|string}&\stdClass&\Stripe\StripeObject) $permissions <p>This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object.</p><p>For specific permissions, please refer to their dedicated subsections, such as <code>permissions.update.shipping_details</code>.</p>

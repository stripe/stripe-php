 ...
 * @property null|(object{shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&\Stripe\StripeObject), name: string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $collected_information Information about the customer collected within the Checkout Session.
 ...
 * @property null|(object{update_shipping_details: null|string}&\stdClass&\Stripe\StripeObject) $permissions <p>This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object.</p><p>For specific permissions, please refer to their dedicated subsections, such as <code>permissions.update.shipping_details</code>.</p>

 ...
 * @property null|(object{background_color: string, border_style: string, button_color: string, display_name: string, font_family: string, icon: null|(object{}&\Stripe\StripeObject), logo: null|(object{}&\Stripe\StripeObject)}&\Stripe\StripeObject) $branding_settings

 ...
 * @property null|(object{enabled: bool}&\stdClass&\Stripe\StripeObject) $adaptive_pricing Settings for price localization with <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a>.
 * @property null|(object{recovery: null|(object{allow_promotion_codes: bool, enabled: bool, expires_at: null|int, url: null|string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property (object{enabled: bool, liability: null|(object{account?: string|\Stripe\Account, type: string}&\stdClass&\Stripe\StripeObject), provider?: null|string, status: null|string}&\stdClass&\Stripe\StripeObject) $automatic_tax
 ...
 * @property null|(object{business_name?: null|string, email?: null|string, phone?: null|string, shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&\Stripe\StripeObject), name: string}&\stdClass&\Stripe\StripeObject), tax_ids?: null|((object{type: string, value: null|string}&\stdClass&\Stripe\StripeObject))[]}&\stdClass&\Stripe\StripeObject) $collected_information Information about the customer collected within the Checkout Session.
 * @property null|(object{promotions: null|string, terms_of_service: null|string}&\stdClass&\Stripe\StripeObject) $consent Results of <code>consent_collection</code> for this session.
 * @property null|(object{payment_method_reuse_agreement: null|(object{position: string}&\stdClass&\Stripe\StripeObject), promotions: null|string, terms_of_service: null|string}&\stdClass&\Stripe\StripeObject) $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|(object{amount_subtotal: int, amount_total: int, fx_rate: string, source_currency: string}&\stdClass&\Stripe\StripeObject) $currency_conversion Currency conversion details for <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a> sessions created before 2025-03-31.
 * @property ((object{dropdown?: (object{default_value: null|string, options: (object{label: string, value: string}&\stdClass&\Stripe\StripeObject)[], value: null|string}&\stdClass&\Stripe\StripeObject), key: string, label: (object{custom: null|string, type: string}&\stdClass&\Stripe\StripeObject), numeric?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int, value: null|string}&\stdClass&\Stripe\StripeObject), optional: bool, text?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int, value: null|string}&\stdClass&\Stripe\StripeObject), type: string}&\stdClass&\Stripe\StripeObject))[] $custom_fields Collect additional information from your customer using custom fields. Up to 3 fields are supported.
 * @property (object{after_submit: null|(object{message: string}&\stdClass&\Stripe\StripeObject), shipping_address: null|(object{message: string}&\stdClass&\Stripe\StripeObject), submit: null|(object{message: string}&\stdClass&\Stripe\StripeObject), terms_of_service_acceptance: null|(object{message: string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $custom_text
 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&\Stripe\StripeObject), email: null|string, name: null|string, phone: null|string, tax_exempt: null|string, tax_ids: null|((object{type: string, value: null|string}&\stdClass&\Stripe\StripeObject))[]}&\stdClass&\Stripe\StripeObject) $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Customer's address details are not present on Sessions in <code>setup</code> mode.
 ...
 * @property null|((object{coupon: null|string|\Stripe\Coupon, promotion_code: null|string|\Stripe\PromotionCode}&\stdClass&\Stripe\StripeObject))[] $discounts List of coupons and promotion codes attached to the Checkout Session.
 ...
 * @property null|(object{enabled: bool, invoice_data: (object{account_tax_ids: null|(string|\Stripe\TaxId)[], custom_fields: null|(object{name: string, value: string}&\stdClass&\Stripe\StripeObject)[], description: null|string, footer: null|string, issuer: null|(object{account?: string|\Stripe\Account, type: string}&\stdClass&\Stripe\StripeObject), metadata: null|\Stripe\StripeObject, rendering_options: null|(object{amount_tax_display: null|string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $invoice_creation Details on the state of invoice creation for the Checkout Session.
 ...
 * @property null|((object{adjustable_quantity: null|(object{enabled: bool, maximum: null|int, minimum: null|int}&\stdClass&\Stripe\StripeObject), price: string, quantity: int}&\stdClass&\Stripe\StripeObject))[] $optional_items The optional items presented to the customer at checkout.
 ...
 * @property null|(object{id: string, parent: null|string}&\stdClass&\Stripe\StripeObject) $payment_method_configuration_details Information about the payment method configuration used for this Checkout session if using dynamic payment methods.
 * @property null|(object{acss_debit?: (object{currency?: string, mandate_options?: (object{custom_mandate_url?: string, default_for?: string[], interval_description: null|string, payment_schedule: null|string, transaction_type: null|string}&\stdClass&\Stripe\StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\stdClass&\Stripe\StripeObject), affirm?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), afterpay_clearpay?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), alipay?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), amazon_pay?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), au_becs_debit?: (object{setup_future_usage?: string, target_date?: string}&\stdClass&\Stripe\StripeObject), bacs_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\stdClass&\Stripe\StripeObject), setup_future_usage?: string, target_date?: string}&\stdClass&\Stripe\StripeObject), bancontact?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), boleto?: (object{expires_after_days: int, setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), card?: (object{installments?: (object{enabled?: bool}&\stdClass&\Stripe\StripeObject), request_decremental_authorization?: string, request_extended_authorization?: string, request_incremental_authorization?: string, request_multicapture?: string, request_overcapture?: string, request_three_d_secure: string, restrictions?: (object{brands_blocked?: string[]}&\stdClass&\Stripe\StripeObject), setup_future_usage?: string, statement_descriptor_suffix_kana?: string, statement_descriptor_suffix_kanji?: string}&\stdClass&\Stripe\StripeObject), cashapp?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), customer_balance?: (object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&\stdClass&\Stripe\StripeObject), requested_address_types?: string[], type: null|string}&\stdClass&\Stripe\StripeObject), funding_type: null|string, setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), eps?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), fpx?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), giropay?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), grabpay?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), ideal?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), kakao_pay?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), klarna?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), konbini?: (object{expires_after_days: null|int, setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), kr_card?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), link?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), mobilepay?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), multibanco?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), naver_pay?: (object{capture_method?: string}&\stdClass&\Stripe\StripeObject), oxxo?: (object{expires_after_days: int, setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), p24?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), payco?: (object{capture_method?: string}&\stdClass&\Stripe\StripeObject), paynow?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), paypal?: (object{capture_method?: string, preferred_locale: null|string, reference: null|string, setup_future_usage?: string, subsellers?: string[]}&\stdClass&\Stripe\StripeObject), payto?: (object{mandate_options?: (object{amount: null|int, amount_type: null|string, end_date: null|string, payment_schedule: null|string, payments_per_period: null|int, purpose: null|string, start_date: null|string}&\stdClass&\Stripe\StripeObject), setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), pix?: (object{expires_after_seconds: null|int}&\stdClass&\Stripe\StripeObject), revolut_pay?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), samsung_pay?: (object{capture_method?: string}&\stdClass&\Stripe\StripeObject), sepa_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\stdClass&\Stripe\StripeObject), setup_future_usage?: string, target_date?: string}&\stdClass&\Stripe\StripeObject), sofort?: (object{setup_future_usage?: string}&\stdClass&\Stripe\StripeObject), swish?: (object{reference: null|string}&\stdClass&\Stripe\StripeObject), us_bank_account?: (object{financial_connections?: (object{filters?: (object{account_subcategories?: string[], institution?: string}&\stdClass&\Stripe\StripeObject), manual_entry?: (object{mode?: string}&\stdClass&\Stripe\StripeObject), permissions?: string[], prefetch: null|string[], return_url?: string}&\stdClass&\Stripe\StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|(object{update?: null|(object{line_items?: null|string, shipping_details: null|string}&\stdClass&\Stripe\StripeObject), update_line_items?: null|string, update_shipping_details: null|string}&\stdClass&\Stripe\StripeObject) $permissions <p>This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object.</p><p>For specific permissions, please refer to their dedicated subsections, such as <code>permissions.update.shipping_details</code>.</p>
 * @property null|(object{enabled: bool}&\stdClass&\Stripe\StripeObject) $phone_number_collection
 * @property null|(object{presentment_amount: int, presentment_currency: string}&\stdClass&\Stripe\StripeObject) $presentment_details
 ...
 * @property null|(object{allow_redisplay_filters: null|string[], payment_method_remove: null|string, payment_method_save: null|string}&\stdClass&\Stripe\StripeObject) $saved_payment_method_options Controls saved payment method settings for the session. Only available in <code>payment</code> and <code>subscription</code> mode.
 ...
 * @property null|(object{allowed_countries: string[]}&\stdClass&\Stripe\StripeObject) $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property null|(object{amount_subtotal: int, amount_tax: int, amount_total: int, shipping_rate: null|string|\Stripe\ShippingRate, taxes?: ((object{amount: int, rate: \Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\stdClass&\Stripe\StripeObject))[]}&\stdClass&\Stripe\StripeObject) $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property ((object{shipping_amount: int, shipping_rate: string|\Stripe\ShippingRate}&\stdClass&\Stripe\StripeObject))[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|(object{enabled: bool, required: string}&\stdClass&\Stripe\StripeObject) $tax_id_collection
 * @property null|(object{amount_discount: int, amount_shipping: null|int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: \Stripe\Discount}&\stdClass&\Stripe\StripeObject)[], taxes: ((object{amount: int, rate: \Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\stdClass&\Stripe\StripeObject))[]}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $total_details Tax and discount details for the computed total amount.

 ...
 * @property (object{enabled: bool, liability: null|(object{account?: string|\Stripe\Account, type: string}&\stdClass&\Stripe\StripeObject), status: null|string}&\stdClass&\Stripe\StripeObject) $automatic_tax

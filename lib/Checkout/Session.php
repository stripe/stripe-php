 ...
 * @property null|string[] $allowed_payment_method_types A list of the types of payment methods (e.g., <code>card</code>) this Checkout Session can accept.
 ...
 * @property null|string $approval_method <p>Determines whether the customer's attempt to pay must be manually approved.</p><p>Default is <code>auto</code>, when the customer's attempt to pay is approved automatically with no action required on your server.</p><p>When set to <code>manual</code>, you must approve the customer's attempt to pay by calling <a href="api/checkout/sessions/approve">approve</a> from your server.</p>
 * @property null|(object{calculation_basis: null|string, enabled: bool, provider?: string, status?: string, tax_behavior: null|string}&\Stripe\StripeObject) $automatic_surcharge
 * @property (object{address_collection_precision?: null|string, enabled: bool, enablement_details?: null|(object{integration_configuration_disabled_reason: null|(object{conflicting_field: string}&\Stripe\StripeObject), source: string}&\Stripe\StripeObject), liability: null|(object{account?: string|\Stripe\Account, type: string}&\Stripe\StripeObject), provider: null|string, status: null|string}&\Stripe\StripeObject) $automatic_tax
 ...
 * @property null|(object{type: string, rate_card_subscription_item?: (object{rate_card: string, metadata: \Stripe\StripeObject, rate_card_version: string, billing_cadence?: string, rate_card_subscription?: string}&\Stripe\StripeObject), pricing_plan_subscription_item?: (object{pricing_plan: string, pricing_plan_version: string, metadata: \Stripe\StripeObject, component_configurations: \Stripe\StripeObject, pricing_plan_subscription?: string, billing_cadence?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject)[] $checkout_items
 ...
 * @property null|(object{business_name: null|string, email?: null|string, individual_name: null|string, phone?: null|string, shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Stripe\StripeObject), name: string}&\Stripe\StripeObject), tax_id?: null|(object{type: string, value: null|string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $collected_information Information about the customer collected within the Checkout Session.
 ...
 * @property null|((object{key: string, subscription?: (object{backdate_start_date?: null|int, description: null|string, items: ((object{current_trial: null|(object{trial_offer: string}&\Stripe\StripeObject), price: string|\Stripe\Price, quantity: null|int}&\Stripe\StripeObject))[], metadata: null|\Stripe\StripeObject, pending_invoice_item_interval: null|(object{interval: string, interval_count: int}&\Stripe\StripeObject), proration_behavior: null|string, subscription: null|string|\Stripe\Subscription, trial_end: null|int, trial_period_days: null|int, trial_settings: null|(object{end_behavior: (object{billing_cycle_anchor?: null|string, missing_payment_method: string}&\Stripe\StripeObject)}&\Stripe\StripeObject)}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject))[] $items The items to be purchased by the customer.
 ...
 * @property null|string $payment_method_collection Configure whether a Checkout Session should collect a payment method for sessions with mode <code>payment</code>. Defaults to <code>always</code>.
 ...
 * @property null|string|\Stripe\PaymentRecord $payment_record The <a href="https://docs.stripe.com/api/payment-record">Payment Record</a> for this Checkout Session.
 * @property null|string $payment_reservation The ID of the Payment Reservation for this Checkout Session.
 ...
 * @property null|(object{update?: null|(object{line_items?: null|string, shipping_details: null|string}&\Stripe\StripeObject), update_line_items?: null|string, update_shipping_details: null|string}&\Stripe\StripeObject) $permissions <p>This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object.</p><p>For specific permissions, please refer to their dedicated subsections, such as <code>permissions.update_shipping_details</code>.</p>
 ...
 * @property null|(object{status: string}&\Stripe\StripeObject) $redaction The redaction status of the Checkout Session. If the Session is not redacted, this field is null.
 ...
 * @property null|(object{allow_redisplay_filters: null|string[], payment_method_preselect?: null|string, payment_method_remove: null|string, payment_method_save: null|string}&\Stripe\StripeObject) $saved_payment_method_options Controls saved payment method settings for the session. Only available in <code>payment</code> and <code>subscription</code> mode.
 ...
 * @property ((object{shipping_amount: int, shipping_rate: string|\Stripe\ShippingRate, tax_rates?: string[]}&\Stripe\StripeObject))[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|(object{amount_subtotal: int, amount_tax: int, amount_total: int}&\Stripe\StripeObject) $surcharge_cost
 * @property null|(object{enabled: bool, required: string}&\Stripe\StripeObject) $tax_id_collection
 * @property null|(object{amount_discount: int, amount_shipping: null|int, amount_surcharge?: int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: \Stripe\Discount}&\Stripe\StripeObject)[], taxes: ((object{amount: int, rate: \Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\Stripe\StripeObject))[]}&\Stripe\StripeObject)}&\Stripe\StripeObject) $total_details Tax and discount details for the computed total amount.
...
class Session extends \Stripe\ApiResource
{
    ...
    const APPROVAL_METHOD_AUTO = 'auto';
    const APPROVAL_METHOD_MANUAL = 'manual';
     ...
     * @param null|array{automatic_tax?: array{liability?: array{account?: string, type: string}}, collected_information?: array{shipping_details?: array{address: array{city?: string, country: string, line1: string, line2?: string, postal_code?: string, state?: string}, name: string}}, discounts?: null|(array{coupon?: string, coupon_data?: array{amount_off?: int, currency?: string, duration?: string, metadata?: null|array<string, string>, name?: string, percent_off?: float}})[], expand?: string[], invoice_creation?: array{invoice_data?: array{issuer?: array{account?: string, type: string}}}, line_items?: (array{adjustable_quantity?: array{enabled: bool, maximum?: int, minimum?: int}, id?: string, metadata?: null|array<string, string>, price?: string, price_data?: array{currency: string, product?: string, product_data?: array{description?: string, images?: string[], metadata?: array<string, string>, name: string, tax_code?: string, tax_details?: array{performance_location?: string, tax_code?: null|string}, unit_label?: string}, recurring?: array{interval: string, interval_count?: int}, tax_behavior?: string, unit_amount?: int, unit_amount_decimal?: string}, quantity?: int, tax_rates?: null|string[]})[], metadata?: null|array<string, string>, payment_intent_data?: array{description?: null|string, metadata?: null|array<string, string>, receipt_email?: null|string, setup_future_usage?: null|string, statement_descriptor?: null|string, statement_descriptor_suffix?: null|string}, shipping_options?: null|(array{shipping_rate?: string, shipping_rate_data?: array{delivery_estimate?: array{maximum?: array{unit: string, value: int}, minimum?: array{unit: string, value: int}}, display_name: string, fixed_amount?: array{amount: int, currency: string, currency_options?: array<string, array{amount: int, tax_behavior?: string}>}, metadata?: array<string, string>, tax_behavior?: string, tax_code?: string, type?: string}, tax_rates?: null|string[]})[], subscription_data?: array{invoice_settings?: array{issuer?: array{account?: string, type: string}}, pending_invoice_item_interval?: null|array{interval: string, interval_count?: int}, trial_end?: int, trial_period_days?: null|int}} $params
     * @param null|array|string $opts
     *
     ...
     * @param null|array|string $opts
     *
     * @return Session the approved session
     *
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     */

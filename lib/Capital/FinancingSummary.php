 ...
 * @property null|(object{advance_amount: int, advance_paid_out_at: null|float, currency: string, current_repayment_interval: null|(object{due_at: float, incremental_interval_target_amount?: int, paid_amount: null|int, remaining_amount: int, starts_at?: int}&\Stripe\StripeObject), disclaimer_variant?: string, enabled_payment_types?: string[], fee_amount: int, paid_amount: int, remaining_amount: int, repayments_begin_at: null|float, total_due_amount?: int, withhold_rate: float}&\Stripe\StripeObject) $details <p>Additional information about the financing summary. Describes currency, advance amount, fee amount, withhold rate, remaining amount, paid amount, current repayment interval, repayment start date, and advance payout date.</p><p>Only present for financing offers with a <code>status</code> other than <code>none</code>.</p>

...
class PaymentRecord extends ApiResource
{
     ...
     * @throws Exception\ApiErrorException if the request fails
     */
    public function reportDispute($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/report_dispute';
     ...
     * @param null|array|string $opts
     *
     * @return SearchResult<PaymentRecord> the payment record search results
     *
     * @throws Exception\ApiErrorException if the request fails
     */
    public static function search($params = null, $opts = null)
    {
        $url = '/v1/payment_records/search';

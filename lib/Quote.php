 ...
 * @property (object{bill_on_acceptance?: null|(object{bill_from: null|(object{computed: null|int, line_starts_at: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject), bill_until: null|(object{computed: null|int, duration: null|(object{interval: string, interval_count: int}&StripeObject), line_ends_at: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject)}&StripeObject), billing_behavior?: string, billing_cycle_anchor?: null|string, billing_mode: (object{flexible?: (object{consistent_proration_discount_amounts?: bool}&StripeObject), type: string}&StripeObject), description: null|string, effective_date: null|int, end_behavior?: null|string, from_subscription?: null|string|Subscription, metadata: null|StripeObject, prebilling?: null|(object{iterations: int}&StripeObject), proration_behavior?: string, trial_period_days: null|int}&StripeObject) $subscription_data

 ...
 * @property (object{enabled: bool, liability: null|(object{account?: Account|string, type: string}&\stdClass&StripeObject), provider?: null|string, status: null|string}&\stdClass&StripeObject) $automatic_tax
 ...
 * @property (object{last_reestimation_details?: null|(object{failed: null|(object{failure_code: null|string, message: null|string, reason: string}&\stdClass&StripeObject), status: string}&\stdClass&StripeObject), recurring: null|(object{amount_subtotal: int, amount_total: int, interval: string, interval_count: int, total_details: (object{amount_discount: int, amount_shipping: null|int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: Discount}&\stdClass&StripeObject)[], taxes: ((object{amount: int, rate: TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\stdClass&StripeObject))[]}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject), updated_at?: null|int, upfront: (object{amount_subtotal: int, amount_total: int, line_items?: Collection<LineItem>, total_details: (object{amount_discount: int, amount_shipping: null|int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: Discount}&\stdClass&StripeObject)[], taxes: ((object{amount: int, rate: TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\stdClass&StripeObject))[]}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject) $computed
 ...
 * @property null|(object{canceled?: (object{reason: null|string, transitioned_at: null|int}&\stdClass&StripeObject), stale?: (object{expires_at: null|int, last_reason: null|(object{line_invalid?: string, lines_invalid?: (object{invalid_at: int, lines: string[]}&\stdClass&StripeObject)[], marked_stale?: null|string, subscription_canceled?: string, subscription_changed?: (object{previous_subscription: null|Subscription}&\stdClass&StripeObject), subscription_expired?: string, subscription_schedule_canceled?: string, subscription_schedule_changed?: (object{previous_subscription_schedule: null|SubscriptionSchedule}&\stdClass&StripeObject), subscription_schedule_released?: string, type: null|string}&\stdClass&StripeObject), last_updated_at: null|int, transitioned_at: null|int}&\stdClass&StripeObject)}&\stdClass&StripeObject) $status_details Details on when and why a quote has been marked as stale or canceled.
 ...
 * @property (object{bill_on_acceptance?: null|(object{bill_from: null|(object{computed: null|int, line_starts_at: null|(object{id: string}&\stdClass&StripeObject), timestamp: null|int, type: string}&\stdClass&StripeObject), bill_until: null|(object{computed: null|int, duration: null|(object{interval: string, interval_count: int}&\stdClass&StripeObject), line_ends_at: null|(object{id: string}&\stdClass&StripeObject), timestamp: null|int, type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), billing_behavior?: string, billing_cycle_anchor?: null|string, description: null|string, effective_date: null|int, end_behavior?: null|string, from_subscription?: null|string|Subscription, metadata: null|StripeObject, prebilling?: null|(object{iterations: int}&\stdClass&StripeObject), proration_behavior?: string, trial_period_days: null|int}&\stdClass&StripeObject) $subscription_data
 * @property null|((object{applies_to: (object{new_reference: null|string, subscription_schedule: null|string, type: string}&\stdClass&StripeObject), bill_on_acceptance?: null|(object{bill_from: null|(object{computed: null|int, line_starts_at: null|(object{id: string}&\stdClass&StripeObject), timestamp: null|int, type: string}&\stdClass&StripeObject), bill_until: null|(object{computed: null|int, duration: null|(object{interval: string, interval_count: int}&\stdClass&StripeObject), line_ends_at: null|(object{id: string}&\stdClass&StripeObject), timestamp: null|int, type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), billing_behavior?: string, customer: null|string, description: null|string, end_behavior?: null|string, proration_behavior?: null|string}&\stdClass&StripeObject))[] $subscription_data_overrides List representing overrides for <code>subscription_data</code> configurations for specific subscription schedules.
 ...
 * @property null|((object{applies_to: (object{new_reference: null|string, subscription_schedule: null|string, type: string}&\stdClass&StripeObject), subscription_schedule: string}&\stdClass&StripeObject))[] $subscription_schedules The subscription schedules that were created or updated from this quote.

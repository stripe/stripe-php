 ...
 * @property (object{bill_on_acceptance?: null|(object{bill_from: null|(object{computed: null|int, line_starts_at: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject), bill_until: null|(object{computed: null|int, duration: null|(object{interval: string, interval_count: int}&StripeObject), line_ends_at: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject)}&StripeObject), billing_behavior?: string, billing_cycle_anchor?: null|string, billing_mode: (object{flexible?: (object{proration_discounts?: string}&StripeObject), type: string}&StripeObject), billing_schedules?: ((object{applies_to: null|((object{price: null|Price|string, type: string}&StripeObject))[], bill_from?: null|(object{computed_timestamp: null|int, line_starts_at: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject), bill_until: (object{computed_timestamp: null|int, duration: null|(object{interval: string, interval_count: null|int}&StripeObject), line_ends_at?: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject), key: string}&StripeObject))[], description: null|string, effective_date: null|int, end_behavior?: null|string, from_subscription?: null|string|Subscription, metadata: null|StripeObject, phase_effective_at?: null|string, prebilling?: null|(object{iterations: int}&StripeObject), proration_behavior?: string, trial_period_days: null|int}&StripeObject) $subscription_data
 * @property null|((object{applies_to: (object{new_reference: null|string, subscription_schedule: null|string, type: string}&StripeObject), bill_on_acceptance?: null|(object{bill_from: null|(object{computed: null|int, line_starts_at: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject), bill_until: null|(object{computed: null|int, duration: null|(object{interval: string, interval_count: int}&StripeObject), line_ends_at: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject)}&StripeObject), billing_behavior?: string, billing_schedules?: ((object{applies_to: null|((object{price: null|Price|string, type: string}&StripeObject))[], bill_from?: null|(object{computed_timestamp: null|int, line_starts_at: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject), bill_until: (object{computed_timestamp: null|int, duration: null|(object{interval: string, interval_count: null|int}&StripeObject), line_ends_at?: null|(object{id: string}&StripeObject), timestamp: null|int, type: string}&StripeObject), key: string}&StripeObject))[], customer: null|string, description: null|string, end_behavior?: null|string, phase_effective_at?: null|string, proration_behavior?: null|string}&StripeObject))[] $subscription_data_overrides List representing overrides for <code>subscription_data</code> configurations for specific subscription schedules.

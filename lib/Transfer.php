 ...
 * @property null|ApplicationFee|string $application_fee
 * @property null|int $application_fee_amount
...
class Transfer extends ApiResource
{
     ...
     *
     * @param null|array{amount?: int, application_fee_amount?: int, currency: string, description?: string, destination: string, expand?: string[], fx_quote?: string, metadata?: array<string, string>, source_transaction?: string, source_type?: string, transfer_group?: string} $params

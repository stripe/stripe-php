 ...
 * @property null|string $status The networking status of the reader. This value is <code>null</code> for mobile readers. We do not recommend using this field in flows that may block taking payments.
 */

 ...
 * @property null|(object{card?: (object{commodity_code: null|string, ev_charging?: (object{carbon_footprint_avoided_grams_co2?: int, charging_ended_at?: int, charging_power_output_capacity_kw?: int, charging_started_at?: int, connector_type?: string, estimated_range_added?: int, estimated_range_left?: int, maximum_power_dispensed_kw?: int}&StripeObject), fleet_data?: (object{product_type?: string, service_type?: string}&StripeObject)}&StripeObject), card_present?: (object{commodity_code: null|string}&StripeObject), klarna?: (object{image_url: null|string, product_url: null|string, reference: null|string, subscription_reference: null|string}&StripeObject), paypal?: (object{category?: string, description?: string, sold_by?: string}&StripeObject)}&StripeObject) $payment_method_options Payment method-specific information for line items.

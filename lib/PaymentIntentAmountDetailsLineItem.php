 ...
 * @property null|(object{card?: (object{commodity_code: null|string, fleet_data?: (object{product_type?: string, service_type?: string}&StripeObject)}&StripeObject), card_present?: (object{commodity_code: null|string}&StripeObject), klarna?: (object{image_url: null|string, product_url: null|string, reference: null|string, subscription_reference: null|string}&StripeObject), paypal?: (object{category?: string, description?: string, sold_by?: string}&StripeObject)}&StripeObject) $payment_method_options Payment method-specific information for line items.

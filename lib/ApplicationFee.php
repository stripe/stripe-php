 ...
 * @property null|(object{charge?: string, payout?: string, type: string, transfer?: string}&StripeObject) $fee_source Polymorphic source of the application fee. Includes the ID of the object the application fee was created from.

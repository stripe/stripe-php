 ...
 * @property (object{disabled_reason: null|string, enabled: bool, liability: null|(object{account?: Account|string, type: string}&\stdClass&StripeObject), provider?: null|string, status: null|string}&\stdClass&StripeObject) $automatic_tax
 ...
 * @property null|(object{client_secret: string, type: string}&\stdClass&StripeObject) $confirmation_secret The confirmation secret associated with this invoice. Currently, this contains the client_secret of the PaymentIntent that Stripe creates during invoice finalization.
 ...
 * @property null|(object{quote_details: null|(object{quote: string}&\stdClass&StripeObject), subscription_details: null|(object{metadata: null|StripeObject, pause_collection?: null|(object{behavior: null|string, resumes_at: null|int}&\stdClass&StripeObject), subscription: string|Subscription, subscription_proration_date?: int}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject) $parent The parent that generated this invoice
 ...
 * @property null|((object{amount: int, tax_behavior: string, tax_rate_details: null|(object{tax_rate: string}&\stdClass&StripeObject), taxability_reason: string, taxable_amount: null|int, type: string}&\stdClass&StripeObject))[] $total_taxes The aggregate tax information of all line items.

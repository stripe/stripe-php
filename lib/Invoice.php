 ...
 *
 * They contain <a href="https://docs.stripe.com/api#invoiceitems">invoice items</a>, and proration adjustments
 ...
 * @property (object{disabled_reason: null|string, enabled: bool, enablement_details?: null|(object{integration_configuration_disabled_reason: null|(object{conflicting_field: string}&StripeObject), source: string}&StripeObject), liability: null|(object{account?: Account|string, type: string}&StripeObject), provider: null|string, status: null|string}&StripeObject) $automatic_tax
 ...
 * @property null|(object{applied_balance: int, automatically_applied_balance: int, manually_applied_balance: int}&StripeObject) $customer_balance The customer balance amounts applied to this invoice.
 ...
 * @property null|(object{billing_cadence_details?: null|(object{billing_cadence: string}&StripeObject), quote_details: null|(object{quote: string}&StripeObject), schedule_details?: null|(object{schedule: string, subscription: null|string|Subscription}&StripeObject), subscription_details: null|(object{metadata: null|StripeObject, pause_collection?: null|(object{behavior: null|string, resumes_at: null|int}&StripeObject), subscription: string|Subscription, subscription_proration_date?: int}&StripeObject), type: string}&StripeObject) $parent The parent that generated this invoice
 * @property null|PaymentPlan|string $payment_plan The ID of the payment plan associated with this invoice, if any. Use <code>expand[]=payment_plan</code> to include the full payment plan object.
 * @property (object{default_mandate: null|string, payment_method_options: null|(object{acss_debit: null|(object{mandate_options?: (object{transaction_type: null|string}&StripeObject), verification_method?: string}&StripeObject), bacs_debit?: null|(object{target_date?: string, verification_method?: string}&StripeObject), bancontact: null|(object{preferred_language: string}&StripeObject), billie?: null|(object{company_details?: (object{registered_address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&StripeObject), registered_name: null|string, registration_number: null|string, registration_type?: string, vat: null|string}&StripeObject), reference?: null|string}&StripeObject), bizum?: null|(object{}&StripeObject), blik?: null|(object{}&StripeObject), card: null|(object{installments?: (object{enabled: null|bool}&StripeObject), request_three_d_secure: null|string}&StripeObject), check_scan?: null|(object{}&StripeObject), customer_balance: null|(object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&StripeObject), type: null|string}&StripeObject), funding_type: null|string}&StripeObject), id_bank_transfer?: null|(object{}&StripeObject), konbini: null|(object{}&StripeObject), payto: null|(object{mandate_options?: (object{amount: null|int, amount_type: null|string, purpose: null|string}&StripeObject)}&StripeObject), pix: null|(object{amount_includes_iof: null|string, expires_after_seconds?: int}&StripeObject), sepa_debit: null|(object{}&StripeObject), upi: null|(object{mandate_options?: (object{amount: null|int, amount_type: null|string, description: null|string, end_date: null|int}&StripeObject)}&StripeObject), us_bank_account: null|(object{financial_connections?: (object{filters?: (object{account_subcategories?: string[], institution?: string}&StripeObject), permissions?: string[], prefetch: null|string[]}&StripeObject), verification_method?: string}&StripeObject), wechat_pay?: null|(object{app_id?: string, client?: string}&StripeObject)}&StripeObject), payment_method_types: null|string[]}&StripeObject) $payment_settings
 ...
 * @property null|(object{uncollectible?: (object{reason: null|string}&StripeObject)}&StripeObject) $status_details
 ...
 * @property null|((object{amount: int, tax_behavior: string, tax_rate_details: null|(object{tax_rate: string|TaxRate}&StripeObject), taxability_reason: string, taxable_amount: null|int, type: string}&StripeObject))[] $total_taxes The aggregate tax information of all line items.
...
class Invoice extends ApiResource
{
     ...
     *
     * @param null|array{billing_cadence?: string, collection_method?: string, created?: array|int, customer?: string, customer_account?: string, due_date?: array|int, ending_before?: string, expand?: string[], limit?: int, starting_after?: string, status?: string, subscription?: string} $params
     * @param null|array|string $opts
     *
     ...
     * @param null|array|string $opts
     *
     * @return Invoice the detached invoice
     *
     * @throws Exception\ApiErrorException if the request fails
     */
    public function detachPayment($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/detach_payment';
        list($response, $opts) = $this->_request('post', $url, $params, $opts);
        $this->refreshFrom($response, $opts);

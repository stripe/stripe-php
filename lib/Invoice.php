 ...
 * @property null|(object{quote_details: null|(object{quote: string}&\stdClass&StripeObject), subscription_details: null|(object{metadata: null|StripeObject, subscription: string|Subscription, subscription_proration_date?: int}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject) $parent The parent that generated this invoice
 * @property (object{default_mandate: null|string, payment_method_options: null|(object{acss_debit: null|(object{mandate_options?: (object{transaction_type: null|string}&\stdClass&StripeObject), verification_method?: string}&\stdClass&StripeObject), bancontact: null|(object{preferred_language: string}&\stdClass&StripeObject), card: null|(object{installments?: (object{enabled: null|bool}&\stdClass&StripeObject), request_three_d_secure: null|string}&\stdClass&StripeObject), customer_balance: null|(object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&\stdClass&StripeObject), type: null|string}&\stdClass&StripeObject), funding_type: null|string}&\stdClass&StripeObject), konbini: null|(object{}&\stdClass&StripeObject), sepa_debit: null|(object{}&\stdClass&StripeObject), us_bank_account: null|(object{financial_connections?: (object{filters?: (object{account_subcategories?: string[]}&\stdClass&StripeObject), permissions?: string[], prefetch: null|string[]}&\stdClass&StripeObject), verification_method?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), payment_method_types: null|string[]}&\stdClass&StripeObject) $payment_settings
 ...
 * @property null|((object{amount: int, credit_balance_transaction?: null|Billing\CreditBalanceTransaction|string, discount?: Discount|string, type: string}&\stdClass&StripeObject))[] $total_pretax_credit_amounts Contains pretax credit amounts (ex: discount, credit grants, etc) that apply to this invoice. This is a combined list of total_pretax_credit_amounts across all invoice line items.

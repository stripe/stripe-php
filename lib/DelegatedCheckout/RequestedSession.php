 ...
 * @property ((object{description: null|string, images: null|string[], key: string, name: string, quantity: int, sku_id: string, unit_amount: int, amount_discount: int, amount_subtotal: int, product_details?: (object{custom_attributes: null|(object{display_name: string, value: string}&\Stripe\StripeObject)[], description: null|string, disclosures: null|(object{content: string, content_type: string, type: string}&\Stripe\StripeObject)[], images: null|string[], title: string}&\Stripe\StripeObject)}&\Stripe\StripeObject))[] $line_item_details The line items to be purchased.

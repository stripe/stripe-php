 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\Stripe\StripeObject), email: null|string, fulfillment_options: null|((object{shipping: null|(object{shipping_options: null|((object{description: null|string, display_name: string, earliest_delivery_time: null|int, key: string, latest_delivery_time: null|int, shipping_amount: int}&\Stripe\StripeObject))[]}&\Stripe\StripeObject), type: string, digital: null|(object{digital_options: null|((object{description: null|string, digital_amount: int, display_name: string, key: string}&\Stripe\StripeObject))[]}&\Stripe\StripeObject)}&\Stripe\StripeObject))[], name: null|string, phone: null|string, selected_fulfillment_option: null|(object{shipping: null|(object{shipping_option: null|string}&\Stripe\StripeObject), type: string, digital: null|(object{digital_option: null|string}&\Stripe\StripeObject)}&\Stripe\StripeObject)}&\Stripe\StripeObject) $fulfillment_details The details of the fulfillment.
 * @property ((object{amount_discount: int, amount_subtotal: int, key: string, product_details?: (object{custom_attributes: null|(object{display_name: string, value: string}&\Stripe\StripeObject)[], description: null|string, disclosures: null|(object{content: string, content_type: string, type: string}&\Stripe\StripeObject)[], images: null|string[], title: string}&\Stripe\StripeObject), quantity: int, sku_id: string, unit_amount: int, fulfillment_type: string}&\Stripe\StripeObject))[] $line_item_details The line items to be purchased.
 ...
 * @property (object{marketplace_seller_details: null|(object{}&\Stripe\StripeObject), network_profile: string|\Stripe\Profile, privacy_notice_url: null|string, return_policy_url: null|string, store_policy_url: null|string, terms_of_service_url: null|string}&\Stripe\StripeObject) $seller_details

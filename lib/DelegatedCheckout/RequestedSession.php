 ...
 * @property (object{marketplace_seller_details: null|(object{}&\Stripe\StripeObject), network_profile: string|\Stripe\Profile, privacy_notice_url: null|string, return_policy_url: null|string, store_policy_url: null|string, terms_of_service_url: null|string, card_brands: null|string[], payment_method_types: null|string[]}&\Stripe\StripeObject) $seller_details
...
class RequestedSession extends \Stripe\ApiResource
{
     ...
     *
     * @param null|array{affiliate_attribution?: array{campaign_id?: string, creative_id?: string, expires_at: int, identification_token: string, issued_at: int, provider: string, publisher_id?: string, shared_metadata?: array<string, string>, source?: array{platform?: string, type: string, url?: string}, sub_id?: string, touchpoint: string}, currency: string, customer?: string, expand?: string[], fulfillment_details?: array{address?: array{city: string, country: string, line1?: string, line2?: string, postal_code: string, state: string}, email?: string, name?: string, phone?: string}, line_item_details: array{quantity: int, sku_id: string}[], metadata?: array<string, string>, payment_method?: string, seller_details: array{network_profile: string}, setup_future_usage?: string, shared_metadata?: array<string, string>, payment_method_options?: array{card?: array{brands_blocked?: string[]}, excluded_payment_method_types?: string[]}} $params

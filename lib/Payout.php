...
class Payout extends ApiResource
{
     ...
     *
     * @param null|array{amount: int, currency: string, description?: string, destination?: string, expand?: string[], metadata?: StripeObject, method?: string, payout_method?: string, source_type?: string, statement_descriptor?: string} $params

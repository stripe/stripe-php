 ...
 * @property null|(object{currently_due: null|string[], errors: null|(object{code: string, details?: (object{partner_rejection_code?: string}&StripeObject), reason: string, requirement: string}&StripeObject)[], past_due: null|string[], pending_verification: null|string[]}&StripeObject) $future_requirements Information about the <a href="https://docs.stripe.com/connect/custom-accounts/future-requirements">upcoming new requirements for the bank account</a>, including what information needs to be collected, and by when.
 ...
 * @property null|(object{currently_due: null|string[], errors: null|(object{code: string, details?: (object{partner_rejection_code?: string}&StripeObject), reason: string, requirement: string}&StripeObject)[], past_due: null|string[], pending_verification: null|string[]}&StripeObject) $requirements Information about the requirements for the bank account, including what information needs to be collected.

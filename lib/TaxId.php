 ...
 * @property null|(object{account?: Account|string, application?: Application|string, customer?: Customer|string, type: string}&\stdClass&StripeObject) $owner The account or customer the tax ID belongs to.

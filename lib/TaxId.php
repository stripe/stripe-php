 ...
 * @property null|(object{account?: Account|string, application?: Application|string, customer?: Customer|string, customer_account?: null|string, type: string}&\stdClass&StripeObject) $owner The account or customer the tax ID belongs to.
 ...
 * @property null|(object{status: string, verified_address: null|string, verified_name: null|string}&\stdClass&StripeObject) $verification Tax ID verification information.
 */

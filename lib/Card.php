 ...
 * @property null|(object{issuer: null|string, programs: null|string[]}&StripeObject) $benefits
 ...
 * @property null|(object{status: string}&StripeObject) $redaction Redaction status of this card. If not null, this card is associated to a redaction job.

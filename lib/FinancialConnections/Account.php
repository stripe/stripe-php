 ...
 * @property null|string $authorization The ID of the Financial Connections Authorization this account belongs to.
 ...
 * @property null|(object{active?: (object{action: string, cause: string, expected_deactivation_date: int}&\Stripe\StripeObject), inactive?: (object{action: string, cause: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $status_details

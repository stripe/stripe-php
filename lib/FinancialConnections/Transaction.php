 ...
 * @property null|((object{credit?: (object{confidence_level: null|string, detailed_label: null|string, primary_label: null|string}&\Stripe\StripeObject), money_movement?: (object{confidence_level: null|string, detailed_label: null|string, primary_label: null|string}&\Stripe\StripeObject), personal_finance?: (object{confidence_level: null|string, detailed_label: null|string, primary_label: null|string}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject))[] $classifications Classification labels for this transaction, one entry per subscribed use case.

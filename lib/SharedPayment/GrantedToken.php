 ...
 * @property null|(object{currency: string, expires_at: null|int, max_amount: int}&\Stripe\StripeObject) $usage_limits Limits on how this SharedPaymentGrantedToken can be used.
 */

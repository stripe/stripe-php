 ...
 * @property (object{application_fee_percent: null|float, automatic_tax?: (object{disabled_reason: null|string, enabled: bool, liability: null|(object{account?: Account|string, type: string}&StripeObject)}&StripeObject), billing_cycle_anchor: string, billing_thresholds: null|(object{amount_gte: null|int, reset_billing_cycle_anchor: null|bool}&StripeObject), collection_method: null|string, default_payment_method: null|PaymentMethod|string, description: null|string, invoice_settings: (object{account_tax_ids: null|(string|TaxId)[], custom_fields: null|(object{name: string, value: string}&StripeObject)[], days_until_due: null|int, description: null|string, footer: null|string, issuer: (object{account?: Account|string, type: string}&StripeObject)}&StripeObject), on_behalf_of: null|Account|string, phase_effective_at?: string, transfer_data: null|(object{amount_percent: null|float, destination: Account|string}&StripeObject)}&StripeObject) $default_settings
 ...
 * @property null|(object{errored_at: int, failed_transitions: (object{source_price: string, target_price: string}&StripeObject)[], type: string}&StripeObject) $last_price_migration_error Details of the most recent price migration that failed for the subscription schedule.
 * @property null|Invoice|string $latest_invoice The most recent invoice this subscription schedule has generated.
 ...
 * @property null|((object{key: string, pause: (object{pause_at: int, settings: null|(object{bill_for: (object{outstanding_usage_through: (object{type: string}&StripeObject), unused_time_from: (object{type: string}&StripeObject)}&StripeObject), invoicing_behavior: string, type: string}&StripeObject), status: (object{error?: (object{code?: string, message: string}&StripeObject), type: string}&StripeObject)}&StripeObject), resume: null|(object{resume_at: int, settings: (object{billing_cycle_anchor: string, payment_behavior: string, proration_behavior: string}&StripeObject), status: (object{error?: (object{code?: string, message: string}&StripeObject), type: string}&StripeObject)}&StripeObject)}&StripeObject))[] $pause_schedules The pause schedules for this subscription schedule.
 * @property ((object{add_invoice_items: ((object{discountable: null|bool, discounts: ((object{coupon: null|Coupon|string, discount: null|Discount|string, discount_end?: null|(object{timestamp: null|int, type: string}&StripeObject), promotion_code: null|PromotionCode|string}&StripeObject))[], metadata: null|StripeObject, period: (object{end: (object{timestamp?: int, type: string}&StripeObject), start: (object{timestamp?: int, type: string}&StripeObject)}&StripeObject), price: Price|string, quantity: null|int, tax_rates?: null|TaxRate[]}&StripeObject))[], application_fee_percent: null|float, automatic_tax?: (object{disabled_reason: null|string, enabled: bool, liability: null|(object{account?: Account|string, type: string}&StripeObject)}&StripeObject), billing_cycle_anchor: null|string, billing_thresholds: null|(object{amount_gte: null|int, reset_billing_cycle_anchor: null|bool}&StripeObject), collection_method: null|string, currency: string, default_payment_method: null|PaymentMethod|string, default_tax_rates?: null|TaxRate[], description: null|string, discounts: ((object{coupon: null|Coupon|string, discount: null|Discount|string, discount_end?: null|(object{timestamp: null|int, type: string}&StripeObject), promotion_code: null|PromotionCode|string, settings?: (object{service_period_anchor_config: (object{custom?: (object{day_of_month: int, hour: null|int, minute: null|int, month: null|int, second: null|int}&StripeObject), type: string}&StripeObject), start_date: string}&StripeObject)}&StripeObject))[], effective_at?: null|string, end_date: int, invoice_settings: null|(object{account_tax_ids: null|(string|TaxId)[], custom_fields: null|(object{name: string, value: string}&StripeObject)[], days_until_due: null|int, description: null|string, footer: null|string, issuer: null|(object{account?: Account|string, type: string}&StripeObject)}&StripeObject), items: ((object{billing_thresholds: null|(object{usage_gte: null|int}&StripeObject), discounts: ((object{coupon: null|Coupon|string, discount: null|Discount|string, discount_end?: null|(object{timestamp: null|int, type: string}&StripeObject), promotion_code: null|PromotionCode|string, settings?: (object{service_period_anchor_config: (object{custom?: (object{day_of_month: int, hour: null|int, minute: null|int, month: null|int, second: null|int}&StripeObject), type: string}&StripeObject), start_date: string}&StripeObject)}&StripeObject))[], metadata: null|StripeObject, plan: Plan|string, price: Price|string, quantity?: int, tax_rates?: null|TaxRate[], trial?: null|(object{converts_to?: null|string[], type: string}&StripeObject), trial_offer?: null|string}&StripeObject))[], metadata: null|StripeObject, on_behalf_of: null|Account|string, pause_collection?: null|(object{behavior: string}&StripeObject), proration_behavior: string, start_date: int, transfer_data: null|(object{amount_percent: null|float, destination: Account|string}&StripeObject), trial?: bool, trial_continuation?: null|string, trial_end: null|int, trial_settings?: null|(object{end_behavior: null|(object{prorate_up_front: null|string}&StripeObject)}&StripeObject)}&StripeObject))[] $phases Configuration for the subscription schedule's phases.
 * @property null|(object{invoice: Invoice|string, period_end: int, period_start: int, update_behavior?: string}&StripeObject) $prebilling Time period and invoice for a Subscription billed in advance.
...
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @param null|array{billing_behavior?: string, billing_mode?: array{flexible?: array{proration_discounts?: string}, type: string}, billing_schedules?: array{applies_to?: array{price?: string, type: string}[], bill_until: array{duration?: array{interval: string, interval_count?: int}, timestamp?: int, type: string}, key?: string}[], customer?: string, customer_account?: string, default_settings?: array{application_fee_percent?: float, automatic_tax?: array{enabled: bool, liability?: array{account?: string, type: string}}, billing_cycle_anchor?: string, billing_thresholds?: null|array{amount_gte?: int, reset_billing_cycle_anchor?: bool}, collection_method?: string, default_payment_method?: string, description?: null|string, invoice_settings?: array{account_tax_ids?: null|string[], custom_fields?: null|array{name: string, value: string}[], days_until_due?: int, description?: null|string, footer?: null|string, issuer?: array{account?: string, type: string}}, on_behalf_of?: null|string, phase_effective_at?: string, transfer_data?: null|array{amount_percent?: float, destination: string}}, end_behavior?: string, expand?: string[], from_subscription?: string, metadata?: null|array<string, string>, pause_schedules?: array{key?: string, pause?: array{pause_at: array{timestamp?: int, type: string}, settings?: array{bill_for?: array{outstanding_usage_through?: array{type?: string}, unused_time_from?: array{type?: string}}, invoicing_behavior?: string, type?: string}}, resume?: array{resume_at: array{duration?: array{interval: string, interval_count?: int}, timestamp?: int, type: string}, settings?: array{billing_cycle_anchor?: string, payment_behavior?: string, proration_behavior?: string}}}[], phases?: (array{add_invoice_items?: (array{discountable?: bool, discounts?: array{coupon?: string, discount?: string, discount_end?: array{duration?: array{interval: string, interval_count: int}, timestamp?: int, type: string}, promotion_code?: string}[], metadata?: array<string, string>, period?: array{end: array{timestamp?: int, type: string}, start: array{timestamp?: int, type: string}}, price?: string, price_data?: array{currency: string, product: string, tax_behavior?: string, unit_amount?: int, unit_amount_decimal?: string}, quantity?: int, tax_rates?: null|string[]})[], application_fee_percent?: float, automatic_tax?: array{enabled: bool, liability?: array{account?: string, type: string}}, billing_cycle_anchor?: string, billing_thresholds?: null|array{amount_gte?: int, reset_billing_cycle_anchor?: bool}, collection_method?: string, currency?: string, default_payment_method?: string, default_tax_rates?: null|string[], description?: null|string, discounts?: null|array{coupon?: string, discount?: string, discount_end?: array{duration?: array{interval: string, interval_count: int}, timestamp?: int, type: string}, promotion_code?: string, settings?: array{service_period_anchor_config?: array{custom?: array{day_of_month: int, hour?: int, minute?: int, month?: int, second?: int}, type?: string}, start_date?: string}}[], duration?: array{interval: string, interval_count?: int}, effective_at?: string, end_date?: int, invoice_settings?: array{account_tax_ids?: null|string[], custom_fields?: null|array{name: string, value: string}[], days_until_due?: int, description?: null|string, footer?: null|string, issuer?: array{account?: string, type: string}}, items: (array{billing_thresholds?: null|array{usage_gte: int}, discounts?: null|array{coupon?: string, discount?: string, discount_end?: array{duration?: array{interval: string, interval_count: int}, timestamp?: int, type: string}, promotion_code?: string, settings?: array{service_period_anchor_config?: array{custom?: array{day_of_month: int, hour?: int, minute?: int, month?: int, second?: int}, type?: string}, start_date?: string}}[], metadata?: array<string, string>, plan?: string, price?: string, price_data?: array{currency: string, product: string, recurring: array{interval: string, interval_count?: int}, tax_behavior?: string, unit_amount?: int, unit_amount_decimal?: string}, quantity?: int, tax_rates?: null|string[], trial?: array{converts_to?: string[], type: string}, trial_offer?: string})[], metadata?: array<string, string>, on_behalf_of?: string, pause_collection?: array{behavior: string}, proration_behavior?: string, transfer_data?: array{amount_percent?: float, destination: string}, trial?: bool, trial_continuation?: string, trial_end?: int, trial_settings?: array{end_behavior?: array{prorate_up_front?: string}}})[], prebilling?: array{iterations: int, update_behavior?: string}, start_date?: array|int|string} $params
     ...
     * @param null|array{billing_behavior?: string, billing_schedules?: null|array{applies_to?: array{price?: string, type: string}[], bill_until?: array{duration?: array{interval: string, interval_count?: int}, timestamp?: int, type: string}, key?: string}[], default_settings?: array{application_fee_percent?: float, automatic_tax?: array{enabled: bool, liability?: array{account?: string, type: string}}, billing_cycle_anchor?: string, billing_thresholds?: null|array{amount_gte?: int, reset_billing_cycle_anchor?: bool}, collection_method?: string, default_payment_method?: string, description?: null|string, invoice_settings?: array{account_tax_ids?: null|string[], custom_fields?: null|array{name: string, value: string}[], days_until_due?: int, description?: null|string, footer?: null|string, issuer?: array{account?: string, type: string}}, on_behalf_of?: null|string, phase_effective_at?: string, transfer_data?: null|array{amount_percent?: float, destination: string}}, end_behavior?: string, expand?: string[], metadata?: null|array<string, string>, pause_schedules?: null|(array{key?: string, pause?: array{pause_at?: array{timestamp?: int, type: string}, settings?: array{bill_for?: array{outstanding_usage_through?: array{type?: string}, unused_time_from?: array{type?: string}}, invoicing_behavior?: string, type?: string}}, resume?: null|array{resume_at?: array{duration?: array{interval: string, interval_count?: int}, timestamp?: int, type: string}, settings?: array{billing_cycle_anchor?: string, payment_behavior?: string, proration_behavior?: string}}})[], phases?: (array{add_invoice_items?: (array{discountable?: bool, discounts?: array{coupon?: string, discount?: string, discount_end?: array{duration?: array{interval: string, interval_count: int}, timestamp?: int, type: string}, promotion_code?: string}[], metadata?: array<string, string>, period?: array{end: array{timestamp?: int, type: string}, start: array{timestamp?: int, type: string}}, price?: string, price_data?: array{currency: string, product: string, tax_behavior?: string, unit_amount?: int, unit_amount_decimal?: string}, quantity?: int, tax_rates?: null|string[]})[], application_fee_percent?: float, automatic_tax?: array{enabled: bool, liability?: array{account?: string, type: string}}, billing_cycle_anchor?: string, billing_thresholds?: null|array{amount_gte?: int, reset_billing_cycle_anchor?: bool}, collection_method?: string, currency?: string, default_payment_method?: string, default_tax_rates?: null|string[], description?: null|string, discounts?: null|array{coupon?: string, discount?: string, discount_end?: array{duration?: array{interval: string, interval_count: int}, timestamp?: int, type: string}, promotion_code?: string, settings?: array{service_period_anchor_config?: array{custom?: array{day_of_month: int, hour?: int, minute?: int, month?: int, second?: int}, type?: string}, start_date?: string}}[], duration?: array{interval: string, interval_count?: int}, effective_at?: string, end_date?: array|int|string, invoice_settings?: array{account_tax_ids?: null|string[], custom_fields?: null|array{name: string, value: string}[], days_until_due?: int, description?: null|string, footer?: null|string, issuer?: array{account?: string, type: string}}, items: (array{billing_thresholds?: null|array{usage_gte: int}, discounts?: null|array{coupon?: string, discount?: string, discount_end?: array{duration?: array{interval: string, interval_count: int}, timestamp?: int, type: string}, promotion_code?: string, settings?: array{service_period_anchor_config?: array{custom?: array{day_of_month: int, hour?: int, minute?: int, month?: int, second?: int}, type?: string}, start_date?: string}}[], metadata?: array<string, string>, plan?: string, price?: string, price_data?: array{currency: string, product: string, recurring: array{interval: string, interval_count?: int}, tax_behavior?: string, unit_amount?: int, unit_amount_decimal?: string}, quantity?: int, tax_rates?: null|string[], trial?: array{converts_to?: string[], type: string}, trial_offer?: string})[], metadata?: array<string, string>, on_behalf_of?: string, pause_collection?: array{behavior: string}, proration_behavior?: string, start_date?: array|int|string, transfer_data?: array{amount_percent?: float, destination: string}, trial?: bool, trial_continuation?: string, trial_end?: array|int|string, trial_settings?: array{end_behavior?: array{prorate_up_front?: string}}})[], prebilling?: array{iterations: int, update_behavior?: string}, proration_behavior?: string} $params
     * @param null|array|string $opts
     *

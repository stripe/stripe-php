 ...
 * @property (object{destination_amount: null|string, destination_currencies: null|string[], destination_currency: null|string, destination_network: null|string, destination_networks: null|string[], fees: null|(object{network_fee_amount: null|string, transaction_fee_amount: null|string}&\Stripe\StripeObject), lock_wallet_address: null|bool, settlement_speed: null|string, source_amount: null|string, source_currency: null|string, transaction_id: null|string, wallet_address: null|string, wallet_addresses: null|(object{avalanche: null|string, base_network: null|string, bitcoin: null|string, celo: null|string, destination_tags: null|(object{stellar: null|string}&\Stripe\StripeObject), ethereum: null|string, optimism: null|string, polygon: null|string, solana: null|string, stellar: null|string, sui: null|string, tempo: null|string, worldchain: null|string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $transaction_details
 */

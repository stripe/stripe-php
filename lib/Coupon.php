...
class Coupon extends ApiResource
{
     ...
     * it.
     *
     * @param null|array{amount_off?: int, applies_to?: array{products?: string[]}, currency?: string, currency_options?: StripeObject, duration?: string, duration_in_months?: int, expand?: string[], id?: string, max_redemptions?: int, metadata?: array<string, string>, name?: string, percent_off?: float, redeem_by?: int} $params
     ...
     * @param null|array{currency_options?: StripeObject, expand?: string[], metadata?: array<string, string>, name?: string} $params
     * @param null|array|string $opts
     *

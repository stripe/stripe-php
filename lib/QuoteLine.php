 ...
 * @property null|string $effective_at Configures how the subscription schedule handles billing for phase transitions. Possible values are <code>phase_start</code> (default) or <code>billing_period_start</code>. <code>phase_start</code> bills based on the current state of the subscription, ignoring changes scheduled in future phases. <code>billing_period_start</code> bills predictively for upcoming phase transitions within the current billing cycle, including pricing changes and service period adjustments that will occur before the next invoice.

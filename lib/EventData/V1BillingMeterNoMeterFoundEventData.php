 ...
 * @property (object{error_count: int, error_types: (object{code: string, error_count: int, sample_errors: (object{error_message: string, request: (object{identifier: string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject)[]}&\stdClass&\Stripe\StripeObject)[]}&\stdClass&\Stripe\StripeObject) $reason This contains information about why meter error happens.

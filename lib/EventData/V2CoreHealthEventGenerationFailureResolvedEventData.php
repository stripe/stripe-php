 ...
 * @property (object{account: null|string, event_type: string, livemode: bool, missing_delivery_attempts: int, related_object_id: string}&\Stripe\StripeObject) $impact The user impact.

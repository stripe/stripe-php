 ...
 * @property (object{pipeline: string}&\Stripe\StripeObject) $impact The user impact.
 ...
 */
class V2CoreHealthMetronomeNotificationLatencyResolvedEventData extends \Stripe\StripeObject {}

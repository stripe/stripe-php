 ...
 * @property (object{canonical_path: string, http_method: string, http_status: string, impacted_requests: int, impacted_requests_percentage?: string}&\Stripe\StripeObject) $impact The user impact.

 ...
 * @property (object{charge_type: string, current_percentage: string, dimensions?: (object{acquirer?: string, issuer?: string, type: string}&\Stripe\StripeObject)[], payment_method_type: string, previous_percentage: string}&\Stripe\StripeObject) $impact The user impact.

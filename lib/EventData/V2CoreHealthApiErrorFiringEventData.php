 ...
 * @property (object{canonical_path: string, error_code: null|string, http_method: string, http_status: string, impacted_requests: int}&\Stripe\StripeObject) $impact The user impact.

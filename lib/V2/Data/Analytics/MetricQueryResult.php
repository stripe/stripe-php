 ...
 * @property string $created The timestamp at which this metric query result was created.
 * @property (object{dimensions: \Stripe\StripeObject, id: string, results: (object{currency?: string, metric: string, name: string, value: int}&\Stripe\StripeObject)[], timestamp: string}&\Stripe\StripeObject)[] $data An array of timeseries data rows.
 ...
 * @property string $refreshed_at A timestamp representing the freshness of the data this metric is aggregated from.
 */

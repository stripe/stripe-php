 ...
 * @property int $created Timestamp at which the account activity was created.
 ...
 * @property int $occurred_at Timestamp at which the activity occurred. Defaults to the created time if not provided.

 ...
 * @property null|(object{fraudulent_website?: (object{details?: string, evaluated_at?: string, risk_level: string, signal?: string}&\Stripe\StripeObject), user_account_sharing?: (object{evaluated_at?: string, risk_level: string, score?: string, signal?: string}&\Stripe\StripeObject), user_multi_accounting?: (object{evaluated_at?: string, risk_level: string, score?: string, signal?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $evaluated_signals Signal results that are available for the evaluation.

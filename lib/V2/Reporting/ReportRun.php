 ...
 * @property null|(object{type: string, file?: (object{content_type: string, download_url: (object{expires_at?: int, url: string}&\Stripe\StripeObject), size: int}&\Stripe\StripeObject)}&\Stripe\StripeObject) $result Details how to retrieve the results of a successfully completed <code>ReportRun</code>.

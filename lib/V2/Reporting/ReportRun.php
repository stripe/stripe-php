 ...
 * @property null|(object{file?: (object{content_type: string, download_url: (object{expires_at?: int, url: string}&\Stripe\StripeObject), schema: (object{name: string, type: string}&\Stripe\StripeObject)[], size: int}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject) $result Details how to retrieve the results of a successfully completed <code>ReportRun</code>.

 ...
 * @property null|(object{file: (object{content_type: string, download_url: (object{expires_at: null|int, url: string}&\Stripe\StripeObject), size: int}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject) $result Details how to retrieve the results of a successfully completed <code>ReportRun</code>.
 * @property null|(object{compress_file: null|bool}&\Stripe\StripeObject) $result_options The options specified for customizing the output file of the <code>ReportRun</code>.

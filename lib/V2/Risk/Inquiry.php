 ...
 * @property string $closed_at Time at which the inquiry was closed.
 * @property string $created Time at which the inquiry was created.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property string $opened_at Time at which the inquiry was opened.
 * @property null|(object{items_removed_at: string}&\Stripe\StripeObject) $product_removal Data for product_removal inquiries. Only present when type is product_removal.

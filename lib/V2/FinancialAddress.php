 ...
 * @property null|(object{type: string, gb_bank_account: null|(object{account_holder_name: string, account_number: null|string, last4: string, sort_code: string}&\stdClass&\Stripe\StripeObject), us_bank_account: null|(object{account_number: null|string, bank_name: null|string, last4: string, routing_number: string, swift_code: null|string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $credentials Object indicates the type of credentials that have been allocated and attached to the FinancialAddress. It contains all necessary banking details with which to perform money movements with the FinancialAddress. This field is only available for FinancialAddresses with an active status.

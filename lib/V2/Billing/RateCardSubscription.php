 ...
 * @property null|(object{activated_at?: string, canceled_at?: string, paused_at?: string}&\Stripe\StripeObject) $servicing_status_transitions The servicing status transitions of the Rate Card Subscription.

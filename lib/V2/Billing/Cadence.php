...
/**
 * @property string $id The ID of the billing Cadence object.
 * @property string $object String representing the object's type. Objects of the same type share the same value of the object field.
 * @property (object{interval_count: int, type: string, day: null|(object{time: (object{hour: int, minute: int}&\Stripe\StripeObject)}&\Stripe\StripeObject), month: null|(object{day_of_month: int, time: (object{hour: int, minute: int}&\Stripe\StripeObject)}&\Stripe\StripeObject), week: null|(object{day_of_week: int, time: (object{hour: int, minute: int}&\Stripe\StripeObject)}&\Stripe\StripeObject), year: null|(object{day_of_month: int, month_of_year: int, time: (object{hour: int, minute: int}&\Stripe\StripeObject)}&\Stripe\StripeObject)}&\Stripe\StripeObject) $billing_cycle The billing cycle is the object that defines future billing cycle dates.
 ...
 * @property null|string $test_clock The ID of the TestClock.
 */

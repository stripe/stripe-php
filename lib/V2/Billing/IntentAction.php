 ...
 * @property null|(object{collect_at: string, effective_at: (object{timestamp?: int, type: string}&\Stripe\StripeObject), type: string, pricing_plan_subscription_details?: (object{component_configurations: (object{quantity?: int, lookup_key?: string, pricing_plan_component?: string}&\Stripe\StripeObject)[], new_pricing_plan: string, new_pricing_plan_version: string, overrides?: (object{partial_period_behaviors: (object{type: string, license_fee?: (object{credit_proration_behavior: string, debit_proration_behavior: string}&\Stripe\StripeObject), recurring_credit_grant?: (object{create_behavior: string}&\Stripe\StripeObject)}&\Stripe\StripeObject)[]}&\Stripe\StripeObject), pricing_plan_subscription: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $modify Details for a modify action.
 ...
 * @property null|(object{collect_at: string, effective_at: (object{timestamp?: int, type: string}&\Stripe\StripeObject), type: string, pricing_plan_subscription_details?: (object{component_configurations: (object{quantity?: int, lookup_key?: string, pricing_plan_component?: string}&\Stripe\StripeObject)[], metadata?: \Stripe\StripeObject, overrides?: (object{partial_period_behaviors: (object{type: string, license_fee?: (object{debit_proration_behavior: string}&\Stripe\StripeObject), recurring_credit_grant?: (object{create_behavior: string}&\Stripe\StripeObject)}&\Stripe\StripeObject)[]}&\Stripe\StripeObject), pricing_plan: string, pricing_plan_subscription?: string, pricing_plan_version: string}&\Stripe\StripeObject), v1_subscription_details?: (object{description?: string, items: (object{metadata?: \Stripe\StripeObject, price: string, quantity?: int}&\Stripe\StripeObject)[], metadata?: \Stripe\StripeObject}&\Stripe\StripeObject)}&\Stripe\StripeObject) $subscribe Details for a subscribe action.

 ...
 * @property null|(object{alert: string, amount: (object{custom_pricing_unit?: (object{id?: string, value: string}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject), custom_pricing_unit_overage_rate: (object{id: string}&\Stripe\StripeObject), effective_from: string, effective_until?: string}&\Stripe\StripeObject) $max_billing_period_spend Max invoice spend details. Present if type is <code>max_billing_period_spend</code>.

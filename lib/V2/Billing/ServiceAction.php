 ...
 * @property null|(object{amount: (object{custom_pricing_unit?: (object{custom_pricing_unit_details?: CustomPricingUnit, id: string, value: string}&\Stripe\StripeObject), monetary?: \Stripe\StripeObject, type: string}&\Stripe\StripeObject), applicability_config: (object{scope: (object{billable_items?: string[], price_type?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), category?: string, expiry_config: (object{type: string}&\Stripe\StripeObject), name: string, priority?: int}&\Stripe\StripeObject) $credit_grant Details for the credit grant. Provided only if <code>type</code> is &quot;credit_grant&quot;.

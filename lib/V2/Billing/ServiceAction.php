 ...
 * @property null|(object{amount: (object{type: string, custom_pricing_unit: null|(object{id: string, value: string}&\Stripe\StripeObject), monetary: null|\Stripe\StripeObject}&\Stripe\StripeObject), applicability_config: (object{scope: (object{billable_items: null|string[], price_type: null|string}&\Stripe\StripeObject)}&\Stripe\StripeObject), expiry_config: (object{type: string}&\Stripe\StripeObject), name: string}&\Stripe\StripeObject) $credit_grant_per_tenant Details for the credit grant per tenant. Provided only if <code>type</code> is &quot;credit_grant_per_tenant&quot;.

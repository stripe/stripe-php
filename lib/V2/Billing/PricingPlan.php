 ...
 * @property null|string $description A description of the pricing plan. Maximum length of 500 characters.
 ...
 * @property string $tax_behavior The tax behavior for Stripe Tax — whether the pricing plan price includes or excludes tax.
 */

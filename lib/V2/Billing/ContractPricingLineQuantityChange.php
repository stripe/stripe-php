 ...
 * @property string $created The timestamp when this quantity change object was created.
 * @property string $effective_at The timestamp when this quantity change takes effect.

 ...
 * @property null|(object{data: (object{ends_at: (object{timestamp: int}&\Stripe\StripeObject), id: string, lookup_key?: string, multiplier?: (object{criteria: (object{billable_item_ids: string[], billable_item_lookup_keys: string[], billable_item_types: string[], metadata_conditions: (object{all_of: (object{key: string, value: string}&\Stripe\StripeObject)[]}&\Stripe\StripeObject)[], rate_card_ids: string[], type: string}&\Stripe\StripeObject)[], factor: string}&\Stripe\StripeObject), priority: int, starts_at: (object{timestamp: int}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject)[]}&\Stripe\StripeObject) $pricing_overrides The pricing overrides of the contract. Only populated when <code>pricing_overrides</code> is passed in the <code>include</code> parameter.

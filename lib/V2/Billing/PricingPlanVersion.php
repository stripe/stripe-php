 ...
 * @property null|string $end_date The timestamp when this version became inactive. null if it's the latest version.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property string $pricing_plan The ID of the PricingPlan this version belongs to.
 * @property string $start_date The timestamp when this version became active.
 */

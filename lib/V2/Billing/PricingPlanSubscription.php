 ...
 * @property (object{activated_at?: string, canceled_at?: string, paused_at?: string}&\Stripe\StripeObject) $servicing_status_transitions Timestamps for servicing status transitions.

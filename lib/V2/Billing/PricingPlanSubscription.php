 ...
 * @property null|(object{license_fee_details?: (object{currency: string, display_name: string, license_fee: string, license_fee_version: string, quantity: int, service_cycle: (object{interval: string, interval_count: int}&\Stripe\StripeObject), tiering_mode?: string, tiers: (object{flat_amount?: string, unit_amount?: string, up_to_decimal?: string, up_to_inf?: string}&\Stripe\StripeObject)[], transform_quantity?: (object{divide_by: int, round: string}&\Stripe\StripeObject), unit_amount?: string, unit_label?: string}&\Stripe\StripeObject), pricing_plan_component: string, rate_card_details?: (object{currency: string, display_name: string, rate_card: string, rate_card_version: string, service_cycle: (object{interval: string, interval_count: int}&\Stripe\StripeObject), tax_behavior: string}&\Stripe\StripeObject), recurring_credit_grant_details?: (object{credit_grant_details?: (object{amount: (object{custom_pricing_unit?: (object{custom_pricing_unit_details?: CustomPricingUnit, id: string, value: string}&\Stripe\StripeObject), monetary?: \Stripe\StripeObject, type: string}&\Stripe\StripeObject), applicability_config: (object{scope: (object{billable_items?: string[], price_type?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), expiry_config: (object{type: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), credit_grant_per_tenant_details?: (object{amount: (object{custom_pricing_unit?: (object{custom_pricing_unit_details?: CustomPricingUnit, id: string, value: string}&\Stripe\StripeObject), monetary?: \Stripe\StripeObject, type: string}&\Stripe\StripeObject), applicability_config: (object{scope: (object{billable_items?: string[], price_type?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), expiry_config: (object{type: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), recurring_credit_grant: string, service_cycle: (object{interval: string, interval_count: int}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject)[] $pricing_plan_component_details Pricing plan component details for the subscription, populated when pricing_plan_component_details is included.

 ...
 * @property int $service_interval_count The length of the interval for assessing service. For example, set this to 3 and <code>service_interval</code> to <code>&quot;month&quot;</code> to specify quarterly service.

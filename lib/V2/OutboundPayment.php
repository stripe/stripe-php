 ...
 * @property null|(object{failed: null|(object{reason: string}&\stdClass&\Stripe\StripeObject), returned: null|(object{reason: string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $status_details Status details for an OutboundPayment in a <code>failed</code> or <code>returned</code> state.
 ...
 * @property (object{credited: \Stripe\StripeObject, payout_method: string, recipient: string}&\stdClass&\Stripe\StripeObject) $to To which payout method the OutboundPayment was sent.
 * @property (object{status: string, value: null|string}&\stdClass&\Stripe\StripeObject) $trace_id A unique identifier that can be used to track this OutboundPayment with recipient bank. Banks might call this a “reference number” or something similar.
 */

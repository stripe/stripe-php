 ...
 * @property null|(object{crypto?: (object{currency_networks: \Stripe\StripeObject, custody_model: string}&\Stripe\StripeObject), funds_usage_type?: string, holds_currencies: string[]}&\Stripe\StripeObject) $storage If this is a <code>storage</code> FinancialAccount, this hash includes details specific to <code>storage</code> FinancialAccounts.

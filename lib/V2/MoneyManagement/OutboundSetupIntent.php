 ...
 * @property null|(object{type: string, confirmation_of_payee: null|(object{object: string, status: string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $next_action Specifies which actions needs to be taken next to continue setup of the credential.

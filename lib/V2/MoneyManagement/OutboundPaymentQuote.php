 ...
 * @property (object{amount: \Stripe\StripeObject, network_fee_details?: (object{network: string, network_options: (object{ach?: (object{submission?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject)}&\Stripe\StripeObject), tax_amount?: (object{currency: string, value_decimal: string}&\Stripe\StripeObject), type: string}&\Stripe\StripeObject)[] $estimated_fees The estimated fees for the OutboundPaymentQuote.

 ...
 * @property string $created Time at which the OutboundTransfer was created. Represented as a RFC 3339 date &amp; time UTC value in millisecond precision, for example: 2022-09-18T13:22:18.123Z.
 ...
 * @property null|(object{failed?: (object{reason: string}&\Stripe\StripeObject), processing?: (object{reason: string}&\Stripe\StripeObject), returned?: (object{reason: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $status_details Status details for an OutboundTransfer in a <code>processing</code>, <code>failed</code>, or <code>returned</code> state.
 ...
 * @property (object{credited: \Stripe\StripeObject, payout_method: string, payout_method_options?: (object{bank_account?: (object{preferred_network_options?: (object{ach?: (object{addenda?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), preferred_networks: string[]}&\Stripe\StripeObject)}&\Stripe\StripeObject)}&\Stripe\StripeObject) $to To which payout method the OutboundTransfer was sent.

 ...
 * @property null|(object{bank_account: null|string}&\Stripe\StripeObject) $delivery_options Delivery options to be used to send the OutboundTransfer.
 ...
 * @property null|(object{failed: null|(object{reason: string}&\Stripe\StripeObject), returned: null|(object{reason: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $status_details Status details for an OutboundTransfer in a <code>failed</code> or <code>returned</code> state.
 ...
 * @property (object{status: string, value: null|string}&\Stripe\StripeObject) $trace_id A unique identifier that can be used to track this OutboundTransfer with recipient bank. Banks might call this a “reference number” or something similar.
 */

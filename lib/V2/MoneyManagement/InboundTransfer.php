 ...
 * @property (object{bank_debit_failed?: (object{failure_reason: string}&\Stripe\StripeObject), bank_debit_processing?: \Stripe\StripeObject, bank_debit_queued?: \Stripe\StripeObject, bank_debit_returned?: (object{return_reason: string}&\Stripe\StripeObject), bank_debit_succeeded?: \Stripe\StripeObject, created: int, effective_at: int, id: string, level: string, type: string}&\Stripe\StripeObject)[] $transfer_history A list of history objects, representing changes in the state of the InboundTransfer.
 */

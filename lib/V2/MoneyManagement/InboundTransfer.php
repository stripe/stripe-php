 ...
 * @property (object{bank_debit_failed?: (object{failure_reason: string}&\Stripe\StripeObject), bank_debit_processing?: (object{}&\Stripe\StripeObject), bank_debit_queued?: (object{}&\Stripe\StripeObject), bank_debit_returned?: (object{return_reason: string}&\Stripe\StripeObject), bank_debit_succeeded?: (object{}&\Stripe\StripeObject), created: string, effective_at: string, id: string, type: string}&\Stripe\StripeObject)[] $transfer_history A list of history objects, representing changes in the state of the InboundTransfer. The most recent entry's type indicates the current status of the InboundTransfer.
 */

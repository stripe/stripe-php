 ...
 * @property null|(object{archived: bool, bank_name: string, country: string, enabled_delivery_options: string[], last4: string, routing_number: null|string, supported_currencies: string[]}&\Stripe\StripeObject) $bank_account The PayoutMethodBankAccount object details.

 ...
 * @property (object{posted_at?: string, void_at?: string}&\Stripe\StripeObject) $status_transitions Timestamps for when the Transaction transitioned to a particular status.
 * @property null|string $treasury_transaction The v1 Treasury transaction associated with this transaction.
 */
class Transaction extends \Stripe\ApiResource
{
    ...
    const CATEGORY_EARNED_CREDIT = 'earned_credit';
    const CATEGORY_FINANCING_PAYDOWN = 'financing_paydown';
    const CATEGORY_FINANCING_PAYDOWN_REVERSAL = 'financing_paydown_reversal';
    const CATEGORY_INBOUND_PAYMENT = 'inbound_payment';
    const CATEGORY_INBOUND_PAYMENT_FAILURE = 'inbound_payment_failure';
    ...
    const CATEGORY_PAYMENT_METHOD_PASSTHROUGH_FEE = 'payment_method_passthrough_fee';
    ...
    const CATEGORY_TAX_FUND = 'tax_fund';
    const CATEGORY_TAX_WITHHOLDING = 'tax_withholding';

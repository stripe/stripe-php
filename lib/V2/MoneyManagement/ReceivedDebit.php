 ...
 * @property null|(object{canceled_at?: string, failed_at?: string, succeeded_at?: string}&\Stripe\StripeObject) $status_transitions The time at which the ReceivedDebit transitioned to a particular status.

 ...
 * @property null|(object{to_account?: string, topup?: string, type: string}&\Stripe\StripeObject) $balance_transfer This object stores details about the balance transfer object that resulted in the ReceivedDebit.
 * @property null|(object{financial_address: string, gb_bank_account?: (object{account_holder_name?: string, bank_name?: string, last4?: string, network: string, received_debit_mandate?: string, sort_code?: string}&\Stripe\StripeObject), network_details?: (object{ach?: (object{addenda?: string, originator_company_entry_description?: string, originator_company_id?: string, originator_company_name?: string, receiver_id_number?: string, receiver_name?: string, standard_entry_class_code?: string, trace_id?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), origin_type: string, payment_method_type: string, statement_descriptor?: string, us_bank_account?: (object{bank_name?: string, network: string, routing_number?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject) $bank_transfer This object stores details about the originating banking transaction that resulted in the ReceivedDebit. Present if <code>type</code> field value is <code>bank_transfer</code>.
 ...
 * @property string $created The time at which the ReceivedDebit was created. Represented as a RFC 3339 date &amp; time UTC value in millisecond precision, for example: <code>2022-09-18T13:22:18.123Z</code>.
 * @property null|string $description Freeform string sent by the originator of the ReceivedDebit.
 * @property null|(object{debit_dispute?: string, dispute_window_closes_at?: string}&\Stripe\StripeObject) $dispute_details The dispute details.
 ...
 * @property null|string $settles_at The time at which the scheduled ReceivedDebit is expected to settle. Represented as a RFC 3339 date &amp; time UTC value in millisecond precision, for example: <code>2022-09-18T13:22:18.123Z</code>. Only present when status is <code>scheduled</code>.
 ...
 * @property null|(object{canceled_at?: string, failed_at?: string, returned_at?: string, succeeded_at?: string}&\Stripe\StripeObject) $status_transitions The time at which the ReceivedDebit transitioned to a particular status.

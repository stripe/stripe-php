 ...
 * @property null|(object{crypto_wallet: (object{address: string, memo: string, network: string}&\Stripe\StripeObject), financial_address: string, origin_type: string, statement_descriptor?: string}&\Stripe\StripeObject) $crypto_wallet_transfer This object stores details about the originating crypto transaction that resulted in the ReceivedCredit. Present if <code>type</code> field value is <code>crypto_wallet_transfer</code>.

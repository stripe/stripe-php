 ...
 * @property string[] $ip_allowlist List of IP addresses allowed to use this API key.
 * @property null|int $last_used Timestamp when the API key was last used.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string $managed_by Account that manages this API key (for keys managed by platforms).
 ...
 * @property null|string $status Current status of the API key (e.g., active, expired).

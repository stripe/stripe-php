 ...
 * @property (object{mcp: null|string, publishable: string, secret: string}&\Stripe\StripeObject) $api_keys Keys that can be used to set up an integration for this sandbox and operate on the account.

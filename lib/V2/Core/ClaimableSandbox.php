 ...
 * @property (object{account: string, api_keys: null|(object{mcp: null|string, publishable: string, secret: string}&\Stripe\StripeObject), owner_account: null|string}&\Stripe\StripeObject) $sandbox_details Data about the Stripe sandbox object.

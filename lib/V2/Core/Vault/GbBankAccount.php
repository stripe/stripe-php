 ...
 * @property (object{result: (object{created: int, match_result: string, matched: (object{business_type: null|string, name: null|string}&\stdClass&\Stripe\StripeObject), message: string, provided: (object{business_type: string, name: string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject), status: string}&\stdClass&\Stripe\StripeObject) $confirmation_of_payee Information around the status of Confirmation of Payee matching done on this bank account. Confirmation of Payee is a name matching service that must be done before making OutboundPayments in the UK.

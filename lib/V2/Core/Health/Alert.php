 ...
 *
 * @property string $id Unique identifier for the health alert.
 ...
 * @property string $grouping_type Whether the alert is linked to an incident or is a self-contained problem.
...
{
    const OBJECT_NAME = 'v2.core.health.alert';
    ...
    const GROUPING_TYPE_INCIDENT = 'incident';
    const GROUPING_TYPE_STANDALONE = 'standalone';

    const SEVERITY_CRITICAL = 'critical';
    const SEVERITY_NON_CRITICAL = 'non_critical';

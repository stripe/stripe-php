 ...
 * @property null|(object{financial_address: string, payment_method_type: string, statement_descriptor: null|string, us_bank_account: (object{bank_name: null|string, network: string, routing_number: null|string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $bank_transfer This object stores details about the originating banking transaction that resulted in the ReceivedDebit. Present if <code>type</code> field value is <code>bank_transfer</code>.
 * @property null|(object{authorization: null|(object{amount: \Stripe\StripeObject, issuing_authorization_v1: string}&\stdClass&\Stripe\StripeObject), card_transactions: (object{amount: \Stripe\StripeObject, issuing_transaction_v1: string}&\stdClass&\Stripe\StripeObject)[], card_v1_id: string}&\stdClass&\Stripe\StripeObject) $card_spend This object stores details about the issuing transactions that resulted in the ReceivedDebit. Present if <code>type</code> field value is <code>card_spend</code>.
 ...
 * @property null|(object{failed: (object{reason: string}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $status_details Detailed information about the status of the ReceivedDebit.
 * @property (object{canceled_at: null|int, failed_at: null|int, succeeded_at: null|int}&\stdClass&\Stripe\StripeObject) $status_transitions The time at which the ReceivedDebit transitioned to a particular status.

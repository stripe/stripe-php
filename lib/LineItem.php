 ...
 * @property null|(object{enabled: bool, maximum: null|int, minimum: null|int}&\stdClass&StripeObject) $adjustable_quantity
 ...
 * @property null|(object{description: null|string, images: string[], name: string}&\stdClass&StripeObject) $display

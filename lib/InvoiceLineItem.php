 ...
 * @property null|(object{invoice_item_details: null|(object{invoice_item: string, proration: bool, proration_details: null|(object{credited_items: null|(object{invoice: string, invoice_line_items: string[]}&\stdClass&StripeObject)}&\stdClass&StripeObject), subscription: null|string}&\stdClass&StripeObject), subscription_item_details: null|(object{invoice_item: null|string, proration: bool, proration_details: null|(object{credited_items: null|(object{invoice: string, invoice_line_items: string[]}&\stdClass&StripeObject)}&\stdClass&StripeObject), subscription: string, subscription_item: string}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject) $parent

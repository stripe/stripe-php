 ...
 * @property null|(object{invoice_item_details: null|(object{invoice_item: string, proration: bool, proration_details: null|(object{credited_items: null|(object{invoice: string, invoice_line_items: string[]}&StripeObject)}&StripeObject), subscription: null|string}&StripeObject), subscription_item_details: null|(object{invoice_item: null|string, proration: bool, proration_details: null|(object{credited_items: null|(object{invoice: string, invoice_line_items: string[]}&StripeObject)}&StripeObject), subscription: null|string, subscription_item: string}&StripeObject), type: string, rate_card_subscription_details?: (object{invoice_item: string, rate_card_subscription: string, rate_card_version: string}&StripeObject)}&StripeObject) $parent The parent that generated this line item.
 ...
 * @property null|(object{price_details?: (object{price: string, product: string}&StripeObject), type: string, unit_amount_decimal: null|string, rate_card_rate_details?: (object{rate_card: string, rate_card_rate: string, metered_item: string}&StripeObject)}&StripeObject) $pricing The pricing information of the line item.

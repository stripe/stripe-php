...
class BalanceTransaction extends ApiResource
{
    ...
    const TYPE_ISSUING_DISPUTE_PROVISIONAL_CREDIT = 'issuing_dispute_provisional_credit';
    const TYPE_ISSUING_DISPUTE_PROVISIONAL_CREDIT_REVERSAL = 'issuing_dispute_provisional_credit_reversal';

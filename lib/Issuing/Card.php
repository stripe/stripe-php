 ...
 * @property null|(object{address: null|string, chain: string, currency: string, type: null|string}&\Stripe\StripeObject) $crypto_wallet
 ...
 * @property null|string $product_code The product code the card is currently enrolled under. <code>product_graduation_state</code> reflects any in-flight product graduation and whether the card network has confirmed it.
 * @property null|(object{state: string, target_product_code: null|string}&\Stripe\StripeObject) $product_graduation_state State of the product graduation request on this card. Only present when a product graduation has been requested.
...
class Card extends \Stripe\ApiResource
{
     ...
     * @param null|array{cancellation_reason?: string, crypto_wallet?: array{currency: string}, expand?: string[], metadata?: null|array<string, string>, personalization_design?: string, pin?: array{encrypted_number?: string}, product_code?: string, shipping?: array{address: array{city: string, country: string, line1: string, line2?: string, postal_code: string, state?: string}, address_validation?: array{mode: string}, business_name?: string, customs?: array{eori_number?: string}, name: string, phone_number?: string, require_signature?: bool, service?: string, type?: string}, spending_controls?: array{allowed_card_presences?: string[], allowed_categories?: string[], allowed_merchant_countries?: string[], blocked_card_presences?: string[], blocked_categories?: string[], blocked_merchant_countries?: string[], spending_limits?: array{amount: int, categories?: string[], interval: string}[]}, status?: string} $params
     * @param null|array|string $opts
     *

 ...
 * @property null|(object{footer_body: null|string, footer_title: null|string, header_body: null|string, header_title: null|string}&\stdClass&\Stripe\StripeObject) $carrier_text Hash containing carrier text, for use with physical bundles that support carrier text.
 ...
 * @property (object{is_default: bool, is_platform_default: null|bool}&\stdClass&\Stripe\StripeObject) $preferences
 * @property (object{card_logo: null|string[], carrier_text: null|string[]}&\stdClass&\Stripe\StripeObject) $rejection_reasons

 ...
 * @property null|(object{account_type: string, available_balance: int, currency: string, current_balance: int}&\Stripe\StripeObject) $balance_response
 ...
 * @property null|(object{clinic_amount?: null|int, currency?: string, dental_amount?: null|int, prescription_amount?: null|int, purchase_type?: null|string, total_qualified_amount?: int, verification_status?: string, vision_amount?: null|int}&\Stripe\StripeObject) $healthcare Details about the IIAS FSA/HSA healthcare amounts on this authorization.
 ...
 * @property null|float $merchant_amount_exchange_rate The exchange rate used by the network to convert the <code>merchant_amount</code> to <code>amount</code>. The <code>merchant_amount</code> multiplied with this rate will equal to the <code>amount</code>.
 ...
 * @property (object{category: string, category_code: string, city: null|string, country: null|string, name: null|string, network_id: string, payment_facilitator_id?: null|string, postal_code: null|string, state: null|string, sub_merchant_id?: null|string, tax_id: null|string, terminal_id: null|string, url: null|string}&\Stripe\StripeObject) $merchant_data
 ...
 * @property null|(object{amount: int, amount_details: null|(object{atm_fee: null|int, cashback_amount: null|int}&\Stripe\StripeObject), currency: string, hold_amount?: null|(object{currency: string, value: int}&\Stripe\StripeObject), hold_amount_details?: null|(object{network: (object{currency: string, value: int}&\Stripe\StripeObject), reserve: null|(object{currency: string, value: int}&\Stripe\StripeObject)}&\Stripe\StripeObject), is_amount_controllable: bool, merchant_amount: int, merchant_currency: string, network_risk_score: null|int}&\Stripe\StripeObject) $pending_request The pending authorization request. This field will only be non-null during an <code>issuing_authorization.request</code> webhook.
 ...
 * @property null|(object{card: string, created: int, device_fingerprint?: string, network_data?: (object{device?: (object{device_id?: null|string, ip_address?: string, language?: string, phone_number?: string}&\Stripe\StripeObject), mastercard?: (object{card_reference_id?: string, token_reference_id: string, token_requestor_id: string}&\Stripe\StripeObject), type: string, visa?: (object{card_reference_id?: string, token_decision_recommendation?: null|string, token_reference_id: string, token_requestor_id: string, token_risk_score?: string}&\Stripe\StripeObject), wallet_provider?: (object{account_trust_score?: int, card_number_source?: string, device_trust_score?: int, reason_codes?: string[], suggested_decision?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject), provisioning_decision?: null|string, token_type?: null|string}&\Stripe\StripeObject) $token_details

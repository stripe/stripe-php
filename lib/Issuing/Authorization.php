 ...
 * @property null|(object{card: string, created: int, device_fingerprint?: string, network_data?: (object{device?: (object{ip_address?: string, language?: string, phone_number?: string}&\Stripe\StripeObject), mastercard?: (object{card_reference_id?: string, token_reference_id: string, token_requestor_id: string}&\Stripe\StripeObject), type: string, visa?: (object{card_reference_id?: string, token_reference_id: string, token_requestor_id: string, token_risk_score?: string}&\Stripe\StripeObject), wallet_provider?: (object{account_trust_score?: int, card_number_source?: string, device_trust_score?: int, reason_codes?: string[], suggested_decision?: string}&\Stripe\StripeObject)}&\Stripe\StripeObject)}&\Stripe\StripeObject) $token_details

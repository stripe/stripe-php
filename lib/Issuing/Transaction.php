 ...
 * @property string|\Stripe\Issuing\Authorization|null $authorization The <code>Authorization</code> object that led to this transaction.
 * @property string|\Stripe\BalanceTransaction|null $balance_transaction ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
 ...
 * @property string|\Stripe\Issuing\Dispute|null $dispute If you've disputed the transaction, the ID of the <a href="https://stripe.com/docs/api/issuing/disputes/object">dispute object</a>.

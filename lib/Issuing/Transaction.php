 ...
 * @property null|\Stripe\StripeObject $amount_details Detailed breakdown of amount components. These amounts are denominated in `currency` and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>.
 ...
 * @property int $merchant_amount The amount that the merchant will receive, denominated in `merchant_currency` and in the <a href="https://stripe.com/docs/currencies#zero-decimal">smallest currency unit</a>. It will be different from `amount` if the merchant is taking payment in a different currency.

 ...
 * @property null|(object{acquirer_reference_number?: null|string, acquiring_institution_country?: null|string, acquiring_institution_id?: null|string, authorization_code: null|string, processing_date: null|string, retrieval_reference_number?: null|string, routed_network?: null|string, trace_id?: null|(object{banknet_reference_number: null|string, financial_network_code: null|string, network_date: null|string}&\Stripe\StripeObject), transaction_id: null|string}&\Stripe\StripeObject) $network_data Details about the transaction, such as processing dates, set by the card network.
 ...
 * @property null|Settlement|string $settlement The ID of the <a href="https://docs.stripe.com/api/issuing/settlements">settlement</a> to which this transaction belongs.
 * @property null|(object{amount: null|int, currency: null|string, exchange_rate: null|float}&\Stripe\StripeObject) $settlement_details Details about the transaction for settlement reconciliation.

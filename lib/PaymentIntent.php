 ...
 * @property null|(object{tip?: (object{amount?: int}&\stdClass&StripeObject)}&\stdClass&StripeObject) $amount_details
 ...
 * @property null|(object{inputs?: (object{tax?: (object{calculation: string}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject) $async_workflows
 * @property null|(object{allow_redirects?: string, enabled: bool}&\stdClass&StripeObject) $automatic_payment_methods Settings to configure compatible payment methods from the <a href="https://dashboard.stripe.com/settings/payment_methods">Stripe Dashboard</a>
 ...
 * @property null|string $customer_account <p>ID of the Account this PaymentIntent belongs to, if one exists.</p><p>Payment methods attached to other Accounts cannot be used with this PaymentIntent.</p><p>If <a href="https://stripe.com/docs/api#payment_intent_object-setup_future_usage">setup_future_usage</a> is set and this PaymentIntent's payment method is not <code>card_present</code>, then the payment method attaches to the Account after the PaymentIntent has been confirmed and any required actions from the user are complete. If the payment method is <code>card_present</code> and isn't a digital wallet, then a <a href="https://docs.stripe.com/api/charges/object#charge_object-payment_method_details-card_present-generated_card">generated_card</a> payment method representing the card is created and attached to the Account instead.</p>
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|(object{advice_code?: string, charge?: string, code?: string, decline_code?: string, doc_url?: string, message?: string, network_advice_code?: string, network_decline_code?: string, param?: string, payment_intent?: PaymentIntent, payment_method?: PaymentMethod, payment_method_type?: string, request_log_url?: string, setup_intent?: SetupIntent, source?: Account|BankAccount|Card|Source, type: string}&\stdClass&StripeObject) $last_payment_error The payment error encountered in the previous PaymentIntent confirmation. It will be cleared if the PaymentIntent is later updated for any reason.
 ...
 * @property null|(object{alipay_handle_redirect?: (object{native_data: null|string, native_url: null|string, return_url: null|string, url: null|string}&\stdClass&StripeObject), boleto_display_details?: (object{expires_at: null|int, hosted_voucher_url: null|string, number: null|string, pdf: null|string}&\stdClass&StripeObject), card_await_notification?: (object{charge_attempt_at: null|int, customer_approval_required: null|bool}&\stdClass&StripeObject), cashapp_handle_redirect_or_display_qr_code?: (object{hosted_instructions_url: string, mobile_auth_url: string, qr_code: (object{expires_at: int, image_url_png: string, image_url_svg: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), display_bank_transfer_instructions?: (object{amount_remaining: null|int, currency: null|string, financial_addresses?: ((object{aba?: (object{account_holder_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), account_holder_name: string, account_number: string, account_type: string, bank_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), bank_name: string, routing_number: string}&\stdClass&StripeObject), iban?: (object{account_holder_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), account_holder_name: string, bank_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), bic: string, country: string, iban: string}&\stdClass&StripeObject), sort_code?: (object{account_holder_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), account_holder_name: string, account_number: string, bank_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), sort_code: string}&\stdClass&StripeObject), spei?: (object{account_holder_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), account_holder_name: string, bank_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), bank_code: string, bank_name: string, clabe: string}&\stdClass&StripeObject), supported_networks?: string[], swift?: (object{account_holder_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), account_holder_name: string, account_number: string, account_type: string, bank_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), bank_name: string, swift_code: string}&\stdClass&StripeObject), type: string, zengin?: (object{account_holder_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), account_holder_name: null|string, account_number: null|string, account_type: null|string, bank_address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), bank_code: null|string, bank_name: null|string, branch_code: null|string, branch_name: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject))[], hosted_instructions_url: null|string, reference: null|string, type: string}&\stdClass&StripeObject), konbini_display_details?: (object{expires_at: int, hosted_voucher_url: null|string, stores: (object{familymart: null|(object{confirmation_number?: string, payment_code: string}&\stdClass&StripeObject), lawson: null|(object{confirmation_number?: string, payment_code: string}&\stdClass&StripeObject), ministop: null|(object{confirmation_number?: string, payment_code: string}&\stdClass&StripeObject), seicomart: null|(object{confirmation_number?: string, payment_code: string}&\stdClass&StripeObject)}&\stdClass&StripeObject)}&\stdClass&StripeObject), multibanco_display_details?: (object{entity: null|string, expires_at: null|int, hosted_voucher_url: null|string, reference: null|string}&\stdClass&StripeObject), oxxo_display_details?: (object{expires_after: null|int, hosted_voucher_url: null|string, number: null|string}&\stdClass&StripeObject), paynow_display_qr_code?: (object{data: string, hosted_instructions_url: null|string, image_url_png: string, image_url_svg: string}&\stdClass&StripeObject), pix_display_qr_code?: (object{data?: string, expires_at?: int, hosted_instructions_url?: string, image_url_png?: string, image_url_svg?: string}&\stdClass&StripeObject), promptpay_display_qr_code?: (object{data: string, hosted_instructions_url: string, image_url_png: string, image_url_svg: string}&\stdClass&StripeObject), redirect_to_url?: (object{return_url: null|string, url: null|string}&\stdClass&StripeObject), swish_handle_redirect_or_display_qr_code?: (object{hosted_instructions_url: string, mobile_auth_url: string, qr_code: (object{data: string, image_url_png: string, image_url_svg: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), type: string, use_stripe_sdk?: StripeObject, verify_with_microdeposits?: (object{arrival_date: int, hosted_verification_url: string, microdeposit_type: null|string}&\stdClass&StripeObject), wechat_pay_display_qr_code?: (object{data: string, hosted_instructions_url: string, image_data_url: string, image_url_png: string, image_url_svg: string}&\stdClass&StripeObject), wechat_pay_redirect_to_android_app?: (object{app_id: string, nonce_str: string, package: string, partner_id: string, prepay_id: string, sign: string, timestamp: string}&\stdClass&StripeObject), wechat_pay_redirect_to_ios_app?: (object{native_url: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $next_action If present, this property tells you what actions you need to take in order for your customer to fulfill a payment using the provided source.
 ...
 * @property (object{car_rental?: (object{affiliate?: (object{name?: string}&\stdClass&StripeObject), booking_number: string, car_class_code?: string, car_make?: string, car_model?: string, company?: string, customer_service_phone_number?: string, days_rented: int, delivery?: (object{mode?: string, recipient?: (object{email?: string, name?: string, phone?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), drivers?: (object{name?: string}&\stdClass&StripeObject)[], extra_charges?: string[], no_show?: bool, pickup_address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), pickup_at: int, rate_amount?: int, rate_interval?: string, renter_name?: string, return_address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), return_at: int, tax_exempt?: bool}&\stdClass&StripeObject), event_details?: (object{access_controlled_venue?: bool, address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), affiliate?: (object{name?: string}&\stdClass&StripeObject), company?: string, delivery?: (object{mode?: string, recipient?: (object{email?: string, name?: string, phone?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), ends_at?: int, genre?: string, name?: string, starts_at?: int}&\stdClass&StripeObject), subscription?: (object{affiliate?: (object{name?: string}&\stdClass&StripeObject), auto_renewal?: bool, billing_interval?: (object{count?: int, interval?: string}&\stdClass&StripeObject), ends_at?: int, name?: string, starts_at?: int}&\stdClass&StripeObject)}&\stdClass&StripeObject) $payment_details
 * @property null|PaymentMethod|string $payment_method ID of the payment method used in this PaymentIntent.
 * @property null|(object{id: string, parent: null|string}&\stdClass&StripeObject) $payment_method_configuration_details Information about the <a href="https://stripe.com/docs/api/payment_method_configurations">payment method configuration</a> used for this PaymentIntent.
 * @property null|(object{acss_debit?: (object{mandate_options?: (object{custom_mandate_url?: string, interval_description: null|string, payment_schedule: null|string, transaction_type: null|string}&\stdClass&StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\stdClass&StripeObject), affirm?: (object{capture_method?: string, preferred_locale?: string, setup_future_usage?: string}&\stdClass&StripeObject), afterpay_clearpay?: (object{capture_method?: string, reference: null|string, setup_future_usage?: string}&\stdClass&StripeObject), alipay?: (object{setup_future_usage?: string}&\stdClass&StripeObject), alma?: (object{capture_method?: string}&\stdClass&StripeObject), amazon_pay?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&StripeObject), au_becs_debit?: (object{setup_future_usage?: string, target_date?: string}&\stdClass&StripeObject), bacs_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\stdClass&StripeObject), setup_future_usage?: string, target_date?: string}&\stdClass&StripeObject), bancontact?: (object{preferred_language: string, setup_future_usage?: string}&\stdClass&StripeObject), billie?: (object{}&\stdClass&StripeObject), blik?: (object{setup_future_usage?: string}&\stdClass&StripeObject), boleto?: (object{expires_after_days: int, setup_future_usage?: string}&\stdClass&StripeObject), card?: (object{capture_method?: string, installments: null|(object{available_plans: null|((object{count: null|int, interval: null|string, type: string}&\stdClass&StripeObject))[], enabled: bool, plan: null|(object{count: null|int, interval: null|string, type: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), mandate_options: null|(object{amount: int, amount_type: string, description: null|string, end_date: null|int, interval: string, interval_count: null|int, reference: string, start_date: int, supported_types: null|string[]}&\stdClass&StripeObject), network: null|string, request_decremental_authorization?: string, request_extended_authorization?: string, request_incremental_authorization?: string, request_multicapture?: string, request_overcapture?: string, request_partial_authorization?: string, request_three_d_secure: null|string, require_cvc_recollection?: bool, setup_future_usage?: string, statement_descriptor_suffix_kana?: string, statement_descriptor_suffix_kanji?: string, statement_details?: (object{address?: (object{city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, state?: string}&\stdClass&StripeObject), phone?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), card_present?: (object{request_extended_authorization: null|bool, request_incremental_authorization_support: null|bool, routing?: (object{requested_priority: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), cashapp?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&StripeObject), customer_balance?: (object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&\stdClass&StripeObject), requested_address_types?: string[], type: null|string}&\stdClass&StripeObject), funding_type: null|string, setup_future_usage?: string}&\stdClass&StripeObject), eps?: (object{setup_future_usage?: string}&\stdClass&StripeObject), fpx?: (object{setup_future_usage?: string}&\stdClass&StripeObject), giropay?: (object{setup_future_usage?: string}&\stdClass&StripeObject), gopay?: (object{setup_future_usage?: string}&\stdClass&StripeObject), grabpay?: (object{setup_future_usage?: string}&\stdClass&StripeObject), id_bank_transfer?: (object{expires_after?: null|int, expires_at: null|int, setup_future_usage?: string}&\stdClass&StripeObject), ideal?: (object{setup_future_usage?: string}&\stdClass&StripeObject), interac_present?: (object{}&\stdClass&StripeObject), kakao_pay?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&StripeObject), klarna?: (object{capture_method?: string, preferred_locale: null|string, setup_future_usage?: string}&\stdClass&StripeObject), konbini?: (object{confirmation_number: null|string, expires_after_days: null|int, expires_at: null|int, product_description: null|string, setup_future_usage?: string}&\stdClass&StripeObject), kr_card?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&StripeObject), link?: (object{capture_method?: string, persistent_token: null|string, setup_future_usage?: string}&\stdClass&StripeObject), mb_way?: (object{setup_future_usage?: string}&\stdClass&StripeObject), mobilepay?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&StripeObject), multibanco?: (object{setup_future_usage?: string}&\stdClass&StripeObject), naver_pay?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&StripeObject), nz_bank_account?: (object{setup_future_usage?: string, target_date?: string}&\stdClass&StripeObject), oxxo?: (object{expires_after_days: int, setup_future_usage?: string}&\stdClass&StripeObject), p24?: (object{setup_future_usage?: string}&\stdClass&StripeObject), pay_by_bank?: (object{}&\stdClass&StripeObject), payco?: (object{capture_method?: string}&\stdClass&StripeObject), paynow?: (object{setup_future_usage?: string}&\stdClass&StripeObject), paypal?: (object{capture_method?: string, line_items?: (object{category?: string, description?: string, name: string, quantity: int, sku?: string, sold_by?: string, tax?: (object{amount: int, behavior: string}&\stdClass&StripeObject), unit_amount: int}&\stdClass&StripeObject)[], preferred_locale: null|string, reference: null|string, reference_id?: null|string, setup_future_usage?: string, subsellers?: string[]}&\stdClass&StripeObject), payto?: (object{mandate_options?: (object{amount: null|int, amount_type: null|string, end_date: null|string, payment_schedule: null|string, payments_per_period: null|int, purpose: null|string}&\stdClass&StripeObject), setup_future_usage?: string}&\stdClass&StripeObject), pix?: (object{expires_after_seconds: null|int, expires_at: null|int, setup_future_usage?: string}&\stdClass&StripeObject), promptpay?: (object{setup_future_usage?: string}&\stdClass&StripeObject), qris?: (object{setup_future_usage?: string}&\stdClass&StripeObject), rechnung?: (object{}&\stdClass&StripeObject), revolut_pay?: (object{capture_method?: string, setup_future_usage?: string}&\stdClass&StripeObject), samsung_pay?: (object{capture_method?: string}&\stdClass&StripeObject), sepa_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\stdClass&StripeObject), setup_future_usage?: string, target_date?: string}&\stdClass&StripeObject), shopeepay?: (object{setup_future_usage?: string}&\stdClass&StripeObject), sofort?: (object{preferred_language: null|string, setup_future_usage?: string}&\stdClass&StripeObject), stripe_balance?: (object{setup_future_usage?: string}&\stdClass&StripeObject), swish?: (object{reference: null|string, setup_future_usage?: string}&\stdClass&StripeObject), twint?: (object{setup_future_usage?: string}&\stdClass&StripeObject), us_bank_account?: (object{financial_connections?: (object{filters?: (object{account_subcategories?: string[], institution?: string}&\stdClass&StripeObject), manual_entry?: (object{mode?: string}&\stdClass&StripeObject), permissions?: string[], prefetch: null|string[], return_url?: string}&\stdClass&StripeObject), mandate_options?: (object{collection_method?: string}&\stdClass&StripeObject), preferred_settlement_speed?: string, setup_future_usage?: string, target_date?: string, verification_method?: string}&\stdClass&StripeObject), wechat_pay?: (object{app_id: null|string, client: null|string, setup_future_usage?: string}&\stdClass&StripeObject), zip?: (object{setup_future_usage?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $payment_method_options Payment-method-specific configuration for this PaymentIntent.
 ...
 * @property null|(object{card?: (object{customer_notification?: (object{approval_requested: null|bool, completes_at: null|int}&\stdClass&StripeObject)}&\stdClass&StripeObject), type: string}&\stdClass&StripeObject) $processing If present, this property tells you about the processing state of the payment.
 ...
 * @property null|(object{address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), carrier?: null|string, name?: string, phone?: null|string, tracking_number?: null|string}&\stdClass&StripeObject) $shipping Shipping information for this PaymentIntent.
 ...
 * @property null|(object{amount?: int, destination: Account|string}&\stdClass&StripeObject) $transfer_data The data that automatically creates a Transfer after the payment finalizes. Learn more about the <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a>.
...
class PaymentIntent extends ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return PaymentIntent the decremented payment intent
     *
     * @throws Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|array|string $opts
     *
     * @return PaymentIntent the triggered payment intent
     *
     * @throws Exception\ApiErrorException if the request fails
     */

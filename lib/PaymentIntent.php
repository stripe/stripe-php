 ...
 * @property null|(object{car_rental?: (object{affiliate?: (object{name?: string}&StripeObject), booking_number: string, car_class_code?: string, car_make?: string, car_model?: string, company?: string, customer_service_phone_number?: string, days_rented: int, delivery?: (object{mode?: string, recipient?: (object{email?: string, name?: string, phone?: string}&StripeObject)}&StripeObject), drivers?: (object{name?: string}&StripeObject)[], extra_charges?: string[], no_show?: bool, pickup_address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&StripeObject), pickup_at: int, rate_amount?: int, rate_interval?: string, renter_name?: string, return_address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&StripeObject), return_at: int, tax_exempt?: bool}&StripeObject), event_details?: (object{access_controlled_venue?: bool, address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&StripeObject), affiliate?: (object{name?: string}&StripeObject), company?: string, delivery?: (object{mode?: string, recipient?: (object{email?: string, name?: string, phone?: string}&StripeObject)}&StripeObject), ends_at?: int, genre?: string, name?: string, starts_at?: int}&StripeObject), subscription?: (object{affiliate?: (object{name?: string}&StripeObject), auto_renewal?: bool, billing_interval?: (object{count?: int, interval?: string}&StripeObject), ends_at?: int, name?: string, starts_at?: int}&StripeObject)}&StripeObject) $payment_details

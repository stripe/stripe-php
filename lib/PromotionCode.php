...
class PromotionCode extends ApiResource
{
     ...
     *
     * @param null|array{active?: bool, code?: string, coupon: string, customer?: string, expand?: string[], expires_at?: int, max_redemptions?: int, metadata?: array<string, string>, restrictions?: array{currency_options?: StripeObject, first_time_transaction?: bool, minimum_amount?: int, minimum_amount_currency?: string}} $params
     ...
     * @param null|array{active?: bool, expand?: string[], metadata?: array<string, string>, restrictions?: array{currency_options?: StripeObject}} $params
     * @param null|array|string $opts
     *

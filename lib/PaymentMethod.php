 ...
 * @property null|(object{display_name: null|string, logo: null|(object{content_type: null|string, url: string}&StripeObject), type: string, payment_method_reference?: null|string}&StripeObject) $custom

 ...
 * @property null|(object{enabled: bool, status: null|string}&\stdClass&StripeObject) $automatic_tax
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), email: null|string, name: null|string, phone: null|string}&\stdClass&StripeObject) $billing_details Customer billing details associated with the order.
 ...
 * @property null|((object{amount: int, gift_card: null|(object{card: string}&\stdClass&StripeObject), ineligible_line_items: null|string[], type: string}&\stdClass&StripeObject))[] $credits The credits applied to the Order. At most 10 credits can be applied to an Order.
 ...
 * @property (object{payment_intent: null|PaymentIntent|string, settings: null|(object{application_fee_amount: null|int, automatic_payment_methods: null|(object{enabled: bool}&\stdClass&StripeObject), payment_method_options: null|(object{acss_debit?: (object{mandate_options?: (object{custom_mandate_url?: string, interval_description: null|string, payment_schedule: null|string, transaction_type: null|string}&\stdClass&StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\stdClass&StripeObject), afterpay_clearpay?: (object{capture_method?: string, reference: null|string, setup_future_usage?: string}&\stdClass&StripeObject), alipay?: (object{setup_future_usage?: string}&\stdClass&StripeObject), bancontact?: (object{preferred_language: string, setup_future_usage?: string}&\stdClass&StripeObject), card?: (object{capture_method: string, setup_future_usage?: string}&\stdClass&StripeObject), customer_balance?: (object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&\stdClass&StripeObject), requested_address_types?: string[], type: null|string}&\stdClass&StripeObject), funding_type: null|string, setup_future_usage?: string}&\stdClass&StripeObject), ideal?: (object{setup_future_usage?: string}&\stdClass&StripeObject), klarna?: (object{capture_method?: string, preferred_locale: null|string, setup_future_usage?: string}&\stdClass&StripeObject), link?: (object{capture_method?: string, persistent_token: null|string, setup_future_usage?: string}&\stdClass&StripeObject), oxxo?: (object{expires_after_days: int, setup_future_usage?: string}&\stdClass&StripeObject), p24?: (object{setup_future_usage?: string}&\stdClass&StripeObject), paypal?: (object{capture_method?: string, line_items?: (object{category?: string, description?: string, name: string, quantity: int, sku?: string, sold_by?: string, tax?: (object{amount: int, behavior: string}&\stdClass&StripeObject), unit_amount: int}&\stdClass&StripeObject)[], preferred_locale: null|string, reference: null|string, reference_id?: null|string, setup_future_usage?: string, subsellers?: string[]}&\stdClass&StripeObject), sepa_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\stdClass&StripeObject), setup_future_usage?: string, target_date?: string}&\stdClass&StripeObject), sofort?: (object{preferred_language: null|string, setup_future_usage?: string}&\stdClass&StripeObject), wechat_pay?: (object{app_id: null|string, client: null|string, setup_future_usage?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), payment_method_types: null|string[], return_url: null|string, statement_descriptor: null|string, statement_descriptor_suffix: null|string, transfer_data: null|(object{amount: null|int, destination: Account|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), status: null|string}&\stdClass&StripeObject) $payment
 * @property null|(object{amount_subtotal: int, amount_tax: int, amount_total: int, shipping_rate: null|ShippingRate|string, taxes?: ((object{amount: int, rate: TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\stdClass&StripeObject))[]}&\stdClass&StripeObject) $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), name: null|string, phone: null|string}&\stdClass&StripeObject) $shipping_details Customer shipping information associated with the order.
 * @property string $status The overall status of the order.
 * @property null|(object{tax_exempt: string, tax_ids: ((object{type: string, value: null|string}&\stdClass&StripeObject))[]}&\stdClass&StripeObject) $tax_details
 * @property (object{amount_credit?: int, amount_discount: int, amount_shipping: null|int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: Discount}&\stdClass&StripeObject)[], taxes: ((object{amount: int, rate: TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\stdClass&StripeObject))[]}&\stdClass&StripeObject)}&\stdClass&StripeObject) $total_details
 */

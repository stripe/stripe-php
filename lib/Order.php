 ...
 * @property (object{enabled: bool, status: null|string}&\stdClass&StripeObject) $automatic_tax
 ...
 * @property ((object{amount: int, gift_card: null|(object{card: string}&\stdClass&StripeObject), ineligible_line_items: null|string[], type: string}&\stdClass&StripeObject))[] $credits The credits applied to the Order. At most 10 credits can be applied to an Order.
 ...
 * @property (object{tax_exempt: string, tax_ids: ((object{type: string, value: null|string}&\stdClass&StripeObject))[]}&\stdClass&StripeObject) $tax_details

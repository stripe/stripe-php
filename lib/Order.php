 ...
 * @property null|((object{amount: int, gift_card: null|(object{card: string}&StripeObject), ineligible_line_items: null|string[], type: string}&StripeObject))[] $credits The credits applied to the Order. At most 10 credits can be applied to an Order.
 ...
 * @property (object{amount_credit?: int, amount_discount: int, amount_shipping: null|int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: Discount}&StripeObject)[], taxes: ((object{amount: int, rate: TaxRate, taxability_reason: null|string, taxable_amount: null|int}&StripeObject))[]}&StripeObject)}&StripeObject) $total_details
 */

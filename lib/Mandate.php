 ...
 * @property (object{acss_debit?: (object{default_for?: string[], interval_description: null|string, payment_schedule: string, transaction_type: string}&\stdClass&StripeObject), amazon_pay?: (object{}&\stdClass&StripeObject), au_becs_debit?: (object{url: string}&\stdClass&StripeObject), bacs_debit?: (object{network_status: string, reference: string, revocation_reason: null|string, url: string}&\stdClass&StripeObject), card?: (object{}&\stdClass&StripeObject), cashapp?: (object{}&\stdClass&StripeObject), kakao_pay?: (object{}&\stdClass&StripeObject), kr_card?: (object{}&\stdClass&StripeObject), link?: (object{}&\stdClass&StripeObject), naver_pay?: (object{}&\stdClass&StripeObject), nz_bank_account?: (object{}&\stdClass&StripeObject), paypal?: (object{billing_agreement_id: null|string, fingerprint?: null|string, payer_id: null|string, verified_email?: null|string}&\stdClass&StripeObject), payto?: (object{amount: null|int, amount_type: string, end_date: null|string, payment_schedule: string, payments_per_period: null|int, purpose: null|string, start_date: null|string}&\stdClass&StripeObject), revolut_pay?: (object{}&\stdClass&StripeObject), sepa_debit?: (object{reference: string, url: string}&\stdClass&StripeObject), type: string, us_bank_account?: (object{collection_method?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $payment_method_details

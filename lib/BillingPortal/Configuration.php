 ...
 * @property (object{headline: null|string, privacy_policy_url: null|string, terms_of_service_url: null|string}&\stdClass&\Stripe\StripeObject) $business_profile
 ...
 * @property (object{customer_update: (object{allowed_updates: string[], enabled: bool}&\stdClass&\Stripe\StripeObject), invoice_history: (object{enabled: bool}&\stdClass&\Stripe\StripeObject), payment_method_update: (object{enabled: bool}&\stdClass&\Stripe\StripeObject), subscription_cancel: (object{cancellation_reason: (object{enabled: bool, options: string[]}&\stdClass&\Stripe\StripeObject), enabled: bool, mode: string, proration_behavior: string}&\stdClass&\Stripe\StripeObject), subscription_update: (object{default_allowed_updates: string[], enabled: bool, products?: null|(object{prices: string[], product: string}&\stdClass&\Stripe\StripeObject)[], proration_behavior: string, schedule_at_period_end: (object{conditions: (object{type: string}&\stdClass&\Stripe\StripeObject)[]}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject)}&\stdClass&\Stripe\StripeObject) $features
 ...
 * @property (object{enabled: bool, url: null|string}&\stdClass&\Stripe\StripeObject) $login_page

 ...
 * @property null|(object{balance_transaction: BalanceTransaction|string, linked_transaction: CustomerCashBalanceTransaction|string}&\stdClass&StripeObject) $adjusted_for_overdraft
 * @property null|(object{payment_intent: PaymentIntent|string}&\stdClass&StripeObject) $applied_to_payment
 ...
 * @property null|(object{refund: Refund|string}&\stdClass&StripeObject) $refunded_from_payment
 * @property null|(object{balance_transaction: BalanceTransaction|string}&\stdClass&StripeObject) $transferred_to_balance
 ...
 * @property null|(object{payment_intent: PaymentIntent|string}&\stdClass&StripeObject) $unapplied_from_payment
 */

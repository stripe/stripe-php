 ...
 * @property (object{account_number?: null|string, bank_name?: null|string, fingerprint?: null|string, refund_account_holder_name?: null|string, refund_account_holder_type?: null|string, refund_routing_number?: null|string, routing_number?: null|string, swift_code?: null|string}&\stdClass&StripeObject) $ach_credit_transfer
 * @property (object{bank_name?: null|string, country?: null|string, fingerprint?: null|string, last4?: null|string, routing_number?: null|string, type?: null|string}&\stdClass&StripeObject) $ach_debit
 * @property (object{bank_address_city?: null|string, bank_address_line_1?: null|string, bank_address_line_2?: null|string, bank_address_postal_code?: null|string, bank_name?: null|string, category?: null|string, country?: null|string, fingerprint?: null|string, last4?: null|string, routing_number?: null|string}&\stdClass&StripeObject) $acss_debit
 * @property (object{data_string?: null|string, native_url?: null|string, statement_descriptor?: null|string}&\stdClass&StripeObject) $alipay
 ...
 * @property (object{bank_code?: null|string, bank_name?: null|string, bic?: null|string, iban_last4?: null|string, preferred_language?: null|string, statement_descriptor?: null|string}&\stdClass&StripeObject) $bancontact
 ...
 * @property (object{reference?: null|string, statement_descriptor?: null|string}&\stdClass&StripeObject) $eps
 ...
 * @property (object{bank_code?: null|string, bank_name?: null|string, bic?: null|string, statement_descriptor?: null|string}&\stdClass&StripeObject) $giropay
 * @property (object{bank?: null|string, bic?: null|string, iban_last4?: null|string, statement_descriptor?: null|string}&\stdClass&StripeObject) $ideal
 ...
 * @property (object{reference?: null|string}&\stdClass&StripeObject) $p24
 * @property (object{billing_agreement?: null|string, fingerprint?: null|string, payer_id?: null|string, reference_id?: string, reference_transaction_amount?: string, reference_transaction_charged?: bool, statement_descriptor?: null|string, transaction_id?: string, verified_email?: null|string}&\stdClass&StripeObject) $paypal
 * @property (object{address: null|string, amount_charged: int, amount_received: int, amount_returned: int, refund_attributes_method: string, refund_attributes_status: string}&\stdClass&StripeObject) $receiver
 * @property (object{failure_reason: null|string, return_url: string, status: string, url: string}&\stdClass&StripeObject) $redirect
 ...
 * @property (object{bank_code?: null|string, branch_code?: null|string, country?: null|string, fingerprint?: null|string, last4?: null|string, mandate_reference?: null|string, mandate_url?: null|string}&\stdClass&StripeObject) $sepa_debit
 * @property (object{bank_code?: null|string, bank_name?: null|string, bic?: null|string, country?: null|string, iban_last4?: null|string, preferred_language?: null|string, statement_descriptor?: null|string}&\stdClass&StripeObject) $sofort
 * @property (object{amount: int, currency: string, email?: string, items: null|((object{amount: null|int, currency: null|string, description: null|string, parent: null|string, quantity?: int, type: null|string}&\stdClass&StripeObject))[], shipping?: (object{address?: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\stdClass&StripeObject), carrier?: null|string, name?: string, phone?: null|string, tracking_number?: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $source_order
 ...
 * @property (object{prepay_id?: string, qr_code_url?: null|string, statement_descriptor?: string}&\stdClass&StripeObject) $wechat
 */

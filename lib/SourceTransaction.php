 ...
 * @property null|(object{customer_data?: string, fingerprint?: string, last4?: string, routing_number?: string}&\stdClass&StripeObject) $ach_credit_transfer
 ...
 * @property null|(object{reference?: string, sender_address_country?: string, sender_address_line1?: string, sender_iban?: string, sender_name?: string}&\stdClass&StripeObject) $chf_credit_transfer
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|(object{fingerprint?: string, funding_method?: string, last4?: string, reference?: string, sender_account_number?: string, sender_name?: string, sender_sort_code?: string}&\stdClass&StripeObject) $gbp_credit_transfer
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|(object{available_at?: string, invoices?: string}&\stdClass&StripeObject) $paper_check
 * @property null|(object{reference?: string, sender_iban?: string, sender_name?: string}&\stdClass&StripeObject) $sepa_credit_transfer

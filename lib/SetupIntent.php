 ...
 * @property null|StripeObject $automatic_payment_methods Settings for dynamic payment methods compatible with this Setup Intent
 ...
 * @property null|StripeObject $last_setup_error The error encountered in the previous SetupIntent confirmation.
 ...
 * @property null|StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
 ...
 * @property null|StripeObject $payment_method_configuration_details Information about the <a href="https://stripe.com/docs/api/payment_method_configurations">payment method configuration</a> used for this Setup Intent.
 * @property null|StripeObject $payment_method_options Payment method-specific configuration for this SetupIntent.

 ...
 * @property null|(object{allow_redirects?: string, enabled: null|bool}&\stdClass&StripeObject) $automatic_payment_methods Settings for dynamic payment methods compatible with this Setup Intent
 ...
 * @property null|(object{cashapp_handle_redirect_or_display_qr_code?: (object{hosted_instructions_url: string, mobile_auth_url: string, qr_code: (object{expires_at: int, image_url_png: string, image_url_svg: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), redirect_to_url?: (object{return_url: null|string, url: null|string}&\stdClass&StripeObject), type: string, use_stripe_sdk?: StripeObject, verify_with_microdeposits?: (object{arrival_date: int, hosted_verification_url: string, microdeposit_type: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $next_action If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
 ...
 * @property null|(object{id: string, parent: null|string}&\stdClass&StripeObject) $payment_method_configuration_details Information about the <a href="https://stripe.com/docs/api/payment_method_configurations">payment method configuration</a> used for this Setup Intent.
 * @property null|(object{acss_debit?: (object{currency: null|string, mandate_options?: (object{custom_mandate_url?: string, default_for?: string[], interval_description: null|string, payment_schedule: null|string, transaction_type: null|string}&\stdClass&StripeObject), verification_method?: string}&\stdClass&StripeObject), amazon_pay?: (object{}&\stdClass&StripeObject), bacs_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), card?: (object{mandate_options: null|(object{amount: int, amount_type: string, currency: string, description: null|string, end_date: null|int, interval: string, interval_count: null|int, reference: string, start_date: int, supported_types: null|string[]}&\stdClass&StripeObject), network: null|string, request_three_d_secure: null|string}&\stdClass&StripeObject), card_present?: (object{}&\stdClass&StripeObject), link?: (object{persistent_token: null|string}&\stdClass&StripeObject), paypal?: (object{billing_agreement_id: null|string, currency?: null|string, subsellers?: string[]}&\stdClass&StripeObject), payto?: (object{mandate_options?: (object{amount: null|int, amount_type: null|string, end_date: null|string, payment_schedule: null|string, payments_per_period: null|int, purpose: null|string, start_date: null|string}&\stdClass&StripeObject)}&\stdClass&StripeObject), sepa_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject), us_bank_account?: (object{financial_connections?: (object{filters?: (object{account_subcategories?: string[], institution?: string}&\stdClass&StripeObject), manual_entry?: (object{mode?: string}&\stdClass&StripeObject), permissions?: string[], prefetch: null|string[], return_url?: string}&\stdClass&StripeObject), mandate_options?: (object{collection_method?: string}&\stdClass&StripeObject), verification_method?: string}&\stdClass&StripeObject)}&\stdClass&StripeObject) $payment_method_options Payment method-specific configuration for this SetupIntent.
